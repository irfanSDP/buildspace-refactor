...
(function() {
  define(["dojo/_base/declare", 'dojo/data/ItemFileWriteStore', 'dojo/request', 'dijit/layout/TabContainer', 'dijit/layout/ContentPane', 'dijit/layout/BorderContainer', 'dijit/layout/StackController', 'dijit/layout/StackContainer', 'dijit/form/Button', './grid', './WorkArea', 'buildspace/widget/grid/cells/Formatter', 'dojo/i18n!../../nls/StockIn', 'buildspace/widget/grid/Filter'], function(declare, ItemFileWriteStore, request, TabContainer, ContentPane, BorderContainer, StackController, StackContainer, Button, PurchaseOrderGrid, WorkArea, Formatter, nls, FilterToolbar) {
    return declare("buildspace.apps.StockInReport", buildspace.apps._App, {
      init: function(args) {
        ...
        store = new dojo.data.ItemFileWriteStore({
          url: 'stockIn/getStockInProjectList',
          clearOnClose: true,
          urlPreventCache: true
        });
        grid = new PurchaseOrderGrid({
          ...
          onRowDblClick: function(e) {
            ...
            self.kill();
            self.win = new buildspace.widget.Window({
              title: buildspace.truncateString("Stock In (" + project.title[0] + ")", 150),
