...
(function() {
  define('buildspace/apps/StockInReport/InvoiceDeliveryOrderTab/PrintPreviewDialog/PrintPreviewFormDialog', ["dojo/_base/declare", 'dojo/_base/lang', "dojo/keys", "dojo/parser", "dijit/_WidgetBase", "dijit/_OnDijitClickMixin", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", 'dijit/Toolbar', 'dijit/form/Button', "dijit/layout/BorderContainer", "dijit/form/ValidationTextBox", "dijit/form/RadioButton", "dijit/form/SimpleTextarea", "dijit/registry", "dojo/dom-style", "dojo/dom-form", "dojo/request", "dojo/json", "dojox/validate/web", "dojox/form/Manager", "dojo/text!./templates/printPreviewForm.html", 'dojo/i18n!buildspace/nls/StockIn'], function(declare, lang, keys, parser, _WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin, Toolbar, Button, BorderContainer, ValidationTextBox, RadioButton, SimpleTextarea, registry, domStyle, domForm, request, JSON, web, Manager, template, nls) {
    ...
    printPreviewForm = declare("buildspace.apps.StockInReport.InvoiceItem.PrintPreviewForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
      ...
      print: function() {
        var csrfToken, deliveryOrderIdInput, descriptionFormat, form, formValues, invoiceIdInput, priceFormat, printNoCents, printingPageTitle, selectedRows, self;
        self = this;
        form = this.stockInReportingPrintForm;
        if (!form.validate()) {
          return false;
        }
        ...
        if (this.invoiceId > 0) {
          ...
          invoiceIdInput.setAttribute("value", this.invoiceId);
          invoiceIdInput.setAttribute('type', 'hidden');
          form.appendChild(invoiceIdInput);
        }
        if (this.deliveryOrderId > 0) {
          deliveryOrderIdInput = document.createElement("input");
          deliveryOrderIdInput.setAttribute("name", "deliveryOrderId");
          deliveryOrderIdInput.setAttribute("value", this.deliveryOrderId);
          deliveryOrderIdInput.setAttribute('type', 'hidden');
          form.appendChild(deliveryOrderIdInput);
        }
    ...
    return declare('buildspace.apps.StockInReport.InvoiceItem.PrePrintFormDialog', dijit.Dialog, {
