define('buildspace/apps/RationalizeRate/primeCostRateDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/when",
    "dojo/html",
    ...
    var Form = declare("buildspace.apps.RationalizeRate.PrimeCostRateForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    var Dialog = declare('buildspace.apps.RationalizeRate.PrimeCostRateDialog', dijit.Dialog, {
