define('buildspace/apps/RationalizeRate/WorkArea',[
    ...
    var ProjectRevisionContainer = declare('buildspace.apps.RationalizeRate.ProjectRevisionContainer', dijit.layout.BorderContainer, {
    ...
    return declare('buildspace.apps.RationalizeRate.WorkArea', dijit.layout.BorderContainer, {
        region: "center",
