define('buildspace/apps/CostData/PrimeCostRateLinkBillItems/ProjectListingGrid',[
    'dojo/_base/declare',
    ...
    var Grid = declare('buildspace.apps.PrimeCostRateLinkBillItems.ProjectListingGrid', EnhancedGrid, {
        style: "border:none;",
        region: 'center',
        keepSelection: true,
    ...
    return declare('buildspace.apps.CostData.PrimeCostRateLinkBillItems.ProjectListingContainer', dijit.layout.BorderContainer, {
        region: "center",
        title: '',
        ...
        createStackContainer: function(){
            var self = this;
            var stackContainerId = 'primeCostRateBillItemsLinker' + self.item.id + '-stackContainer';
            ...
            var controllerPane = new dijit.layout.ContentPane({
                ...
                region: 'top',
                id: 'costDataPrimeCostRateLinkBillItems'+self.costData.id+'-controllerPane',
                content: controller
            });
