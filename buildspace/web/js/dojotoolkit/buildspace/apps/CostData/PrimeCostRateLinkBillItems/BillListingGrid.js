define('buildspace/apps/CostData/PrimeCostRateLinkBillItems/BillListingGrid',[
    'dojo/_base/declare',
    ...
    var Grid = declare('buildspace.apps.PrimeCostRateLinkBillItems.BillListingGrid', EnhancedGrid, {
        style: "border:none;",
        region: 'center',
        keepSelection: true,
    ...
    return declare('buildspace.apps.CostData.PrimeCostRateLinkBillItems.BillListingContainer', dijit.layout.BorderContainer, {
        region: "center",
        title: '',
