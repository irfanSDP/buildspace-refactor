define('buildspace/apps/CostData/PrimeCostRateLinkBillItems/LinkBillItemsGrid',[
...
], function(declare, aspect, number, currency, array, connect, EnhancedGrid, GridFormatter, IndirectSelection, nls){

    var Grid = declare('buildspace.apps.CostData.PrimeCostRateLinkBillItems.LinkBillItemsGrid', EnhancedGrid, {
        style: "border:none;",
        region: 'center',
        keepSelection: true,
        rowSelector: '0px',
    ...
    return declare('buildspace.apps.CostData.PrimeCostRateLinkBillItems.LinkBillItemsContainer', dijit.layout.BorderContainer, {
        region: "center",
        title: '',
