define('buildspace/apps/CostData/ProjectInformationComparisonReport/ComparisonReportDialog',[
    'dojo/_base/declare',
    "dojo/aspect",
    "dojo/_base/array",
    "dojo/_base/connect",
    ...
    var Grid = declare('buildspace.apps.CostData.ProjectInformationComparisonReport.Grid', dojox.grid.EnhancedGrid, {
        region: 'center',
    ...
    return declare('buildspace.apps.CostData.ProjectInformationComparisonReport.Dialog', dijit.Dialog, {
        ...
        createPreviewDialog: function(){
            ...
            var previewDialog = new PreviewDialog({
                ...
                parent: this,
                projectInfoItem: this.projectInfoItem,
            });
