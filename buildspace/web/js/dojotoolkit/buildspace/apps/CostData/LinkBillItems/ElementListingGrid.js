define('buildspace/apps/CostData/LinkBillItems/ElementListingGrid',[
    'dojo/_base/declare',
    ...
    var Grid = declare('buildspace.apps.LinkBillItems.ElementListingGrid', EnhancedGrid, {
        style: "border:none;",
        region: 'center',
        keepSelection: true,
    ...
    return declare('buildspace.apps.CostData.LinkBillItems.ElementListingContainer', dijit.layout.BorderContainer, {
        region: "center",
        title: '',
