define('buildspace/apps/CostData/RowInclusion/RowInclusionDialog',[
    ...
    var Grid = declare('buildspace.apps.CostData.RowInclusion.Grid', dojox.grid.EnhancedGrid, {
        region: 'center',
    ...
    return declare('buildspace.apps.CostData.RowInclusion.Dialog', dijit.Dialog, {
            ...
            pb.show().then( function() {
                dojo.xhrPost( {
                    ...
                    load: function(data) {
                        ...
                        self.grid.selectedItemIds = data.ids;
