define(["../../../dojo/_base/declare",
    ...
    return declare('buildspace.apps.RationalizeRateReport', buildspace.apps._App, {
        type: null,
        win: null,
        project: null,
        init: function(args){
            ...
            this.win = new buildspace.widget.Window({
                title: nls.tenderingReport + ' > ' + nls.viewTenderers+' - '+buildspace.truncateString(project.title, 100),
