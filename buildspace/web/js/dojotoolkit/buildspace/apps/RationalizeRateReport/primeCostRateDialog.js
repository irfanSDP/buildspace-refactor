define('buildspace/apps/RationalizeRateReport/primeCostRateDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/when",
    "dojo/html",
    ...
    var Form = declare("buildspace.apps.RationalizeRateReport.PrimeCostRateForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    var Dialog = declare('buildspace.apps.RationalizeRateReport.PrimeCostRateDialog', dijit.Dialog, {
