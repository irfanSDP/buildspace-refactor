...
(function() {
  define("buildspace/apps/RationalizeRateReport/PrintPreviewDialog/PrintSelectedElementGridDialog", ["dojo/_base/declare", "dojo/aspect", "dojo/_base/lang", "dojo/_base/connect", "dojo/when", "dojo/html", "dojo/dom", "dojo/keys", "dojo/dom-style", "dojo/request", "dojo/json", "./PrintPreviewFormDialog", "buildspace/widget/grid/cells/Formatter", 'dojo/i18n!buildspace/nls/RationalizeRate'], function(declare, aspect, lang, connect, when_, html, dom, keys, domStyle, request, JSON, PrintPreviewFormDialog, Formatter, nls) {
    ...
    selectedElementGridContainer = declare("buildspace.apps.RationalizeRateReport.SelectedElementGridContainer", dijit.layout.BorderContainer, {
    ...
    return Dialog = declare("buildspace.apps.RationalizeRateReport.GroupProjectAssignmentDialog", dijit.Dialog, {
      ...
      createContent: function() {
        var borderContainer, content, formatter, self;
        self = this;
