define('buildspace/apps/ResourceLibrary/importBQItemDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var ImportBQItemGrid = declare('buildspace.apps.ResourceLibrary.ImportBQItemGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        libraryId: 0,
        libraryTradeId: 0,
        ...
        disableToolbarButtons: function(isDisable){
            var importWithRateBtn = dijit.byId('ImportBQItemGrid-'+this.libraryTradeId+'_'+this.libraryId+'ImportWithRate-button');
            importWithRateBtn._setDisabledAttr(isDisable);
            var importWithoutRateBtn = dijit.byId('ImportBQItemGrid-'+this.libraryTradeId+'_'+this.libraryId+'ImportWithoutRate-button');
        ...
        importItem: function(withRate){
            ...
            if( itemIds.length > 0){
                ...
                dojo.xhrPost({
                    url: 'resourceImport/importBQLibraryItems',
    ...
    var ImportGridContainer = declare('buildspace.apps.ResourceLibrary.ImportBQItemGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        ...
        postCreate: function(){
            ...
            var grid = this.grid = new ImportBQItemGrid(this.gridOpts);
            ...
            if(this.type == 'tree'){
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        id: 'ImportBQItemGrid-'+this.libraryTradeId+'_'+this.libraryId+'ImportWithRate-button',
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        id: 'ImportBQItemGrid-'+this.libraryTradeId+'_'+this.libraryId+'ImportWithoutRate-button',
    ...
    return declare('buildspace.apps.ResourceLibrary.ImportItemDialog', dijit.Dialog, {
        ...
        createContent: function(){
            ...
            var formatter = new GridFormatter(),
                store = dojo.data.ItemFileWriteStore({
                    clearOnClose: true,
                    url: "resourceImport/getBQLibraryList"
                }),
                content = new ImportGridContainer({
                    stackContainerTitle: nls.bqLibrary,
            ...
            var gridContainer = this.makeGridContainer(content, nls.bqLibrary);
        ...
        createElementGrid: function(library){
            ...
            var store = new dojo.data.ItemFileWriteStore({
                clearOnClose: true,
                url:"bqLibrary/getElementList/id/"+library.id
            });
        ...
        createItemGrid: function(element){
            var formatter = GridFormatter(),
                store = new dojo.data.ItemFileWriteStore({
                    url:"bqLibrary/getItemList/id/"+element.id
                });
