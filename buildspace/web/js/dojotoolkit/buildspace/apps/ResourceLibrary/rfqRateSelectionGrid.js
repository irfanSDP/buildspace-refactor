define('buildspace/apps/ResourceLibrary/rfqRateSelectionGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var ResourceLibraryRFQRateSelectionGrid = declare('buildspace.apps.ResourceLibrary.ResourceLibraryRFQRateSelectionGrid', dojox.grid.EnhancedGrid, {
        type: null,
        libraryId: 0,
        tradeId: 0,
        itemId: 0,
    ...
    var ResourceLibraryContainer = declare('buildspace.apps.ResourceLibrary.grid', dijit.layout.BorderContainer, {
        pageId: 'page-00',
        ...
        postCreate: function() {
            ...
            var container = dijit.byId('resourceLibraryGrid'+self.libraryId+'-stackContainer');
    ...
    return ResourceLibraryContainer;
});