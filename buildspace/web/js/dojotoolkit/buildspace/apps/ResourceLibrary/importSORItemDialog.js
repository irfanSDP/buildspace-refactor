define('buildspace/apps/ResourceLibrary/importSORItemDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var ImportSORItemGrid = declare('buildspace.apps.ResourceLibrary.ImportSORItemGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        libraryId: 0,
        libraryTradeId: 0,
        ...
        importItem: function(withRate){
            ...
            if( itemIds.length > 0){
                ...
                dojo.xhrPost({
                    url: 'resourceImport/importSORItems',
    ...
    var ImportGridContainer = declare('buildspace.apps.ResourceLibrary.ImportSORItemGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        ...
        createContent: function(){
            ...
            var formatter = new GridFormatter(),
                store = dojo.data.ItemFileWriteStore({
                    clearOnClose: true,
                    url: "resourceImport/getScheduleOfRateList"
                }),
