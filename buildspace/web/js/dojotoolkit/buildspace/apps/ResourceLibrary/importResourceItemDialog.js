define('buildspace/apps/ResourceLibrary/importResourceItemDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var ImportResourceItemGrid = declare('buildspace.apps.ResourceLibrary.ImportResourceItemGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        libraryId: 0,
        libraryTradeId: 0,
        ...
        disableToolbarButtons: function(isDisable){
            var importWithRateBtn = dijit.byId('ImportResourceItemGrid-'+this.libraryTradeId+'_'+this.libraryId+'ImportWithRate-button');
            importWithRateBtn._setDisabledAttr(isDisable);
            var importWithoutRateBtn = dijit.byId('ImportResourceItemGrid-'+this.libraryTradeId+'_'+this.libraryId+'ImportWithoutRate-button');
        ...
        importItem: function(withRate){
            ...
            if( itemIds.length > 0){
                ...
                dojo.xhrPost({
                    url: 'resourceImport/importResourceItems',
    ...
    var ImportGridContainer = declare('buildspace.apps.ResourceLibrary.ImportResourceItemGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        ...
        postCreate: function(){
            ...
            var grid = this.grid = new ImportResourceItemGrid(this.gridOpts);
            ...
            if(this.type == 'tree'){
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        id: 'ImportResourceItemGrid-'+this.libraryTradeId+'_'+this.libraryId+'ImportWithRate-button',
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        id: 'ImportResourceItemGrid-'+this.libraryTradeId+'_'+this.libraryId+'ImportWithoutRate-button',
    ...
    return declare('buildspace.apps.ResourceLibrary.ImportItemDialog', dijit.Dialog, {
        ...
        createContent: function(){
            ...
            var formatter = new GridFormatter(),
                store = dojo.data.ItemFileWriteStore({
                    clearOnClose: true,
                    url: "resourceImport/getResourceList"
                }),
            ...
            var gridContainer = this.makeGridContainer(content,nls.resources);
        ...
        createTradeGrid: function(library){
            ...
            var store = new dojo.data.ItemFileWriteStore({
                clearOnClose: true,
                url:"resourceLibrary/getTradeList/id/"+library.id
            });
        ...
        createItemGrid: function(trade){
            var formatter = GridFormatter(),
                store = new dojo.data.ItemFileWriteStore({
                    url:"resourceLibrary/getItemList/id/"+trade.id
                });
            ...
            new ImportGridContainer({
                ...
                gridOpts: {
                    ...
                    structure: [
                        ...
                        {name: nls.constant, field: 'constant-value', width:'160px', styles:'text-align:right;', formatter: formatter.formulaCurrencyCellFormatter},
