define('buildspace/apps/PostContract/Preliminaries/buildUpQuantitySummary',[
    'dojo/_base/declare',
    "dojo/dom-style",
    "dijit/_WidgetBase",
...
], function(declare, domStyle, _WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin, Button, ValidateTextBox, Checkbox, Select, template, number, nls){

    return declare("buildspace.apps.PostContract.buildUpQuantitySummary", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        postCreate: function(){
            ...
            dojo.xhrGet({
                ...
                load: function(resp) {
                    ...
                    var disabled = !self.editable;

                    // disable or enable inputs
                    self.applyConversionFactorNode.set('disabled', disabled);
                    self.roundingTypeNode.set('disabled', disabled);
                    self.conversionFactorAmountNode.set('disabled', disabled);
                    self.conversionFactorOperatorNode.set('disabled', disabled);
                },
