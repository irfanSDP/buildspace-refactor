define('buildspace/apps/PostContract/Preliminaries/lumpSumPercentDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/when",
    "dojo/html",
    ...
    var LumpSumPercentForm = declare("buildspace.apps.PostContract.Preliminaries.LumpSumPercentForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    return declare('buildspace.apps.PostContract.Preliminaries.LumpSumPercentDialog', dijit.Dialog, {
