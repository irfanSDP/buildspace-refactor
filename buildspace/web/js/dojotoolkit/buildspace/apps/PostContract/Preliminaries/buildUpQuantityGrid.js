define('buildspace/apps/PostContract/Preliminaries/buildUpQuantityGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var BuildUpQuantityGrid = declare('buildspace.apps.PostContract.BuildUpQuantity.grid', dojox.grid.EnhancedGrid, {
    ...
    return declare('buildspace.apps.PostContract.BuildUpQuantityGrid', dijit.layout.BorderContainer, {
