define('buildspace/apps/PostContract/ProjectProperties',[
    'dojo/_base/declare',
    "dojo/html",
    "dojo/dom",
    "dijit/form/Form",
    ...
    var MainInfoForm = declare("buildspace.apps.PostContract.MainInfoFormWidget", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    return declare('buildspace.apps.PostContract.ProjectProperties', dijit.layout.BorderContainer, {
        region: "center",
