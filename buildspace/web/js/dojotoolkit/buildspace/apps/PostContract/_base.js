define(["dojo/_base/declare",
    ...
    return declare('buildspace.apps.PostContract', buildspace.apps._App, {
        win: null,
        init: function(args){
            this.win = new buildspace.widget.Window({
                title: nls.postContract + ' > ' + nls.projectList,
            ...
            this.projectListing = new buildspace.apps.PostContract.ProjectListing({
                region: 'center',
                gridOpts: {
                    structure: [
