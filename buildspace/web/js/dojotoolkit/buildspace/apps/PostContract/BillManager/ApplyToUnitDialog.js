define('buildspace/apps/PostContract/BillManager/ApplyToUnitDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var Grid = declare('buildspace.apps.PostContract.BillManager.ApplyGrid', EnhancedGrid, {
            rootProject: null,
            style: "border:none;",
            region: 'center',
            pageId: null,
    ...
    return declare('buildspace.apps.PostContract.BillManager.ApplyDialog', dijit.Dialog, {
        ...
        createForm: function(){
            ...
            toolbar.addChild(this.saveBtn = new dijit.form.Button({
                label: nls.save,
                id: self.billId+self.elementId+'saveRow-button',
