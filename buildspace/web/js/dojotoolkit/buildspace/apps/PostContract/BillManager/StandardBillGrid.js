define('buildspace/apps/PostContract/BillManager/StandardBillGrid',[
    ...
    var StandardBillGrid = declare('buildspace.apps.PostContract.BillManager.StandardBillGrid', dojox.grid.EnhancedGrid, {
        type: null,
        billId: -1,
        elementId: 0,
        itemId: -1,
        ...
        constructor:function(args){
            ...
            this.disableEditing = args.disableEditing;
                ...
                this.structure = {
                    ...
                    cells: [
                        [{
                            ...
                            styles:'text-align: right;',
                            formatter: this.disableEditing ? formatter.unEditablePercentageCellFormatter : formatter.editableClaimPercentageCellFormatter,
                            editable: !this.disableEditing,
                            cellType: 'buildspace.widget.grid.cells.TextBox'
                        },{
                            name: nls.amount,
                            ...
                            headerClasses: "typeHeader2",
                            styles:'text-align: right;',
                            formatter: this.disableEditing ? formatter.unEditableCurrencyCellFormatter : formatter.claimAmountCellFormatter,
                            editable: !this.disableEditing,
                            cellType: 'buildspace.widget.grid.cells.TextBox'
                        },{
                            name: nls.percent,
                ...
                this.structure = {
                    ...
                    cells: [
                        [{
                            ...
                            headerClasses: "typeHeader1",
                            styles:'text-align: right;',
                            formatter: this.disableEditing ? formatter.unEditablePercentageCellFormatter : formatter.elementClaimEditablePercentageCellFormatter,
                            editable: !this.disableEditing,
                            cellType: 'buildspace.widget.grid.cells.TextBox'
                        },{
                            name: nls.amount,
                            ...
                            headerClasses: "typeHeader1",
                            styles:'text-align: right;',
                            formatter: this.disableEditing ? formatter.unEditableCurrencyCellFormatter : formatter.elementClaimAmountCellFormatter,
                            editable: !this.disableEditing,
                            cellType: 'buildspace.widget.grid.cells.TextBox'
                        },{
                            name: nls.percent,
        ...
        canEdit: function(inCell, inRowIndex){
            ...
            if(inCell != undefined){
                ...
                if(item.id == buildspace.constants.GRID_LAST_ROW || (item.include != undefined && item.include[0] != true )){
                    window.setTimeout(function() {
                        self.edit.cancel();
                        self.focus.setFocusIndex(inRowIndex, inCell.index);
                    }, 10);
                    return false;
                }else if(field == 'rate' && (item.type != buildspace.widget.grid.constants.HIERARCHY_TYPE_ITEM_LUMP_SUM_EXCLUDE ||
    ...
    return declare('buildspace.apps.PostContract.BillManager.StandardBillGridBuilder', dijit.layout.BorderContainer, {
        pageId: 'page-00',
        ...
        postCreate: function(){
            ...
            if(this.type != 'tree' && !this.disableEditing && !this.locked){
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        ...
                        onClick: dojo.hitch(this, "openApplyToUnitDialog")
                    })
                );
            ...
            var container = dijit.byId('postContractStandardBill' + this.billId + '-stackContainer');
        ...
        openApplyToUnitDialog: function(){
            var applyDialog = new ApplyToUnitDialog({
                rootProject : this.rootProject,
                typeItem: this.typeItem,
                billId: this.billId,
                elementId: this.elementId,
                url: 'postContractStandardBillClaim/applyToOtherUnit'
            });
