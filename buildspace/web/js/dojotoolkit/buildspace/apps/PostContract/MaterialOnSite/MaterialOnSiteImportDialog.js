...
(function() {
  define("buildspace/apps/PostContract/MaterialOnSite/MaterialOnSiteImportDialog", ["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/connect", "dojo/when", "dojo/html", "dojo/dom", "dojo/keys", "dojo/dom-style", "dojox/layout/ContentPane", "buildspace/widget/grid/cells/Formatter", "dojox/grid/enhanced/plugins/IndirectSelection", 'dojo/i18n!../../../nls/PostContract'], function(declare, lang, connect, when_, html, dom, keys, domStyle, ContentPane, GridFormatter, IndirectSelection, nls) {
    ...
    importResourceGrid = declare("buildspace.apps.MaterialOnSite.ImportMaterialOnSiteItemGrid", dojox.grid.EnhancedGrid, {
      ...
      constructor: function(args) {
        ...
        this.connects = [];
        if (args.type === "tree") {
          this.urlGetDescendantIds = "materialOnSite/getDescendantsForImport";
          this.plugins = {
            indirectSelection: {
              headerSelector: true,
              width: "20px",
      ...
      importFromMaterialOnSite: function() {
        ...
        if (itemIds.length > 0) {
          ...
          pb.show();
          xhrArgs = {
            url: "materialOnSite/importMaterialOnSiteItems",
            content: {
    ...
    return declare("buildspace.apps.MaterialOnSite.ImportMaterialOnSiteDialog", dijit.Dialog, {
      ...
      createContent: function() {
        ...
        store = dojo.data.ItemFileWriteStore({
          url: "materialOnSite/getMaterialOnSiteList/pid/" + self.project.id[0]
        });
      ...
      createItemGrid: function(materialOnSite) {
        ...
        store = new dojo.data.ItemFileWriteStore({
          url: "materialOnSite/getMaterialOnSiteItemList/id/" + materialOnSite.id[0]
        });
