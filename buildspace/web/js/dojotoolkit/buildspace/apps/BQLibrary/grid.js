define('buildspace/apps/BQLibrary/grid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    './fileImportDialog',
    './ImportBuildspaceZipFile',
    './BQLibraryExportBuildspaceZipFile',
    'dijit/form/DropDownButton',
    "dijit/DropDownMenu",
    "dijit/MenuItem",
    'dojo/i18n!buildspace/nls/BQLibrary',
    'buildspace/widget/grid/Filter'
], function(declare, lang, array, domAttr, connect, TooltipDialog, popup, Menu, number, Selector, Rearrange, FormulatedColumn, evt, keys, focusUtil, html, xhr, PopupMenuItem, Textarea, FormulaTextBox, FileImportDialog, ImportBuildspaceZipFile, BQLibraryExportBuildspaceZipFile, DropDownButton, DropDownMenu, MenuItem, nls, Filter ){

    var BQLibraryGrid = declare('buildspace.apps.BQLibrary.Grid', dojox.grid.EnhancedGrid, {
        type: null,
        libraryId: 0,
        elementId: 0,
        ...
        disableToolbarButtons: function(isDisable, buttonsToEnable){
            var addRowBtn = dijit.byId(this.libraryId+'_'+this.elementId+'AddRow-button');
            var deleteRowBtn = dijit.byId(this.libraryId+'_'+this.elementId+'DeleteRow-button');
            var indentBtn = dijit.byId(this.libraryId+'_'+this.elementId+'Indent-button');
            var outdentBtn = dijit.byId(this.libraryId+'_'+this.elementId+'Outdent-button');
            ...
            if(isDisable && buttonsToEnable instanceof Array ){
                ...
                dojo.forEach(buttonsToEnable, function(label){
                    var btn = dijit.byId(_this.libraryId+'_'+_this.elementId+label+'Row-button');
    ...
    return declare('buildspace.apps.BQLibrary.grid', dijit.layout.BorderContainer, {
        pageId: 'page-00',
        ...
        postCreate: function(){
            ...
            toolbar.addChild(
                new dijit.form.Button({
                    id: self.libraryId+'_'+self.elementId+'AddRow-button',
                    label: nls.addRow,
                    iconClass: "icon-16-container icon-16-add",
            ...
            if(self.type == 'tree'){
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        id: self.libraryId+'_'+self.elementId+'Indent-button',
                        label: nls.indent,
                        iconClass: "icon-16-container icon-16-indent",
                        disabled: grid.selection.selectedIndex > -1 ? false : true,
                        onClick: function(){
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        id: self.libraryId+'_'+self.elementId+'Outdent-button',
                        label: nls.outdent,
                        iconClass: "icon-16-container icon-16-outdent",
                        disabled: grid.selection.selectedIndex > -1 ? false : true,
                        onClick: function(){
            ...
            toolbar.addChild(
                new dijit.form.Button({
                    id: self.libraryId+'_'+self.elementId+'DeleteRow-button',
                    label: nls.deleteRow,
                    iconClass: "icon-16-container icon-16-delete",
                    disabled: grid.selection.selectedIndex > -1 ? false : true,
                    onClick: function(){
            ...
            if(self.type != 'tree'){
                ...
                importDropDownMenu.addChild(new MenuItem({
                    ...
                    onClick: function(e){
                        var fileImportDialog = new ImportBuildspaceZipFile({
                            libraryId: self.libraryId,
                            title: nls.importFromBuildspaceZipFile,
                            libraryGrid: grid
                        });
                        fileImportDialog.show();
                    }
                ...
                importDropDownMenu.addChild(new MenuItem({
                    ...
                    onClick: function(e){
                        var fileImportDialog = new FileImportDialog({
                            ...
                            uploadUrl: "bqLibrary/importBuildsoftExcel",
                ...
                importDropDownMenu.addChild(new MenuItem({
                    ...
                    onClick: function(e){
                        var fileImportDialog = new FileImportDialog({
                            ...
                            uploadUrl: "bqLibrary/previewImportedFile",
                ...
                importDropDownMenu.addChild(new MenuItem({
                    ...
                    onClick: function(e){
                        var fileImportDialog = new FileImportDialog({
                            ...
                            uploadUrl: "bqLibrary/importPricelist",
                ...
                exportDropDownMenu.addChild(new MenuItem({
                    label: nls.exportToBuildspaceZip,
                    onClick: function(e){
                        var fileExportDialog = new BQLibraryExportBuildspaceZipFile({
                            bqLibraryId: self.libraryId
                        });
            ...
            var container = dijit.byId('bqLibrary_'+self.libraryId+'-stackContainer');
            if(container){
