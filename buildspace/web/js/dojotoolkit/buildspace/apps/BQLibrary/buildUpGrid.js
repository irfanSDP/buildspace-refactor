define('buildspace/apps/BQLibrary/buildUpGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var BuildUpGrid = declare('buildspace.apps.BQLibrary.BuildUp.grid', dojox.grid.EnhancedGrid, {
        itemId: -1,
        resource: null,
        bqItemId: 0,
        ...
        disableToolbarButtons: function(isDisable, buttonsToEnable){
            var addRowBtn = dijit.byId('builUpGrid-'+this.resource.id+'_'+this.bqItemId+'AddRow-button');
            var deleteRowBtn = dijit.byId('builUpGrid-'+this.resource.id+'_'+this.bqItemId+'DeleteRow-button');
            ...
            if(isDisable && buttonsToEnable instanceof Array ){
                ...
                dojo.forEach(buttonsToEnable, function(label){
                    var btn = dijit.byId('builUpGrid-'+_this.resource.id+'_'+_this.bqItemId+label+'Row-button');
                    btn._setDisabledAttr(false);
                })
            }
        },
        updateTotalBuildUp: function(totalBuildUp){
            var accContainer = dijit.byId('accPane-'+this.resource.id+'-'+this.bqItemId);
    ...
    return declare('buildspace.apps.BQLibrary.BuildUpGrid', dijit.layout.BorderContainer, {
        ...
        postCreate: function(){
            var self = this;
            self.inherited(arguments);
            lang.mixin(self.gridOpts, { resource: self.resource, bqItemId: self.bqItemId, region:"center" });
            ...
            toolbar.addChild(
                new dijit.form.Button({
                    id: 'builUpGrid-'+self.resource.id+'_'+self.bqItemId+'AddRow-button',
                    label: nls.addRow,
                    iconClass: "icon-16-container icon-16-add",
            ...
            toolbar.addChild(
                new dijit.form.Button({
                    id: 'builUpGrid-'+self.resource.id+'_'+self.bqItemId+'DeleteRow-button',
                    label: nls.deleteRow,
                    iconClass: "icon-16-container icon-16-delete",
                    disabled: grid.selection.selectedIndex > -1 ? false : true,
                    onClick: function(){
