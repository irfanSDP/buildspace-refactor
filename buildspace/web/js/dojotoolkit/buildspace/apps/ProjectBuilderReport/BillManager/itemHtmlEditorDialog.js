define('buildspace/apps/ProjectBuilderReport/BillManager/itemHtmlEditorDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/when",
    "dojo/html",
    ...
    var Form = declare("buildspace.apps.ProjectBuilderReport.BillManager.ItemHtmlEditorForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    var Dialog = declare('buildspace.apps.ProjectBuilderReport.BillManager.ItemHtmlEditorDialog', dijit.Dialog, {
