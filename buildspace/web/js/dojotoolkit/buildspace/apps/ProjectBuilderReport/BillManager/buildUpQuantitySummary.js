define('buildspace/apps/ProjectBuilderReport/BillManager/buildUpQuantitySummary',[
    'dojo/_base/declare',
    "dojo/dom-style",
    "dijit/_WidgetBase",
    ...
    return declare("buildspace.apps.ProjectBuilderReport.BillManager.buildUpQuantitySummary", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
