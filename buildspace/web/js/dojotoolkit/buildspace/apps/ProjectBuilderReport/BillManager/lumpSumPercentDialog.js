define('buildspace/apps/ProjectBuilderReport/BillManager/lumpSumPercentDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/when",
    "dojo/html",
    ...
    var Form = declare("buildspace.apps.ProjectBuilderReport.BillManager.LumpSumPercentForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    var Dialog = declare('buildspace.apps.ProjectBuilderReport.BillManager.LumpSumPercentDialog', dijit.Dialog, {
