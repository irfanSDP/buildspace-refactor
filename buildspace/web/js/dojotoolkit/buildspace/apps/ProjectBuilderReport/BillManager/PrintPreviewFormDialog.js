...
(function() {
  define('buildspace/apps/ProjectBuilderReport/BillManager/PrintPreviewFormDialog', ["dojo/_base/declare", 'dojo/_base/lang', "dojo/keys", "dojo/parser", "dijit/_WidgetBase", "dijit/_OnDijitClickMixin", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", 'dijit/Toolbar', 'dijit/form/Button', "dijit/layout/BorderContainer", "dijit/form/ValidationTextBox", "dijit/form/RadioButton", "dijit/form/SimpleTextarea", "dijit/registry", "dojo/dom-style", "dojo/dom-form", "dojo/request", "dojo/json", "dojox/validate/web", "dojox/form/Manager", "dojo/text!./templates/printPreviewForm.html", 'dojo/i18n!buildspace/nls/TenderingReport'], function(declare, lang, keys, parser, _WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin, Toolbar, Button, BorderContainer, ValidationTextBox, RadioButton, SimpleTextarea, registry, domStyle, domForm, request, JSON, web, Manager, template, nls) {
    ...
    printPreviewForm = declare("buildspace.apps.ProjectBuilderReport.BillManager.PrintPreviewForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
      ...
      print: function() {
        var billColumnSettingIdInput, billIdInput, csrfToken, descriptionFormat, form, formValues, priceFormat, printNoCents, printingPageTitle, selectedRows, self;
        self = this;
        form = this.projectBuilderReportingForm;
        if (!form.validate()) {
          return false;
        }
        ...
        if (this.billColumnSettingId > 0) {
          billColumnSettingIdInput = document.createElement("input");
          billColumnSettingIdInput.setAttribute("name", "billColumnSettingId");
          billColumnSettingIdInput.setAttribute("value", this.billColumnSettingId);
          billColumnSettingIdInput.setAttribute('type', 'hidden');
          form.appendChild(billColumnSettingIdInput);
        }
    ...
    return Dialog = declare('buildspace.apps.ProjectBuilderReport.BillManager.PrePrintFormDialog', dijit.Dialog, {
