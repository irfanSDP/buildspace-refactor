define('buildspace/apps/ProjectBuilderReport/BillManager/AddResourceCategoryDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var AddResourceCategoryGrid = declare('buildspace.apps.ProjectBuilderReport.BillManager.AddResourceCategoryGrid', dojox.grid.EnhancedGrid, {
        billId: 0,
        billItem: null,
        currencyAbbr: null,
        billGridStore: null,
    ...
    var Formatter = declare("buildspace.apps.ProjectBuilderReport.BillManager.AddResourceCategoryGrid.CellFormatter", null, {
    ...
    var Dialog = declare('buildspace.apps.ProjectBuilderReport.BillManager.AddResourceCategoryDialog', dijit.Dialog, {
