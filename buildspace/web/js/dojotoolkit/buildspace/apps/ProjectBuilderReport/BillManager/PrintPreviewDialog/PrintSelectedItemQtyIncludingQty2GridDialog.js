...
(function() {
  ...
  define("buildspace/apps/ProjectBuilderReport/BillManager/PrintPreviewDialog/PrintSelectedItemQtyIncludingQty2GridDialog", ["dojo/_base/declare", "dojo/aspect", "dojo/_base/lang", "dojo/_base/connect", "dojo/when", "dojo/html", "dojo/dom", "dojo/keys", "dojo/dom-style", "dojo/request", "dojo/json", "./PrintPreviewFormDialog", "buildspace/widget/grid/cells/Formatter", 'dojo/i18n!buildspace/nls/ProjectBuilder'], function(declare, aspect, lang, connect, when_, html, dom, keys, domStyle, request, JSON, PrintPreviewFormDialog, Formatter, nls) {
    ...
    return declare("buildspace.apps.ProjectBuilderReport.PrintPreviewReportDialog", dijit.Dialog, {
