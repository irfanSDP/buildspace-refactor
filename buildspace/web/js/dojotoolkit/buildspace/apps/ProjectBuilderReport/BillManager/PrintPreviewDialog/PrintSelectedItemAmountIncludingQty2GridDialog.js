      ...
      openPrintingDialog: function(self) {
        ...
        return request.get("viewTendererReporting/getPrintingInformation", {
          ...
          dialog = new PrintPreviewFormDialog({
            ...
            type: self.type,
            printURL: 'tenderingReport/printSelectedItemsAmountIncludingQty2',
            exportURL: 'tenderingReport/exportExcelSelectedItemsAmountIncludingQty2',
      ...
      constructGridStructure: function(typeColumns) {
        ...
        for (key in typeColumns) {
          ...
          basicStructure.cells[0].push({
            name: nls.amount + "/" + nls.unit,
            field: columnSetting.id + "-total_per_unit",
            width: '100px',
            styles: "text-align:right;",
            formatter: formatter.itemTotalPerUnitCellFormatter,
            noresize: true
          });
          basicStructure.cells[0].push({
            name: nls.amount + "/" + nls.unit + " (2)",
            field: columnSetting.id + "-remeasure_total_per_unit",
            width: '100px',
            styles: "text-align:right;",
            formatter: formatter.itemTotalPerUnitCellFormatter,
            noresize: true
          ...
          basicStructure.cells[0].push({
            name: nls.difference + " (%)",
            field: columnSetting.id + "-total_per_unit_difference",
            width: '85px',
