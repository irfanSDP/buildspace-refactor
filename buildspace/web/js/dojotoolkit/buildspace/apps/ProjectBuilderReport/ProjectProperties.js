define('buildspace/apps/ProjectBuilderReport/ProjectProperties',[
    'dojo/_base/declare',
    "dojo/html",
    "dojo/dom",
    "dijit/form/Form",
    ...
    var MainInfoForm = declare("buildspace.apps.ProjectBuilderReport.MainInfoFormWidget", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    var ProjectProperties = declare('buildspace.apps.ProjectBuilderReport.ProjectProperties', dijit.layout.BorderContainer, {
        region: "center",
