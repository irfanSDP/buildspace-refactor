...
(function() {
    define( 'buildspace/apps/ProjectAnalyzerReport/ScheduleOfRatePrintPreviewDialog/PrintPreviewFormDialog', [ "dojo/_base/declare", 'dojo/_base/lang', "dojo/keys", "dojo/parser", "dijit/_WidgetBase", "dijit/_OnDijitClickMixin", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", 'dijit/Toolbar', 'dijit/form/Button', "dijit/layout/BorderContainer", "dijit/form/ValidationTextBox", "dijit/form/RadioButton", "dijit/form/SimpleTextarea", "dijit/registry", "dojo/dom-style", "dojo/dom-form", "dojo/request", "dojo/json", "dojox/validate/web", "dojox/form/Manager", "dojo/text!./templates/printPreviewForm.html", 'dojo/i18n!buildspace/nls/RationalizeRate' ], function(declare, lang, keys, parser, _WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin, Toolbar, Button, BorderContainer, ValidationTextBox, RadioButton, SimpleTextarea, registry, domStyle, domForm, request, JSON, web, Manager, template, nls) {
        ...
        printPreviewForm = declare( "buildspace.apps.ProjectAnalyzerReport.PrintPreviewForm", [ _WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin ], {
            ...
            print: function() {
                var billIdInput, csrfToken, descriptionFormat, elementIdInput, form, formValues, priceFormat, printNoCents, printingPageTitle, projectIdInput, scheduleOfRateIdInput, selectedRows, self, tradeIdInput;
                self = this;
                form = this.projectAnalyzerSoRReportingPrintForm;
                if( !form.validate() ) {
                    return false;
                }
                ...
                if( this.scheduleOfRateId > 0 ) {
                    scheduleOfRateIdInput = document.createElement( "input" );
                    scheduleOfRateIdInput.setAttribute( "name", "scheduleOfRateId" );
                    scheduleOfRateIdInput.setAttribute( "value", this.scheduleOfRateId );
                    scheduleOfRateIdInput.setAttribute( 'type', 'hidden' );
                    form.appendChild( scheduleOfRateIdInput );
                }
                if( this.projectId > 0 ) {
                ...
                if( this.tradeItemIds ) {
                    ...
                    selectedRows.setAttribute( "name", "tradeItemIds" );
        ...
        return Dialog = declare( 'buildspace.apps.ProjectAnalyzerReport.PrePrintFormDialog', dijit.Dialog, {
