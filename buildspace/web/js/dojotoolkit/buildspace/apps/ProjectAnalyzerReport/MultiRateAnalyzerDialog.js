define('buildspace/apps/ProjectAnalyzerReport/MultiRateAnalyzerDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/html",
    'dojo/keys',
    ...
    var MultiRateAnalyzerGrid = declare('buildspace.apps.ProjectAnalyzerReport.MultiRateAnalyzerGrid', dojox.grid.EnhancedGrid, {
        resourceStore: null,
        projectId: 0,
        resourceId: 0,
        billGrid: null,
    ...
    var Dialog = declare('buildspace.apps.ProjectAnalyzerReport.MultiRateAnalyzerDialog', dijit.Dialog, {
        ...
        createContent: function(){
            ...
            var formatter = new GridFormatter(),
                structure = this.columnName == 'rate' ? [
                    ...
                    {name: 'No.', field: 'id', width:'30px', styles:'text-align:center;', formatter: formatter.rowCountCellFormatter },
                    {name: nls.wastage, field: 'wastage-value', width:'150px', styles:'text-align:right;', formatter: formatter.formulaNumberCellFormatter},
                    {name: nls.noOfBillItems, field: 'no_bill_items', styles:'text-align:center;', width:'150px' }
                ],
