...
(function() {
  define('buildspace/apps/ProjectAnalyzerReport/ResourcePrintPreviewDialog/PrintPreviewFormDialog', ["dojo/_base/declare", 'dojo/_base/lang', "dojo/keys", "dojo/parser", "dijit/_WidgetBase", "dijit/_OnDijitClickMixin", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", 'dijit/Toolbar', 'dijit/form/Button', "dijit/layout/BorderContainer", "dijit/form/ValidationTextBox", "dijit/form/RadioButton", "dijit/form/SimpleTextarea", "dijit/registry", "dojo/dom-style", "dojo/dom-form", "dojo/request", "dojo/json", "dojox/validate/web", "dojox/form/Manager", "dojo/text!./templates/printPreviewForm.html", 'dojo/i18n!buildspace/nls/RationalizeRate'], function(declare, lang, keys, parser, _WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin, Toolbar, Button, BorderContainer, ValidationTextBox, RadioButton, SimpleTextarea, registry, domStyle, domForm, request, JSON, web, Manager, template, nls) {
    ...
    printPreviewForm = declare("buildspace.apps.ProjectAnalyzerReport.ResourcePrintPreviewForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
      ...
      type: null,
      print: function() {
        var billIdInput, csrfToken, descriptionFormat, elementIdInput, form, formValues, priceFormat, printNoCents, printingPageTitle, projectIdInput, resourceIdInput, selectedRows, self, tradeIdInput;
        self = this;
        form = this.projectAnalyzerResourceReportingPrintForm;
        if (!form.validate()) {
          return false;
        }
        ...
        if (this.resourceId > 0) {
          resourceIdInput = document.createElement("input");
          resourceIdInput.setAttribute("name", "resourceId");
          resourceIdInput.setAttribute("value", this.resourceId);
          resourceIdInput.setAttribute('type', 'hidden');
          form.appendChild(resourceIdInput);
        }
        if (this.tradeId > 0) {
          tradeIdInput = document.createElement("input");
          tradeIdInput.setAttribute("name", "tradeId");
          tradeIdInput.setAttribute("value", this.tradeId);
          tradeIdInput.setAttribute('type', 'hidden');
        ...
        if (this.tradeItemIds) {
          selectedRows = document.createElement("input");
          selectedRows.setAttribute("name", "selectedTradeItemIds");
          selectedRows.setAttribute("value", JSON.stringify(this.tradeItemIds));
      ...
      "export": function() {
        var billIdInput, csrfToken, descriptionFormat, elementIdInput, form, formValues, priceFormat, printNoCents, printingPageTitle, projectIdInput, resourceIdInput, selectedRows, self, tradeIdInput, type;
        self = this;
        form = this.projectAnalyzerResourceReportingPrintForm;
        if (!form.validate()) {
          return false;
        ...
        type.setAttribute("value", this.type);
    ...
    return Dialog = declare('buildspace.apps.ProjectAnalyzerReport.ResourcePrePrintFormDialog', dijit.Dialog, {
