(function () {
    define("buildspace/apps/ViewTendererReport/PrintPreviewDialog/PrintSelectedScheduleOfRateItemGridDialog",
        [
        ...
        function (
            declare, aspect, lang, connect, when_, html, dom, keys, domStyle, request, JSON, PrintPreviewFormDialog, Formatter, nls
        ) {
        var Dialog, selectedItemGrid, selectedItemGridContainer;
        selectedItemGrid = declare("buildspace.apps.TenderingReport.SelectedScheduleOfRateItemGrid", dojox.grid.EnhancedGrid, {
        ...
        selectedItemGridContainer = declare("buildspace.apps.TenderingReport.SelectedScheduleOfRateItemGridContainer", dijit.layout.BorderContainer, {
            ...
            openPrintingDialog: function (self) {
                ...
                return request.get("viewTendererReporting/getPrintingInformation", {
                    ...
                    dialog = new PrintPreviewFormDialog({
                        ...
                        type: self.type,
                        printURL: self.type !== null ? 'printReport/printScheduleOfRateItem' : '',
                        exportURL: self.type !== null ? 'scheduleOfRateExportExcelReporting/exportScheduleOfRateTendererReport' : '',
                        billId: self.billId,
        ...
        return Dialog = declare("buildspace.apps.TenderingReport.GroupProjectAssignmentDialog", dijit.Dialog, {
            ...
            createContent: function () {
                ...
                if (this.selectedTenderers.length > 0 && this.type) {
                    request("viewTendererReporting/getContractorsScheduleOfRate", {
                        sync: true,
                        handleAs: 'json',
                        query: {
                            id: self.project.id,
            ...
            constructGridStructure: function (selectedCompanies, type, self) {
                ...
                var displaySelectedTenderer = !type;
                if (self == null) {
                    self = this;
                }
