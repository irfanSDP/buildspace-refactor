...
(function () {
    define("buildspace/apps/ViewTendererReport/PrintPreviewDialog/PrintSelectedItemRateGridDialog", ["dojo/_base/declare", "dojo/aspect", "dojo/_base/lang", "dojo/_base/connect", "dojo/when", "dojo/html", "dojo/dom", "dojo/keys", "dojo/dom-style", "dojo/request", "dojo/json", "./PrintPreviewFormDialog", "buildspace/widget/grid/cells/Formatter", 'dojo/i18n!buildspace/nls/TenderingReport'], function (declare, aspect, lang, connect, when_, html, dom, keys, domStyle, request, JSON, PrintPreviewFormDialog, Formatter, nls) {
        ...
        selectedItemGridContainer = declare("buildspace.apps.TenderingReport.SelectedItemRateGridContainer", dijit.layout.BorderContainer, {
            ...
            openPrintingDialog: function (self) {
                ...
                return request.get("viewTendererReporting/getPrintingInformation", {
                    ...
                    dialog = new PrintPreviewFormDialog({
                        ...
                        type: self.type,
                        printURL: self.type !== null ? 'printReport/printItem' : 'printReport/printSelectedItemRate',
                        exportURL: self.type !== null ? 'exportExcelReport/exportItem' : 'exportExcelReport/exportSelectedItemRate',
                        billId: self.billId,
                    ...
                    additionalStructures = [
                        {
                            ...
                            field: self.companyId + "-rate-value",
                            styles: "text-align:right;color:blue;",
                            width: '100px',
                            formatter: formatter.unEditableCurrencyCellFormatter,
                            noresize: true
