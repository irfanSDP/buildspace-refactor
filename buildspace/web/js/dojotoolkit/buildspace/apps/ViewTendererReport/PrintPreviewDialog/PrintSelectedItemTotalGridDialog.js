...
(function() {
  define("buildspace/apps/ViewTendererReport/PrintPreviewDialog/PrintSelectedItemTotalGridDialog", ["dojo/_base/declare", "dojo/aspect", "dojo/_base/lang", "dojo/_base/connect", "dojo/when", "dojo/html", "dojo/dom", "dojo/keys", "dojo/dom-style", "dojo/request", "dojo/json", "./PrintPreviewFormDialog", "buildspace/widget/grid/cells/Formatter", 'dojo/i18n!buildspace/nls/TenderingReport'], function(declare, aspect, lang, connect, when_, html, dom, keys, domStyle, request, JSON, PrintPreviewFormDialog, Formatter, nls) {
    ...
    selectedItemGridContainer = declare("buildspace.apps.TenderingReport.SelectedItemTotalGridContainer", dijit.layout.BorderContainer, {
      ...
      openPrintingDialog: function(self) {
        ...
        return request.get("viewTendererReporting/getPrintingInformation", {
          ...
          dialog = new PrintPreviewFormDialog({
            ...
            type: self.type,
            printURL: self.type !== null ? 'printReport/printItemTotal' : 'printReport/printSelectedItemTotal',
            exportURL: self.type !== null ? 'exportExcelReport/exportItemTotal' : 'exportExcelReport/exportSelectedItemTotal',
            billId: self.billId,
    ...
    return Dialog = declare("buildspace.apps.TenderingReport.GroupProjectAssignmentDialog", dijit.Dialog, {
      ...
      constructGridStructure: function(selectedCompanies, type, self) {
        ...
        if (!type) {
          ...
          basicStructure.push(additionalStructures);
