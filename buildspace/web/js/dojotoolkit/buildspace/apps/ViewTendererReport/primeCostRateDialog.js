define('buildspace/apps/ViewTendererReport/primeCostRateDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/when",
    "dojo/html",
    ...
    var Form = declare("buildspace.apps.ViewTendererReport.PrimeCostRateForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    var Dialog = declare('buildspace.apps.ViewTendererReport.PrimeCostRateDialog', dijit.Dialog, {
