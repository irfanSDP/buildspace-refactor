define('buildspace/apps/PostContractSubPackageRemeasurement/RemeasurementGrid',[
	'dojo/_base/declare',
	'dojo/_base/lang',
...
], function(declare, lang, Rearrange, FormulatedColumn, GridFormatter, nls) {

	var RemeasurementGrid = declare('buildspace.apps.PostContractSubPackageRemeasurement.ResourceEnhancedGrid', dojox.grid.EnhancedGrid, {
		type: null,
	...
	var RemeasurementGridContainer = declare('buildspace.apps.PostContractSubPackageRemeasurement.RemeasurementGrid', dijit.layout.BorderContainer, {
		stackContainerTitle: '',
