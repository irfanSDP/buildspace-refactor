define('buildspace/apps/PostContractSubPackage/WorkArea',[
    'dojo/_base/declare',
    './ProjectProperties',
    './ProjectBreakdown',
    ...
    './VariationOrder',
    './MaterialOnSite',
    'dojo/i18n!buildspace/nls/PostContractSubPackage'], function(declare, ProjectProperties, ProjectBreakdown, ClaimRevisionSettingsForm, PreliminariesBillManager, StandardBillManager, VariationOrder, MaterialOnSite, nls){

    var ClaimRevisionContainer = declare('buildspace.apps.PostContractSubPackage.ProjectRevisionContainer', dijit.layout.BorderContainer, {
    ...
    return declare('buildspace.apps.PostContractSubPackage.WorkArea', dijit.layout.TabContainer, {
        region: "center",
        ...
        removeBillTab: function (){
            ...
            for(var i in tac){
                ...
                if(tac[i].pane_info.type == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.TYPE_BILL){
        ...
        makeTab: function(item, options, closable){
            ...
            switch(parseInt(item.type)){
                case buildspace.apps.PostContract.ProjectStructureConstants.TYPE_BILL:
                    ...
                    if(item.bill_type == buildspace.apps.PostContract.ProjectStructureConstants.BILL_TYPE_PRELIMINARY) {
