define('buildspace/apps/PostContractSubPackage/ProjectProperties',[
    'dojo/_base/declare',
    "dojo/html",
    "dojo/dom",
    "dijit/form/Form",
    ...
    var MainInfoForm = declare("buildspace.apps.PostContractSubPackage.MainInfoFormWidget", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    return declare('buildspace.apps.PostContractSubPackage.ProjectProperties', dijit.layout.BorderContainer, {
        region: "center",
