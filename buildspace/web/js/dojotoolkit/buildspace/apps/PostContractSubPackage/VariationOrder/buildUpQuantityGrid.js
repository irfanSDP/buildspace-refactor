define('buildspace/apps/PostContractSubPackage/VariationOrder/buildUpQuantityGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var BuildUpQuantityGrid = declare('buildspace.apps.PostContractSubPackage.VariationOrder.BuildUpQuantity.grid', dojox.grid.EnhancedGrid, {
    ...
    return declare('buildspace.apps.PostContractSubPackage.VariationOrder.BuildUpQuantityGrid', dijit.layout.BorderContainer, {
