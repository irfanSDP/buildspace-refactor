define('buildspace/apps/PostContractSubPackage/BillManager/editBillNoteDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var EditBillNoteForm = declare("buildspace.apps.PostContractSubPackage.BillManager.EditBillNoteForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        save: function(){
            var self = this,
                ...
                values = dojo.formToObject(self.editItemNoteForm.id),
                xhrArgs = {
                    url: self.updateUrl,
                    content: values,
                    handleAs: 'json',
    ...
    return declare('buildspace.apps.PostContractSubPackage.BillManager.EditBillNoteDialog', dijit.Dialog, {
