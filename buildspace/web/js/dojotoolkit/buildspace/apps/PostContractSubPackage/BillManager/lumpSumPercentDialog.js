define('buildspace/apps/PostContractSubPackage/BillManager/lumpSumPercentDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/when",
    "dojo/html",
    ...
    var LumpSumPercentForm = declare("buildspace.apps.PostContractSubPackage.BillManager.LumpSumPercentForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    return declare('buildspace.apps.PostContractSubPackage.BillManager.LumpSumPercentDialog', dijit.Dialog, {
