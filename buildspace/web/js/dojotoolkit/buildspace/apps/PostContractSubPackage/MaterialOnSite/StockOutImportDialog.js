...
(function() {
  define("buildspace/apps/PostContractSubPackage/MaterialOnSite/StockOutImportDialog", ["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/connect", "dojo/when", "dojo/html", "dojo/dom", "dojo/keys", "dojo/dom-style", "dojox/layout/ContentPane", "buildspace/widget/grid/cells/Formatter", "dojox/grid/enhanced/plugins/IndirectSelection", 'dojo/i18n!../../../nls/StockOut'], function(declare, lang, connect, when_, html, dom, keys, domStyle, ContentPane, GridFormatter, IndirectSelection, nls) {
    var importGridContainer, importResourceGrid;
    importResourceGrid = declare("buildspace.apps.MaterialOnSite.ImportStockOutItemGrid", dojox.grid.EnhancedGrid, {
      type: null,
      dialogWidget: null,
      _csrf_token: null,
      resource: null,
      ...
      disableToolbarButtons: function(isDisable) {
        var importBtn;
        importBtn = dijit.byId("ImportStockOutItemGrid-Import-button");
        return importBtn._setDisabledAttr(isDisable);
      },
      importFromStockOut: function() {
        ...
        if (itemIds.length > 0) {
          ...
          pb.show();
          xhrArgs = {
            url: "subPackageMaterialOnSite/importStockOutItems",
            content: {
    ...
    importGridContainer = declare("buildspace.apps.MaterialOnSite.ImportStockOutItemGridContainer", dijit.layout.BorderContainer, {
      ...
      postCreate: function() {
        ...
        if (self.type === "tree") {
          ...
          toolbar.addChild(new dijit.form.Button({
            id: "ImportStockOutItemGrid-Import-button",
            label: nls["import"],
            iconClass: "icon-16-container icon-16-import",
            disabled: true,
            onClick: function() {
              return grid.importFromStockOut();
            }
          }));
        ...
        container = dijit.byId("materialOnSiteQuantityFromStockOut-stackContainer");
        if (container) {
    ...
    return declare("buildspace.apps.MaterialOnSite.ImportResourceDialog", dijit.Dialog, {
      ...
      createContent: function() {
        ...
        store = dojo.data.ItemFileWriteStore({
          url: "stockOut/getResourceWithStockInsByProject/projectId/" + self.subPackage.project_structure_id[0]
        });
        content = new importGridContainer({
          gridOpts: {
            ...
            onRowDblClick: function(e) {
              ...
              if (_item.id > 0) {
                return self.createResourceTradeGrid(_item);
              }
            }
          }
        });
      ...
      createResourceTradeGrid: function(resource) {
        ...
        store = new dojo.data.ItemFileWriteStore({
          url: "stockOut/getResourceTradeWithStockInsByProject/projectId/" + self.subPackage.project_structure_id[0] + "/resourceId/" + resource.id[0]
        });
      ...
      createItemGrid: function(resourceTrade) {
        ...
        formatter = new GridFormatter();
        store = new dojo.data.ItemFileWriteStore({
          url: "stockOut/getItemListingsWithDeliveryOrder/projectId/" + self.subPackage.project_structure_id[0] + "/resourceTradeId/" + resourceTrade.id[0]
        });
        return new importGridContainer({
      ...
      makeGridContainer: function(content) {
        ...
        stackContainer = dijit.byId("materialOnSiteQuantityFromStockOut-stackContainer");
        if (stackContainer) {
          dijit.byId("materialOnSiteQuantityFromStockOut-stackContainer").destroyRecursive();
        }
        stackContainer = new dijit.layout.StackContainer({
          style: "width:100%;height:100%;border:0px;",
          region: "center",
          id: "materialOnSiteQuantityFromStockOut-stackContainer"
        });
        ...
        controller = new dijit.layout.StackController({
          region: "top",
          containerId: "materialOnSiteQuantityFromStockOut-stackContainer"
        });
        ...
        dojo.subscribe("materialOnSiteQuantityFromStockOut-stackContainer-selectChild", "", function(page) {
          var children, index, widget, _results;
          widget = dijit.byId("materialOnSiteQuantityFromStockOut-stackContainer");
          if (widget) {
