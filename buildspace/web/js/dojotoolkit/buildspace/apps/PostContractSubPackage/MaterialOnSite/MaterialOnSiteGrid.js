define('buildspace/apps/PostContractSubPackage/MaterialOnSite/MaterialOnSiteGrid',[
    'dojo/_base/declare',
    "dojo/_base/connect",
    'dojo/_base/lang',
    'dojo/_base/html',
    ...
    var MaterialOnSiteGrid = declare('buildspace.apps.PostContractSubPackage.MaterialOnSite.MaterialOnSiteEnhancedGrid', EnhancedGrid, {
        type: null,
        ...
        postCreate: function(){
            ...
            if(!this.locked){
                this.on("RowContextMenu", function(e){
                    ...
                    if(self.type == "vo" || self.type == "vo-items" && self.materialOnSite.status[0] == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.MATERIAL_ON_SITE_THIS_CLAIM){
                        self.contextMenu(e);
                        if(item.id > 0){
        ...
        canEdit: function(inCell, inRowIndex){
            ...
            if(inCell != undefined){
                ...
                if(this.type=="vo"){
                    ...
                    if (item.id > 0 && item.status[0] == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.MATERIAL_ON_SITE_CLAIMED){
                        window.setTimeout(function() {
        ...
        disableToolbarButtons: function(isDisable, buttonsToEnable){
            ...
            switch(this.type){
                case 'vo':
                    id = 'materialOnSite-'+this.subPackage.id;
                    break;
                case 'vo-items':
                    id = 'materialOnSite-'+this.subPackage.id+'_'+this.materialOnSite.id+'-items';
                    break;
                default:
    ...
    return declare('buildspace.apps.PostContractSubPackage.MaterialOnSite.MaterialOnSiteGrid', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        ...
        postCreate: function(){
            ...
            switch(this.type){
                case 'vo':
                    id = 'materialOnSite-'+this.subPackage.id;
                    stackContainerId = 'materialOnSite-'+this.subPackage.id;
                    break;
                case 'vo-items':
                    id = 'materialOnSite-'+this.subPackage.id+'_'+this.materialOnSite.id+'-items';
                    stackContainerId = 'materialOnSiteItems-'+this.subPackage.id+'_'+this.materialOnSite.id;
                    break;
                default:
                    throw new Error("type must be set!");
                    break;
