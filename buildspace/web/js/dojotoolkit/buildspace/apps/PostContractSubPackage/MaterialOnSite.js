define('buildspace/apps/PostContractSubPackage/MaterialOnSite',[
    'dojo/_base/declare',
    'dojo/aspect',
    'dojo/currency',
    'dojo/number',
    ...
    var CustomFormatter = {
        statusCellFormatter: function(cellValue, rowIdx, cell){
            ...
            if(cellValue == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.MATERIAL_ON_SITE_CLAIMED){
    ...
    return declare('buildspace.apps.PostContractSubPackage.MaterialOnSite', dijit.layout.BorderContainer, {
        ...
        postCreate: function() {
            ...
            var statusOptions = {
                ...
                values: [
                    buildspace.apps.PostContractSubPackage.ProjectStructureConstants.MATERIAL_ON_SITE_THIS_CLAIM,
                    buildspace.apps.PostContractSubPackage.ProjectStructureConstants.MATERIAL_ON_SITE_CLAIMED
                ]
            };
            ...
            var self = this,
                ...
                store = dojo.data.ItemFileWriteStore({
                    url: "subPackageMaterialOnSite/getMaterialOnSiteList/subPackageId/"+self.subPackage.id,
                    clearOnClose: true
                }),
                grid = new MaterialOnSiteGrid({
                    id: 'material_on_site-'+self.subPackage.id,
                    stackContainerTitle: nls.scheduleOfRates,
                    pageId: 'material_on_site-'+self.subPackage.id,
                    subPackage: self.subPackage,
                    type: 'vo',
                    gridOpts: {
                        store: store,
                        addUrl: 'subPackageMaterialOnSite/materialOnSiteAdd',
                        updateUrl: 'subPackageMaterialOnSite/materialOnSiteUpdate',
                        deleteUrl: 'subPackageMaterialOnSite/materialOnSiteDelete',
                        structure: [
        ...
        makeItemGrid: function(materialOnSite) {
            ...
            var unitQuery = dojo.xhrGet({
                    url: "subPackageMaterialOnSite/getUnits",
                    handleAs: "json"
                }),
            ...
            when(unitQuery, function(uom){
                ...
                var hierarchyTypes = {
                    ...
                    formatter = new GridFormatter(),
                    store = dojo.data.ItemFileWriteStore({
                        url: "subPackageMaterialOnSite/getMaterialOnSiteItemList/id/"+materialOnSite.id,
                        clearOnClose: true
                    }),
                    structure = [{
                        name: 'No',
                        ...
                        field: 'description',
                        width: 'auto',
                        editable: materialOnSite.status[0] == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.MATERIAL_ON_SITE_THIS_CLAIM,
                        ...
                        width: '120px',
                        cellType: 'buildspace.widget.grid.cells.FormulaTextBox',
                        formatter: materialOnSite.status[0] == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.MATERIAL_ON_SITE_THIS_CLAIM ? CustomFormatter.currencyCellFormatter : formatter.unEditableCurrencyCellFormatter,
                        noresize: true
                    },{
                        name: nls.amount,
                        field: 'amount',
                    ...
                    grid = new MaterialOnSiteGrid({
                        ...
                        type: 'vo-items',
                        locked: materialOnSite.status[0] == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.MATERIAL_ON_SITE_CLAIMED,
                        gridOpts: {
                            store: store,
                            escapeHTMLInData: false,
                            addUrl: 'subPackageMaterialOnSite/materialOnSiteItemAdd',
                            updateUrl: 'subPackageMaterialOnSite/materialOnSiteItemUpdate',
                            deleteUrl: 'subPackageMaterialOnSite/materialOnSiteItemDelete',
                            indentUrl: 'subPackageMaterialOnSite/materialOnSiteItemIndent',
                            outdentUrl: 'subPackageMaterialOnSite/materialOnSiteItemOutdent',
                            pasteUrl: 'subPackageMaterialOnSite/materialOnSiteItemPaste',
                            structure: structure
                        }
                    });

                var title = materialOnSite.description;
                var pageId = 'material_on_site_items-'+materialOnSite.id+'-'+self.subPackage.id+'-page';
        ...
        appendNewStack: function(content, pageId, title) {
            ...
            var container = dijit.byId('materialOnSite-'+self.subPackage.id+'-stackContainer');
