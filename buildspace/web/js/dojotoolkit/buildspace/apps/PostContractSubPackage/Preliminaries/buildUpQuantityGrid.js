define('buildspace/apps/PostContractSubPackage/Preliminaries/buildUpQuantityGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var BuildUpQuantityGrid = declare('buildspace.apps.PostContractSubPackage.BuildUpQuantity.grid', dojox.grid.EnhancedGrid, {
    ...
    return declare('buildspace.apps.PostContractSubPackage.BuildUpQuantityGrid', dijit.layout.BorderContainer, {
