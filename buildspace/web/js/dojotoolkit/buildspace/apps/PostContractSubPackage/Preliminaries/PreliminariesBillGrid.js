define('buildspace/apps/PostContractSubPackage/Preliminaries/PreliminariesBillGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var BillGrid = declare('buildspace.apps.PostContractSubPackage.Preliminaries.PreliminariesBillGrid', dojox.grid.EnhancedGrid, {
        type: null,
        billId: -1,
        elementId: 0,
        itemId: -1,
        ...
        doApplyCellEdit: function(val, rowIdx, inAttrName) {
            ...
            if ( item[inAttrName] && val !== item[inAttrName][0] ) {
                ...
                }, url = 'subPackagePostContractPreliminaries/updateItemClaim';
                ...
                if(item != undefined && item.id[0] > 0 && inCell != undefined) {
                    ...
                    if (splittedFieldName.length > 1) {
                        if ((item.type == buildspace.widget.grid.constants.HIERARCHY_TYPE_HEADER || item.type == buildspace.widget.grid.constants.HIERARCHY_TYPE_HEADER_N || item.type == buildspace.widget.grid.constants.HIERARCHY_TYPE_NOID) && (splittedFieldName[1] !== 'percentage' || splittedFieldName[1] !== 'amount')) {
                            ...
                            return;
                        } else if ( splittedFieldName[0] == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_INITIAL || splittedFieldName[0] == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_FINAL ) {
                            if ( item.claim_at_revision_id[0] != self.currentClaimRevision.id ) {
                                window.setTimeout(function() {
                                    self.edit.cancel();
                                    self.focus.setFocusIndex(inRowIndex, inCell.index);
                                }, 10);
        ...
        constructTypeColumnStructure: function(fixedColumns){
            ...
            dojo.forEach(typeColumns, function(typeColumn){
                ...
                for(var i=0;i<typeColumnChildren.length;i++) {
                    ...
                    if(self.type == 'tree') {
                        if ( fieldName == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_RECURRING || fieldName == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_TIMEBASED || fieldName == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_WORKBASED || fieldName == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_PREVIOUSCLAIM || fieldName == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_CURRENTCLAIM || fieldName == buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_UPTODATECLAIM ) {
                            editable = false;
                        }
                    } else {
                        editable = false;
        ...
        recurringElementGridStructure: function() {
            ...
            var recurringFields = [{
                ...
                field_name: buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_PREVIOUSCLAIM
            }, {
                name: nls.currentClaim,
                field_name: buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_CURRENTCLAIM
            }, {
                name: nls.upToDateClaim,
                field_name: buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_UPTODATECLAIM
        ...
        recurringItemGridStructure: function() {
            ...
            var recurringFields = [{
                name: nls.initial,
                field_name: buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_INITIAL
            }, {
                name: nls.recurring,
                field_name: buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_RECURRING
            }, {
                name: nls.timeBased,
                field_name: buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_TIMEBASED
            }, {
                name: nls.workBased,
                field_name: buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_WORKBASED
            }, {
                name: nls.final,
                field_name: buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_FINAL
            }, {
                name: nls.previousClaim,
                field_name: buildspace.apps.PostContractSubPackage.ProjectStructureConstants.PRELIM_COLUMN_PREVIOUSCLAIM
            }, {
    ...
    return declare('buildspace.apps.PostContractSubPackage.BillManager.PreliminariesBillGridBuilder', dijit.layout.BorderContainer, {
        pageId: 'page-00',
