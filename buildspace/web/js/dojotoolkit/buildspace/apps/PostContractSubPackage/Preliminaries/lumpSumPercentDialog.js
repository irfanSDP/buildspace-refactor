define('buildspace/apps/PostContractSubPackage/Preliminaries/lumpSumPercentDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/when",
    "dojo/html",
    ...
    var LumpSumPercentForm = declare("buildspace.apps.PostContractSubPackage.Preliminaries.LumpSumPercentForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    return declare('buildspace.apps.PostContractSubPackage.Preliminaries.LumpSumPercentDialog', dijit.Dialog, {
        ...
        createContent: function(){
            var borderContainer = new dijit.layout.BorderContainer({
                style:"padding:0;margin:0;width:400px;height:150px;",
                gutters: false
            });
