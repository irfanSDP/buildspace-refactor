define('buildspace/apps/ProjectBuilder/ExportScheduleOfRateBillDialog', [
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var ExportBillForm = declare('buildspace.apps.ProjectBuilder.ExportScheduleOfRateBillForm', [Form,
        _WidgetBase,
        _TemplatedMixin,
        ...
        submit: function () {
            if (this.validate()) {
                ...
                buildspace.windowOpen('POST', 'scheduleOfRateBill/exportExcelByElement', {
                    filename: filename,
                    id: this.bill.id[0],
                    eids: values.eids,
                    wr: this.withRate,
    ...
    var ExportBillDialog = declare('buildspace.apps.ProjectBuilder.ExportScheduleOfRateBillDialog', dijit.Dialog, {
    ...
    var ExportItemGrid = declare('buildspace.apps.ProjectBuilder.ExportScheduleOfRateBillItemGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        bill: null,
        dialogWidget: null,
        ...
        disableToolbarButtons: function (isDisable) {
            var exportBtn = dijit.byId('ExportScheduleOfRateBillItemGrid-' + this.bill.id + 'Export-button');
    ...
    var ExportGridContainer = declare('buildspace.apps.ProjectBuilder.ExportScheduleOfRateBillItemGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        ...
        postCreate: function () {
            ...
            if (this.type != 'tree') {
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        id: 'ExportScheduleOfRateBillItemGrid-' + self.bill.id + 'Export-button',
                        label: nls.export,
            ...
            var container = dijit.byId('ProjectBuilder-schedule_of_rate_bill_export_' + this.bill.id + '-stackContainer');
            if (container) {
    ...
    return declare('buildspace.apps.ProjectBuilder.ExportScheduleOfRateBillItemDialog', dijit.Dialog, {
        style: "padding:0px;margin:0px;",
        title: nls.exportFromScheduleOfRateBill,
        selectedItem: null,
        bill: null,
        billGrid: null,
        buildRendering: function () {
        ...
        createContent: function () {
            ...
            var formatter = new GridFormatter(),
                store = dojo.data.ItemFileWriteStore({
                    url: "scheduleOfRateBill/getElementList/id/" + self.bill.id
                }),
        ...
        createItemGrid: function (element) {
            ...
            var store = new dojo.data.ItemFileWriteStore({
                url: "scheduleOfRateBill/getItemList/id/" + element.id + '/bill_id/' + self.bill.id
            });
        ...
        makeGridContainer: function (content, title) {
            var id = this.bill.id;
            var stackContainer = dijit.byId('ProjectBuilder-schedule_of_rate_bill_export_' + id + '-stackContainer');
            if (stackContainer) {
                dijit.byId('ProjectBuilder-schedule_of_rate_bill_export_' + id + '-stackContainer').destroyRecursive();
            }

            stackContainer = new dijit.layout.StackContainer({
                style: 'width:100%;height:100%;border:0px;',
                region: "center",
                id: 'ProjectBuilder-schedule_of_rate_bill_export_' + id + '-stackContainer'
            });
            ...
            var controller = new dijit.layout.StackController({
                region: "top",
                containerId: 'ProjectBuilder-schedule_of_rate_bill_export_' + id + '-stackContainer'
            });
            ...
            dojo.subscribe('ProjectBuilder-schedule_of_rate_bill_export_' + id + '-stackContainer-selectChild', "", function (page) {
                var widget = dijit.byId('ProjectBuilder-schedule_of_rate_bill_export_' + id + '-stackContainer');
                if (widget) {
