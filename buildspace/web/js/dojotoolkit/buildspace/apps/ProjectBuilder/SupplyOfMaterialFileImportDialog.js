define('buildspace/apps/ProjectBuilder/SupplyOfMaterialFileImportDialog', [
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/dom-construct",
    ...
    var FileImportGrid = declare('buildspace.apps.ProjectBuilder.SupplyOfMaterialFileImportGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        bill: null,
        dialogWidget: null,
        ...
        importFile: function (withRate, withQuantity, withBillRef, asNewBill) {
            ...
            if (itemIds.length > 0) {
                ...
                dojo.xhrPost({
                    url: 'supplyOfMaterialImportFile/' + action,
                    content: {
    ...
    var FileImportGridContainer = declare('buildspace.apps.ProjectBuilder.SupplyOfMaterialFileImportGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        ...
        postCreate: function () {
                ...
                if (this.importType == buildspace.constants.FILE_IMPORT_TYPE_BUILDSPACE) {
                    toolbar.addChild(
                        new dijit.form.Button({
                            ...
                            disabled: (this.bill.hasOwnProperty('type') && this.bill.type[0] == buildspace.apps.ProjectBuilder.ProjectStructureConstants.TYPE_SUPPLY_OF_MATERIAL_BILL) ? false : true,
            ...
            var container = dijit.byId('ProjectBuilder-supply-of-material-item_import_list_' + this.bill.id[0] + '-stackContainer');
    ...
    var FileImportGridDialog = declare('buildspace.apps.ProjectBuilder.SupplyOfMaterialFileImportGridDialog', dijit.Dialog, {
        ...
        createItemGrid: function (element) {
            ...
            FileImportGridContainer({
                ...
                pageId: 'ProjectBuilder-supply-of-material-item_import_list-page_item-' + this.bill.id[0] + '_' + element.id,
                bill: this.bill,
        ...
        makeGridContainer: function (content, title) {
            ...
            var stackContainer = dijit.byId('ProjectBuilder-supply-of-material-item_import_list_' + id + '-stackContainer');
            if (stackContainer) {
                dijit.byId('ProjectBuilder-supply-of-material-item_import_list_' + id + '-stackContainer').destroyRecursive(true);
            }

            stackContainer = new dijit.layout.StackContainer({
                style: 'width:100%;height:100%;border:0px;',
                region: "center",
                id: 'ProjectBuilder-supply-of-material-item_import_list_' + id + '-stackContainer'
            });
            ...
            var controller = new dijit.layout.StackController({
                region: "top",
                containerId: 'ProjectBuilder-supply-of-material-item_import_list_' + id + '-stackContainer'
            });
            ...
            dojo.subscribe('ProjectBuilder-supply-of-material-item_import_list_' + id + '-stackContainer-selectChild', "", function (page) {
                var widget = dijit.byId('ProjectBuilder-supply-of-material-item_import_list_' + id + '-stackContainer');
                if (widget) {
    ...
    var FilePreviewGridDialog = declare('buildspace.apps.ProjectBuilder.FilePreviewGridDialog', dijit.Dialog, {
        ...
        createContent: function () {
            ...
            var store = dojo.data.ItemFileWriteStore({
                ...
                content = FilePreviewGridContainer({
                    pageId: 'import_list-page_library-' + this.bill.id[0],
                    bill: this.bill,
                    uploadUrl: "supplyOfMaterialImportFile/importExcel",
                    gridOpts: {
                        importType: this.importType,
                        store: store,
                        gridData: this.gridData,
        ...
        makeGridContainer: function (content, title) {
            ...
            var stackContainer = dijit.byId('ProjectBuilder-supply-of-material-item_import_list_' + id + '-stackContainer');
            if (stackContainer) {
                dijit.byId('ProjectBuilder-supply-of-material-item_import_list_' + id + '-stackContainer').destroyRecursive();
            }
    ...
    return declare('buildspace.apps.ProjectBuilder.FileImportDialog', dijit.Dialog, {
        style: "padding:0;margin:0;",
        title: nls.importSupplyOfMaterialFile,
        selectedItem: null,
        bill: null,
        billGrid: null,
        uploadUrl: null,
