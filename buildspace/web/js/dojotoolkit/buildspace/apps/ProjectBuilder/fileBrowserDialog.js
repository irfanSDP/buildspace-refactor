define('buildspace/apps/ProjectBuilder/fileBrowserDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var FileBrowserGrid = declare('buildspace.apps.ProjectBuilder.FileBrowserGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        projectId: 0,
        dialogWidget: null,
        ...
        deleteRow: function(rowIndex){
            ...
            pb.show();
            var xhrArgs = {
                url: "billManagerExportFile/deleteFile",
                content: { id: item.id },
                handleAs: 'json',
                load: function(data) {
                    if(data.success){
    ...
    var FileBrowserGridContainer = declare('buildspace.apps.ProjectBuilder.FileBrowserGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        ...
        postCreate: function(){
            ...
            var container = dijit.byId('ProjectBuilder-file_browser_'+this.projectId+'_'+this.billElementId+'-stackContainer');
            if(container){
    ...
    return declare('buildspace.apps.ProjectBuilder.FileBrowserDialog', dijit.Dialog, {
        ...
        createContent: function(){
            ...
            var formatter = new GridFormatter(),
                store = dojo.data.ItemFileWriteStore({
                    url: "billManagerExportFile/getFileByProject/id/"+self.projectId
                }),
                content = FileBrowserGridContainer({
                    ...
                    gridOpts: {
                        ...
                        structure: [
                            ...
                            {name: nls.billTitle, field: 'bill_title',  width:'120px' },
                            {name: nls.filetype, field: 'file_type', styles:'text-align:center;', width:'80px' },
                            {name: nls.created_at, field: 'created_at', styles:'text-align:center;', width:'150px' },
        ...
        makeGridContainer: function(content, title){
            ...
            var stackContainer = dijit.byId('ProjectBuilder-file_browser_'+id+'-stackContainer');
            if(stackContainer){
                dijit.byId('ProjectBuilder-file_browser_'+id+'-stackContainer').destroyRecursive();
            }

            stackContainer = new dijit.layout.StackContainer({
                style:'width:100%;height:100%;border:0px;',
                region: "center",
                id: 'ProjectBuilder-file_browser_'+id+'-stackContainer'
            });
            ...
            var controller = new dijit.layout.StackController({
                region: "top",
                containerId: 'ProjectBuilder-file_browser_'+id+'-stackContainer'
            });
