define('buildspace/apps/ProjectBuilder/BillManager/AddResourceCategoryDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var AddResourceCategoryGrid = declare('buildspace.apps.ProjectBuilder.BillManager.AddResourceCategoryGrid', dojox.grid.EnhancedGrid, {
        billId: 0,
        billItem: null,
        currencyAbbr: null,
        billGridStore: null,
    ...
    var Formatter = declare("buildspace.apps.ProjectBuilder.BillManager.AddResourceCategoryGrid.CellFormatter", null, {
    ...
    return declare('buildspace.apps.ProjectBuilder.BillManager.AddResourceCategoryDialog', dijit.Dialog, {
