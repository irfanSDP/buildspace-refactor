define('buildspace/apps/ProjectBuilder/BillManager/importProjectItemDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
...
], function(declare, lang, connect, when, html, dom, keys, domStyle, aspect, GridFormatter, IndirectSelection, Filter, nls){

    var ImportProjectItemGrid = declare('buildspace.apps.ProjectBuilder.BillManager.ImportProjectItemGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        billId: 0,
        billElementId: 0,
    ...
    var ImportGridContainer = declare('buildspace.apps.ProjectBuilder.BillManager.ImportProjectItemGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
    ...
    return declare('buildspace.apps.ProjectBuilder.BillManager.ImportProjectItemDialog', dijit.Dialog, {
