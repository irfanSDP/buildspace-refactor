define('buildspace/apps/ProjectBuilder/BillManager/itemHtmlEditorDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/when",
    "dojo/html",
    ...
    var ItemHtmlEditorForm = declare("buildspace.apps.ProjectBuilder.BillManager.ItemHtmlEditorForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    return declare('buildspace.apps.ProjectBuilder.BillManager.ItemHtmlEditorDialog', dijit.Dialog, {
