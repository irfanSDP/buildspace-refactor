define('buildspace/apps/ProjectBuilder/BillManager/importItemDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var ImportItemGrid = declare('buildspace.apps.ProjectBuilder.BillManager.ImportItemGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        billId: 0,
        billElementId: 0,
    ...
    var ImportGridContainer = declare('buildspace.apps.ProjectBuilder.BillManager.ImportItemGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        ...
        postCreate: function(){
            ...
            lang.mixin(this.gridOpts, {
                type: this.type,
                billId: this.billId,
                billElementId: this.billElementId,
                region:"center"
            });

            var grid = this.grid = new ImportItemGrid(this.gridOpts);
            ...
            if(this.type == 'tree'){
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        id: 'ImportItemGrid-'+this.billElementId+'_'+this.billId+'ImportWithRate-button',
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        id: 'ImportItemGrid-'+this.billElementId+'_'+this.billId+'ImportWithoutRate-button',
    ...
    return declare('buildspace.apps.ProjectBuilder.BillManager.ImportItemDialog', dijit.Dialog, {
