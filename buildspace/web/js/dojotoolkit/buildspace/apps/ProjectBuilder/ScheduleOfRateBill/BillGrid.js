define('buildspace/apps/ProjectBuilder/ScheduleOfRateBill/BillGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var BillGrid = declare('buildspace.apps.ProjectBuilder.ScheduleOfRateBill.BillGrid', dojox.grid.EnhancedGrid, {
        type: null,
        billId: -1,
        elementId: 0,
        itemId: -1,
    ...
    return declare('buildspace.apps.ProjectBuilder.ScheduleOfRateBill.BillGridBuilder', dijit.layout.BorderContainer, {
        pageId: 'page-00',
            ...
            if(this.type != 'tree'){
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        ...
                        onClick: function(e) {
                            window.open('scheduleOfRateBill/printBill/id/' + self.billId, '_blank');
                        }
                    })
                );
            }
