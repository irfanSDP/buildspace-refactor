...
(function() {
    define(['dojo/_base/declare', 'dijit/layout/BorderContainer', 'dijit/layout/TabContainer', 'dijit/Toolbar', 'dijit/form/Button', 'dojo/request', 'dojo/dom', 'dojo/dom-attr', 'dojo/_base/lang', 'dojo/i18n!buildspace/nls/PrintLayoutSetting'], function(declare, BorderContainer, TabContainer, Toolbar, Button, request, dom, domAttr, lang, nls) {
        return declare('buildspace.apps.ProjectBuilder.ScheduleOfRateBill.BillPrintoutSetting', BorderContainer, {
            sorBillLayoutSettingId: 1,
            region: 'center',
            saveURL: 'scheduleOfRateBill/saveBillPrintOutSettings',
            ...
            renderTabs: function(layoutSettings) {
                ...
                settings = {
                    headStyling: {
                        ...
                        id: "scheduleOfRateBill_headSettings-" + this.sorBillLayoutSettingId
                    },
                    fontNumber: {
                        title: nls.fontNumFormat,
                        nameSpace: 'FontNumberFormatForm',
                        dataName: 'layoutSetting',
                        id: "scheduleOfRateBill_fontNumber-" + this.sorBillLayoutSettingId
                    },
                    pageFormat: {
                        title: nls.pageFormat,
                        nameSpace: 'PageFormatForm',
                        dataName: 'layoutSetting',
                        id: "scheduleOfRateBill_pageFormat-" + this.sorBillLayoutSettingId
                    },
                    standardPhrase: {
                        title: nls.standardPhrases,
                        nameSpace: 'StandardPhrasesForm',
                        dataName: 'phrase',
                        id: "scheduleOfRateBill_standardPhrases-" + this.sorBillLayoutSettingId
                    },
                    headerFooter: {
                        title: nls.headerFooter,
                        nameSpace: 'HeaderFooterForm',
                        dataName: 'phrase',
                        id: "scheduleOfRateBill_headerFooter-" + this.sorBillLayoutSettingId
                    }
                };
                tc = new TabContainer({
                ...
                for (type in settings) {
                    ...
                    form[counter] = new buildspace.apps.ProjectBuilder.ScheduleOfRateBill.BillPrintoutSetting[setting.nameSpace]({
                        sorBillLayoutSettingId: self.sorBillLayoutSettingId,
            ...
            getSettings: function() {
                ...
                request.get("scheduleOfRateBill/getBillPrintOutSettings/id/" + this.sorBillLayoutSettingId, {
                    sync: true,
                    handleAs: 'json',
                    preventCache: true
