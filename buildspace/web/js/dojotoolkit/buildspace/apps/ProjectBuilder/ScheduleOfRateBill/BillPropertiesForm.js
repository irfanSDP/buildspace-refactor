define('buildspace/apps/ProjectBuilder/ScheduleOfRateBill/BillPropertiesForm',[
    'dojo/_base/declare',
    "dojo/html",
    "dojo/dom",
    "dojo/dom-construct",
    ...
    var BillPropertiesMainInfoForm = declare("buildspace.apps.ProjectBuilder.ScheduleOfRateBill.BillPropertiesMainInfoForm", [Form,
        _WidgetBase,
        _TemplatedMixin,
                    ...
                    load: function(resp) {
                        ...
                        if(resp.success){
                            ...
                            for(var key in resp.errors){
                                ...
                                html.set(dom.byId("error-schedule_of_rate_bill_"+key), msg);
                            }
                        }
                        pb.hide();
                    },
    ...
    return declare("buildspace.apps.ProjectBuilder.ScheduleOfRateBill.BillPropertiesForm", dijit.layout.BorderContainer, {
