define('buildspace/apps/ProjectBuilder/ScheduleOfRateBillFileImportDialog', [
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/dom-construct",
    ...
    var FileImportGrid = declare('buildspace.apps.ProjectBuilder.ScheduleOfRateBillFileImportGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        bill: null,
        dialogWidget: null,
    ...
    var FileImportGridContainer = declare('buildspace.apps.ProjectBuilder.ScheduleOfRateBillFileImportGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        ...
        postCreate: function () {
                ...
                if (this.importType == buildspace.constants.FILE_IMPORT_TYPE_BUILDSPACE) {
                    toolbar.addChild(
                        new dijit.form.Button({
                            ...
                            disabled: (this.bill.hasOwnProperty('type') && this.bill.type[0] == buildspace.apps.ProjectBuilder.ProjectStructureConstants.TYPE_SCHEDULE_OF_RATE_BILL) ? false : true,
                            iconClass: "icon-16-container icon-16-paste",
                            onClick: function () {
                                grid.importFile(false);
                            }
                        })
                    );
            ...
            var container = dijit.byId('ProjectBuilder-schedule_of_rate_bill-item_import_list_' + this.bill.id[0] + '-stackContainer');
    ...
    var FileImportGridDialog = declare('buildspace.apps.ProjectBuilder.ScheduleOfRateBillFileImportGridDialog', dijit.Dialog, {
        style: "padding:0px;margin:0px;",
        title: nls.importScheduleOfRateBillFile,
        selectedItem: null,
        bill: null,
        billGrid: null,
        gridData: null,
                ...
                gridOpts: {
                    ...
                    structure: [
                        ...
                        {name: nls.description, field: 'description', width: 'auto'},
                        {
                            ...
                            width: '80px',
                            styles: 'text-align:center;',
                            formatter: formatter.infoFieldFormatter
                        },
                        {
                            name: nls.error,
                            field: 'error',
        ...
        createItemGrid: function (element) {
            ...
            FileImportGridContainer({
                ...
                pageId: 'ProjectBuilder-schedule_of_rate_bill-item_import_list-page_item-' + this.bill.id[0] + '_' + element.id,
                bill: this.bill,
        ...
        makeGridContainer: function (content, title) {
            ...
            var stackContainer = dijit.byId('ProjectBuilder-schedule_of_rate_bill-item_import_list_' + id + '-stackContainer');
            if (stackContainer) {
                dijit.byId('ProjectBuilder-schedule_of_rate_bill-item_import_list_' + id + '-stackContainer').destroyRecursive(true);
            }

            stackContainer = new dijit.layout.StackContainer({
                style: 'width:100%;height:100%;border:0px;',
                region: "center",
                id: 'ProjectBuilder-schedule_of_rate_bill-item_import_list_' + id + '-stackContainer'
            });
            ...
            var controller = new dijit.layout.StackController({
                region: "top",
                containerId: 'ProjectBuilder-schedule_of_rate_bill-item_import_list_' + id + '-stackContainer'
            });
            ...
            dojo.subscribe('ProjectBuilder-schedule_of_rate_bill-item_import_list_' + id + '-stackContainer-selectChild', "", function (page) {
                var widget = dijit.byId('ProjectBuilder-schedule_of_rate_bill-item_import_list_' + id + '-stackContainer');
                if (widget) {
    ...
    var FilePreviewGrid = declare('buildspace.apps.ProjectBuilder.ScheduleOfRateBillFilePreviewGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        dialogWidget: null,
        _csrf_token: null,
    ...
    var FilePreviewGridContainer = declare('buildspace.apps.ProjectBuilder.ScheduleOfRateBillFilePreviewGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        style: "padding:0px;width:100%;height:100%;",
        gutters: false,
        bill: null,
    ...
    var PreviewForm = declare("buildspace.apps.ProjectBuilder.ScheduleOfRateBillPreviewForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    var FilePreviewGridDialog = declare('buildspace.apps.ProjectBuilder.ScheduleOfRateBillFilePreviewGridDialog', dijit.Dialog, {
        ...
        createContent: function () {
            ...
            var store = dojo.data.ItemFileWriteStore({
                ...
                content = FilePreviewGridContainer({
                    pageId: 'import_list-page_library-' + this.bill.id[0],
                    bill: this.bill,
                    uploadUrl: "scheduleOfRateBill/importExcel",
                    gridOpts: {
                        importType: this.importType,
                        store: store,
                        gridData: this.gridData,
        ...
        makeGridContainer: function (content, title) {
            ...
            var stackContainer = dijit.byId('ProjectBuilder-schedule_of_rate_bill-item_import_list_' + id + '-stackContainer');
            if (stackContainer) {
                dijit.byId('ProjectBuilder-schedule_of_rate_bill-item_import_list_' + id + '-stackContainer').destroyRecursive();
            }
    ...
    var Form = declare("buildspace.apps.ProjectBuilder.ScheduleOfRateBillFileImportForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        uploadComplete: function (data) {
            ...
            if (data.hasOwnProperty('success') && !data.success) {
                ...
                if (data.preview) {
                    var previewGridDialog = new FilePreviewGridDialog({
                        bill: this.bill,
                        importType: this.importType,
    ...
    return declare('buildspace.apps.ProjectBuilder.ScheduleOfRateBillFileImportDialog', dijit.Dialog, {
        style: "padding:0;margin:0;",
        title: nls.importScheduleOfRateBillFile,
        selectedItem: null,
        bill: null,
