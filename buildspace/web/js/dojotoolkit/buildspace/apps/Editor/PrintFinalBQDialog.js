define('buildspace/apps/Editor/PrintFinalBQDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
...
], function(declare, lang, connect, when, html, dom, keys, domStyle, Form, _WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin, ValidationTextBox, Menu, DijitDialog, DropDownButton, DropDownMenu, MenuItem, PopupMenuItem, nls){

    var PrintFinalBQGrid = declare('buildspace.apps.Editor.PrintFinalBQGrid', dojox.grid.EnhancedGrid, {
        project: null,
        withPrice: true,
        region: 'center',
        ...
        postCreate: function(){
            ...
            this.on('RowClick', function(e){
                ...
                if(item && !isNaN(parseInt(String(item.id))) && colField == 'print'){
    ...
    var Formatter = declare("buildspace.apps.ViewTenderer.PrintBillGrid.CellFormatter", null, {
        ...
        printCellFormatter: function(cellValue, rowIdx){
            ...
            return (item && !isNaN(parseInt(String(item.id)))) ? '<a href="javascript:void(0);">'+nls.print+'</a>' : null;
        }
    });

    return declare('buildspace.apps.Editor.PrintFinalBQDialog', DijitDialog, {
