require([
    ...
    'buildspace/apps/ViewTenderer/_base'
], function(nls){

    buildspace.apps.ViewTenderer.ProjectStructureConstants = {
        TYPE_ROOT: 1,
        TYPE_LEVEL: 2,
        TYPE_BILL: 4,
    ...
    buildspace.apps.ViewTenderer.getBillTypeText = function(type){
        switch(parseInt(type)){
            case buildspace.apps.ViewTenderer.ProjectStructureConstants.BILL_TYPE_PROVISIONAL:
                return buildspace.apps.ViewTenderer.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_TEXT;
            case buildspace.apps.ViewTenderer.ProjectStructureConstants.BILL_TYPE_PRELIMINARY:
                return buildspace.apps.ViewTenderer.ProjectStructureConstants.BILL_TYPE_PRELIMINARY_TEXT;
            case buildspace.apps.ViewTenderer.ProjectStructureConstants.BILL_TYPE_STANDARD:
                return buildspace.apps.ViewTenderer.ProjectStructureConstants.BILL_TYPE_STANDARD_TEXT;
            default:
                return "";
        }
    }
