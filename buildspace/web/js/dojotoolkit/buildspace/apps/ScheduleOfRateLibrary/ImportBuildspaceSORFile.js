...
(function() {
    define('buildspace/apps/ScheduleOfRateLibrary/ImportBuildspaceSORFile', ["dojo/_base/declare", "dojo/on", 'dojo/_base/lang', "dojo/keys", "dojo/parser", "dijit/_WidgetBase", "dijit/_OnDijitClickMixin", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", 'dijit/Toolbar', 'dijit/form/Button', "dijit/layout/BorderContainer", "dijit/form/ValidationTextBox", "dijit/form/SimpleTextarea", "dijit/registry", "dojo/dom-style", "dojo/dom-form", "dojo/request", "dojox/validate/web", "dijit/form/Select", "dijit/form/FilteringSelect", "dojo/store/Memory", "dojox/form/Manager", "dojo/text!./templates/importBuildspaceSORFileForm.html", 'dojo/i18n!buildspace/nls/ScheduleOfRateLibrary'], function(declare, on_, lang, keys, parser, _WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin, Toolbar, Button, BorderContainer, ValidationTextBox, SimpleTextarea, registry, domStyle, domForm, request, web, Select, FilteringSelect, Memory, Manager, template, nls) {
        var ScheduleOfRateLibraryImportForm;
        ScheduleOfRateLibraryImportForm = declare("buildspace.apps.ScheduleOfRateLibrary.ScheduleOfRateLibraryImportForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
            ...
            createUploader: function() {
                ...
                this.uploader = new dojox.form.Uploader({
                    label: nls.importFromBuildSpaceSORFile,
                    uploadOnSelect: true,
                    style: 'height:24px;',
                    url: self.uploadUrl,
        ...
        return declare('buildspace.apps.ScheduleOfQuantity.ImportRFQSupplierRatesDialog', dijit.Dialog, {
            ...
            createContent: function() {
                ...
                form = new ScheduleOfRateLibraryImportForm({
