define('buildspace/apps/ScheduleOfRateLibrary/importResourceItemDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var ImportResourceItemGrid = declare('buildspace.apps.ScheduleOfRateLibrary.ImportResourceItemGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        libraryId: 0,
        libraryTradeId: 0,
        ...
        importItem: function(withRate){
            ...
            if( itemIds.length > 0){
                ...
                dojo.xhrPost({
                    url: 'scheduleOfRateImport/importResourceItems',
    ...
    var ImportGridContainer = declare('buildspace.apps.ScheduleOfRateLibrary.ImportResourceItemGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        ...
        createContent: function(){
            ...
            var formatter = new GridFormatter(),
                store = dojo.data.ItemFileWriteStore({
                    clearOnClose: true,
                    url: "scheduleOfRateImport/getResourceList"
                }),
