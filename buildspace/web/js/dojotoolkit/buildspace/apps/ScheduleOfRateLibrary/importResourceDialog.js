define('buildspace/apps/ScheduleOfRateLibrary/importResourceDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var ImportResourceGrid = declare('buildspace.apps.ScheduleOfRateLibrary.ImportResourceGrid', dojox.grid.EnhancedGrid, {
        type: null,
        itemId: 0,
        dialogWidget: null,
        _csrf_token: null,
        ...
        import: function(){
            ...
            if( itemIds.length > 0){
                ...
                pb.show();
                var xhrArgs = {
                    url: 'scheduleOfRate/importResourceItems',
    ...
    var ImportGridContainer = declare('buildspace.apps.ScheduleOfRateLibrary.ImportResourceGridContainer', dijit.layout.BorderContainer, {
    ...
    return declare('buildspace.apps.ScheduleOfRateLibrary.ImportResourceDialog', dijit.Dialog, {
