define("buildspace/apps/ProjectAnalyzer/plugins/TotalPane", [
    "dojo/_base/kernel",
    "dojo/_base/declare",
    "dojo/_base/array",
    "dojo/_base/connect",
    ...
    var _TotalPane = declare("buildspace.apps.ProjectAnalyzer.ResourceEnhancedGrid.plugins._TotalPane", [_Widget, _TemplatedMixin], {
    ...
    var TotalPane = declare("buildspace.apps.ProjectAnalyzer.ResourceEnhancedGrid.plugins.TotalPane", _Plugin, {
        name: "totalPane",
        position: 'bottom',
        init: function(){
            var g = this.grid;
