require([
    ...
    'buildspace/apps/PostContractSubPackageReport/_base',
    'buildspace/apps/PostContractSubPackageReport/SubPackageListingGrid'
], function(nls){
    buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants = {
        TYPE_ROOT: 1,
        TYPE_LEVEL: 2,
        TYPE_BILL: 4,
    ...
    buildspace.apps.PostContractSubPackageReport.getBillTypeText = function(itemType) {
        var itemTypeText;

        switch ( parseInt(itemType) )
        {
            case buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.BILL_TYPE_STANDARD:
                itemTypeText = buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.BILL_TYPE_STANDARD_TEXT;
                break;

            case buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.BILL_TYPE_PROVISIONAL:
                itemTypeText = buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_TEXT;
                break;

            case buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.BILL_TYPE_PRELIMINARY:
                itemTypeText = buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.BILL_TYPE_PRELIMINARY_TEXT;
                break;

            case buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.BILL_TYPE_PRIMECOST:
                itemTypeText = buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.BILL_TYPE_PRIMECOST_TEXT;
                break;
