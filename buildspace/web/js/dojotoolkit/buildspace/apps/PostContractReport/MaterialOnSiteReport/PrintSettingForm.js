...
(function() {
  define('buildspace/apps/PostContractReport/MaterialOnSiteReport/PrintSettingForm', ['dojo/_base/declare', 'dojo/_base/lang', "dojo/request", "dojo/dom-style", "dijit/_WidgetBase", "dijit/_OnDijitClickMixin", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", 'dijit/layout/BorderContainer', 'dijit/Toolbar', 'dijit/form/Button', "dojox/form/Manager", "dojo/text!./templates/printSettingForm.html", 'dojo/i18n!buildspace/nls/PostContract'], function(declare, lang, request, domStyle, _WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin, BorderContainer, Toolbar, Button, Manager, template, nls) {
    var printSettingForm;
    printSettingForm = declare("buildspace.apps.PostContractReport.MaterialOnSiteReport.PrintSettingForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
      ...
      startup: function() {
        ...
        return this["mosPrintSettingForm-" + this.projectId].setFormValues(this.formInfo);
      },
      ...
      save: function() {
        ...
        self = this;
        form = this["mosPrintSettingForm-" + this.projectId];
        if (!form.validate()) {
          return false;
        }
        formValues = dojo.formToObject(this["mosPrintSettingForm-" + this.projectId].id);
        ...
        pb.show();
        this.clearErrorMsg();
        return request.post("materialOnSite/savePrintSetting", {
          data: formValues,
          handleAs: 'json'
    ...
    return declare('buildspace.apps.PostContractReport.MaterialOnSiteReport.PrintSettingFormContainer', BorderContainer, {
      rootProject: null,
