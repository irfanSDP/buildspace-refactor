define('buildspace/apps/PostContractReport/MaterialOnSiteReport/MaterialOnSiteGrid', [
    'dojo/_base/declare',
    "dojo/_base/connect",
    'dojo/_base/lang',
    'dojo/_base/html',
    ...
    var MaterialOnSiteGrid = declare('buildspace.apps.PostContractReport.MaterialOnSiteReport.MaterialOnSiteReportEnhancedGrid', EnhancedGrid, {
        type: null,
    ...
    return declare('buildspace.apps.PostContractReport.MaterialOnSiteReport.MaterialOnSiteReportGrid', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        ...
        postCreate: function () {
            ...
            switch (this.type) {
                case 'vo':
                    id = 'materialOnSiteReport-' + this.project.id;
                    stackContainerId = 'materialOnSiteReport-' + this.project.id;
                    break;
                case 'vo-items':
                    id = 'materialOnSiteReport-' + this.project.id + '_' + this.materialOnSite.id + '-items';
                    stackContainerId = 'materialOnSiteItemsReport-' + this.project.id + '_' + this.materialOnSite.id;
                    break;
                default:
        ...
        openPrintSelectedMOSItems: function () {
            ...
            request.post('materialOnSiteReporting/getPrintPreviewSelectedItems', {
                handleAs: 'json',
                data: {
