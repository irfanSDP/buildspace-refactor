      ...
      openPrintingDialog: function(self) {
        ...
        return request.get("viewTendererReporting/getPrintingInformation", {
          ...
          dialog = new PrintPreviewFormDialog({
            ...
            printURL: 'printReport/printPostContractElementWorkdoneOnly',
            exportURL: 'exportExcelReport/exportPostContractElementWorkdoneOnly',
            billId: self.billId,
