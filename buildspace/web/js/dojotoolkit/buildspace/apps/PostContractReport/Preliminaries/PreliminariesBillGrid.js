define('buildspace/apps/PostContractReport/Preliminaries/PreliminariesBillGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/aspect',
    'dojo/_base/connect',
    ...
    var reportingFormatter = declare("buildspace.apps.PostContractReport.Preliminaries.PreliminariesBillGridFormatter", null, {
        formulaPrelimCurrencyCellFormatter: function(cellValue, rowIdx, cell){
            ...
            if(item.type == buildspace.widget.grid.constants.HIERARCHY_TYPE_HEADER || item.type == buildspace.widget.grid.constants.HIERARCHY_TYPE_HEADER_N || item.type == buildspace.widget.grid.constants.HIERARCHY_TYPE_NOID){
                ...
                fieldName == buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_RECURRING ||
                fieldName == buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_TIMEBASED ||
                fieldName == buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_WORKBASED
                ) ) {
        ...
        prelimPercentFormatter: function(cellValue, rowIdx, cell){
            ...
            if(item.type == buildspace.widget.grid.constants.HIERARCHY_TYPE_HEADER || item.type == buildspace.widget.grid.constants.HIERARCHY_TYPE_HEADER_N || item.type == buildspace.widget.grid.constants.HIERARCHY_TYPE_NOID){
                ...
                fieldName == buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_PREVIOUSCLAIM ||
                fieldName == buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_CURRENTCLAIM ||
                fieldName == buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_UPTODATECLAIM
                ) ) {
                cell.customClasses.push('disable-cell');
            }
    ...
    var BillGrid = declare('buildspace.apps.PostContractReport.Preliminaries.PreliminariesBillGrid', dojox.grid.EnhancedGrid, {
        type: null,
        billId: -1,
        elementId: 0,
        itemId: -1,
        ...
        constructor:function(args) {
            ...
            this.gridReportingFormatter = new reportingFormatter();

            this.typeColumnChildren = [
                {name: nls.percent, field_name: 'percentage', width: '60px', styles: "text-align:right;", formatter: this.gridReportingFormatter.prelimPercentFormatter},
                {name: nls.amount, field_name: 'amount', width: '100px', styles: "text-align:right;", formatter: this.gridReportingFormatter.prelimAmountFormatter}
            ];
        ...
        setColumnStructure: function(){
            ...
            var editableModeElementGrid = false;
                ...
                var fixedColumns = this.fixedColumns = {
                    ...
                    cells: [
                        ...
                        },
                        {
                            ...
                            styles: "text-align:right;",
                            width: '75px',
                            formatter: self.gridReportingFormatter.formulaPrelimCurrencyCellFormatter,
                            noresize: true,
                            rowSpan: 2,
                            hidden: true,
                            showInCtxMenu: true
        ...
        recurringElementGridStructure: function() {
            ...
            var recurringFields = [{
                ...
                field_name: buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_PREVIOUSCLAIM
            }, {
                ...
                field_name: buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_UPTODATECLAIM
        ...
        recurringItemGridStructure: function() {
            ...
            var recurringFields = [{
                name: nls.initial,
                field_name: buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_INITIAL
            }, {
                name: nls.recurring,
                field_name: buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_RECURRING
            }, {
                name: nls.timeBased,
                field_name: buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_TIMEBASED
            }, {
                name: nls.workBased,
                field_name: buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_WORKBASED
            }, {
                name: nls.final,
                field_name: buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_FINAL
            }, {
                name: nls.previousClaim,
                field_name: buildspace.apps.PostContractReport.ProjectStructureConstants.PRELIM_COLUMN_PREVIOUSCLAIM
            }, {
    ...
    return declare('buildspace.apps.PostContractReport.BillManager.PreliminariesBillGridBuilder', dijit.layout.BorderContainer, {
        pageId: 'page-00',
        ...
        postCreate: function(){
            ...
            var container = dijit.byId('postContractReportBillGrid'+this.billId+'-stackContainer');
            if(container){
        ...
        openPrintAllSelectedItemDialog: function() {
            ...
            request.post('postContractPreliminaries/getPrintingSelectedItem', {
                handleAs: 'json',
                data: {
                    bill_id: self.billId,
        ...
        openPrintAllItemWithCurrentClaimMoreThanZero: function() {
            ...
            request.post('postContractPreliminaries/getPrintingItemWithCurrentClaimMoreThanZero', {
                handleAs: 'json',
                data: {
                    bill_id: self.billId
                }
        ...
        openPrintAllItemWithClaims: function() {
            ...
            request.post('postContractPreliminaries/getPrintingAllItemClaims', {
                handleAs: 'json',
                data: {
                    bill_id: self.billId
                }
