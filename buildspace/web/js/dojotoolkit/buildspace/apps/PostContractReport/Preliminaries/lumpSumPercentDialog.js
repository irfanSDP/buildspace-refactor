define('buildspace/apps/PostContractReport/Preliminaries/lumpSumPercentDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/when",
    "dojo/html",
    ...
    var Form = declare("buildspace.apps.PostContractReport.Preliminaries.LumpSumPercentForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    var Dialog = declare('buildspace.apps.PostContractReport.Preliminaries.LumpSumPercentDialog', dijit.Dialog, {
