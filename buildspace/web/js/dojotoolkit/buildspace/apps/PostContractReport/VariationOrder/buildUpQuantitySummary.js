define('buildspace/apps/PostContractReport/VariationOrder/buildUpQuantitySummary',[
    'dojo/_base/declare',
    "dojo/dom-style",
    "dijit/_WidgetBase",
    ...
    return declare("buildspace.apps.PostContractReport.VariationOrder.buildUpQuantitySummary", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        postCreate: function(){
            ...
            dojo.xhrGet({
                url: 'variationOrder/getBuildUpSummary',
        ...
        doApplyConversionFactor: function(){
            ...
            if(checked != this.applyConversionFactor){
                ...
                var self = this;
                dojo.xhrPost({
                    url: 'variationOrder/buildUpSummaryApplyConversionFactorUpdate',
        ...
        submitConversionFactorAmount: function(){
            ...
            if(amount != this.conversionFactorAmount){
                ...
                var self = this;
                dojo.xhrPost({
                    url: 'variationOrder/buildUpSummaryConversionFactorUpdate',
        ...
        submitRoundingType: function(){
            ...
            if(roundingType != this.roundingType){
                ...
                var self = this;
                dojo.xhrPost({
                    url: 'variationOrder/buildUpSummaryRoundingUpdate',
