define('buildspace/apps/PostContractReport/StandardBillManager', [
        'dojo/_base/declare',
        'dojo/_base/connect',
        "dojo/dom-style",
        "dijit/TooltipDialog",
    ...
    function (declare, connect, domStyle, TooltipDialog, popup, FormulatedColumn, when, number, currency, ContentPane, EnhancedGrid, GridFormatter, ScheduleOfQuantityGrid, BuildUpQuantitySummary, request, aspect, JSON, Memory, IndirectSelection, DropDownMenu, DropDownButton, MenuItem, StandardBillGrid, PrintPreviewElementByTypesDialog, PrintPreviewElementByTypesByUnitsWithClaimDialog, nls) {

        var Grid = declare('buildspace.apps.PostContractReport.TypeGrid', EnhancedGrid, {
            rootProject: null,
            style: "border:none;",
            region: 'center',
            pageId: null,
        ...
        var StandardBillManagerContainer = declare('buildspace.apps.PostContractReport.StandardBillManager', dijit.layout.BorderContainer, {
            style: "padding:0px;border:0px;width:100%;height:100%;",
            gutters: false,
            billId: null,
            rootProject: null,
            typesPreviewStore: null,
            elementPreviewStore: [],
            itemPreviewStore: [],
            billInfo: null,
            constructor: function (args) {
            ...
            postCreate: function () {
                ...
                dojo.subscribe('postContractReportStandardBill' + self.billId + '-stackContainer-selectChild', "", function (page) {
                    var widget = dijit.byId('postContractReportStandardBill' + self.billId + '-stackContainer');
                    if (widget) {
            ...
            createTypeGrid: function () {
                ...
                var stackContainer = dijit.byId('postContractReportStandardBill' + this.billId + '-stackContainer');
                ...
                stackContainer = this.stackContainer = new dijit.layout.StackContainer({
                    ...
                    region: "center",
                    id: 'postContractReportStandardBill' + this.billId + '-stackContainer'
                });
                ...
                billInfoQuery.then(function (billInfo) {
                    ...
                    try {
                        ...
                        var controller = new dijit.layout.StackController({
                            region: "top",
                            containerId: 'postContractReportStandardBill' + me.billId + '-stackContainer'
                        });
                ...
                scheduleOfQtyQuery.then(function (linkInfo) {
                    ...
                    if (linkInfo.has_linked_qty) {
                        ...
                        scheduleOfQtyGrid = ScheduleOfQuantityGrid({
                            ...
                            billColumnSettingId: billColumnSettingId,
                            disableEditingMode: true,
                            stackContainerId: 'postContractReportStandardBill' + self.billId + '-stackContainer',
                            gridOpts: {
                                qtyType: type,
                    ...
                    var manualGrid = declare('buildspace.apps.PostContractReport.BillManager.BuildUpQtyGrid', dojox.grid.EnhancedGrid, {
                    ...
                    tabContainer.addChild(new manualGrid);
                    ...
                    var container = dijit.byId('postContractReportStandardBill' + self.billId + '-stackContainer');
                    if (container) {
            ...
            openPrintPreviewDialogByTypes: function () {
                ...
                request.post('postContractReport/getPrintingPreviewDataByTypes', {
                    handleAs: 'json',
                    data: {
                        bill_id: self.billId
                    }
            ...
            openPrintPreviewDialogByUnitsWithClaim: function () {
                ...
                request.post('postContractReport/getPrintingPreviewDataByUnitsWithClaim', {
                    handleAs: 'json',
                    data: {
                        bill_id: self.billId
                    }
                    ...
                    var dialog = new PrintPreviewElementByTypesByUnitsWithClaimDialog({
                        ...
                        printURL: 'printReport/printPostContractElementWithClaimByTypes',
                        exportURL: 'exportExcelReport/exportPostContractElementWithClaimByTypes'
                    });
            ...
            openPrintPreviewDialogByAllUnits: function () {
                ...
                request.post('postContractReport/getPrintingPreviewDataBySelectedUnits', {
                    handleAs: 'json',
                    data: {
                        bill_id: self.billId,
                    ...
                    var dialog = new PrintPreviewElementByTypesByUnitsWithClaimDialog({
                        ...
                        billId: self.billId,
                        printURL: 'printReport/printPostContractElementWithClaimByTypesBySelectedUnits',
                        exportURL: 'exportExcelReport/exportPostContractElementWithClaimByTypesBySelectedUnits'
                    });
        ...
        return StandardBillManagerContainer;
    });