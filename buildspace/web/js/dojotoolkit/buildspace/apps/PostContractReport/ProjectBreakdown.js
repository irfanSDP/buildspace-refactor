define('buildspace/apps/PostContractReport/ProjectBreakdown', [
    'dojo/_base/declare',
    'dojo/number',
...
], function (declare, number, EnhancedGrid, GridFormatter, DropDownMenu, DropDownButton, MenuItem, request, PrintProjectClaimReportFormDialog, nls) {

    var Grid = declare('buildspace.apps.PostContractReport.ProjectBreakdownGrid', EnhancedGrid, {
        rootProject: null,
        style: "border:none;",
        region: 'center',
        keepSelection: true,
        ...
        postCreate: function () {
            ...
            this.on("RowClick", function (e) {
                ...
                if (_item && _item.id > 0 && _item.type[0] == buildspace.apps.PostContractReport.ProjectStructureConstants.TYPE_BILL) {
    ...
    var ProjectBreakdown = declare('buildspace.apps.PostContractReport.ProjectBreakdown', dijit.layout.BorderContainer, {
        region: "center",
        ...
        postCreate: function () {
            ...
            var store = new dojo.data.ItemFileWriteStore({
                clearOnClose: true,
                url: "postContract/getProjectBreakdown/id/" + this.rootProject.id
            });
            ...
            var sortOptions = ['allItems', 'provisionalItems'],
                ...
                menu2 = new DropDownMenu({style: "display: none;"});
                ...
                var menuItem = new MenuItem({
                    ...
                    onClick: function () {
                        buildspace.app.launch({
                            ...
                            is_app: true,
                            level: 0,
                            sysname: "PostContractRemeasurementReport",
                ...
                new dijit.form.Button({
                    ...
                    onClick: function () {
                        buildspace.app.launch({
                            ...
                            id: self.rootProject.id + '-view_subpackage_report',
                            is_app: true,
                            level: 0,
                            sysname: "PostContractSubPackageReport",
            ...
            var menuItem = new MenuItem({
                label: nls.claimSummary,
                onClick: function () {
                    self.openPrintClaimSummaryDialog(null, 'claimSummary');
                }
            });
            ...
            var menuItem = new MenuItem({
                label: nls.claimSummaryWithSubPackages,
                onClick: function () {
                    self.openPrintClaimSummaryDialog(null, 'claimSummaryWithSubPackages');
                }
            });
        ...
        openPrintClaimSummaryDialog: function (self, type) {
            var pb;

            var dialogTitle = nls.print + ' ' + nls.claimSummary;
            var printURL = 'postContractReport/printProjectClaimSummary';
            var exportURL = 'postContractReport/exportExcelProjectClaimReport';
            ...
            if (type === 'claimSummaryWithSubPackages') {
                dialogTitle = nls.print + ' ' + nls.claimSummaryWithSubPackages;
                printURL = 'postContractReport/printProjectClaimSummaryWithSubPackages';
                exportURL = 'postContractReport/exportExcelProjectClaimSummaryWithSubPackages';
            }
