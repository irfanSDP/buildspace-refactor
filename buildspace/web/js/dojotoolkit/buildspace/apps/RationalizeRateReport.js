require([
    ...
    'buildspace/apps/RationalizeRateReport/_base'
], function(nls){

    buildspace.apps.RationalizeRateReport.ProjectStructureConstants = {
        TYPE_ROOT: 1,
        TYPE_LEVEL: 2,
        TYPE_BILL: 4,
    ...
    buildspace.apps.RationalizeRateReport.getBillTypeText = function(type){
        switch(parseInt(type)){
            case buildspace.apps.RationalizeRateReport.ProjectStructureConstants.BILL_TYPE_PROVISIONAL:
                return buildspace.apps.RationalizeRateReport.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_TEXT;
            case buildspace.apps.RationalizeRateReport.ProjectStructureConstants.BILL_TYPE_PRELIMINARY:
                return buildspace.apps.RationalizeRateReport.ProjectStructureConstants.BILL_TYPE_PRELIMINARY_TEXT;
            case buildspace.apps.RationalizeRateReport.ProjectStructureConstants.BILL_TYPE_STANDARD:
                return buildspace.apps.RationalizeRateReport.ProjectStructureConstants.BILL_TYPE_STANDARD_TEXT;
            default:
                return "";
        }
    };
