define('buildspace/apps/ScheduleOfRateLibraryReport/buildUpGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var BuildUpGrid = declare('buildspace.apps.ScheduleOfRateLibraryReport.BuildUp.grid', dojox.grid.EnhancedGrid, {
        itemId: -1,
        resource: null,
    ...
    return declare('buildspace.apps.ScheduleOfRateLibraryReport.BuildUpGrid', dijit.layout.BorderContainer, {
