require([
    ...
    'buildspace/apps/PostContract/_base',
    'buildspace/apps/PostContract/ProjectListingGrid'
], function(nls){
    ...
    buildspace.apps.PostContract.ProjectStructureConstants = {
        ...
        TYPE_ADVANCE_PAYMENT: 6,
        TYPE_WORK_ON_BEHALF: 7,
        TYPE_WORK_ON_BEHALF_BACKCHARGE: 8,
        TYPE_PENALTY: 9,
        TYPE_PERMIT: 10,
        ...
        ADVANCE_PAYMENT_PRIORITY_NORMAL: 1,
        ADVANCE_PAYMENT_PRIORITY_HIGH: 2,
        STATUS_APPROVED: 1,
        STATUS_PENDING: 2,
        STATUS_PREPARING: 4,
        LABOUR_TYPE_SKILLED: 1,
        LABOUR_TYPE_UNSKILLED: 2,
        ADVANCE_PAYMENT_PRIORITY_NORMAL_TEXT: 'Normal',
        ADVANCE_PAYMENT_PRIORITY_HIGH_TEXT: 'High',
        STATUS_APPROVED_TEXT: 'Approved',
        STATUS_PENDING_TEXT: 'Pending',
        STATUS_PREPARING_TEXT: 'Preparing',
        LABOUR_TYPE_SKILLED_TEXT: 'Skilled',
        LABOUR_TYPE_UNSKILLED_TEXT: 'Unskilled',
        TYPE_ADVANCE_PAYMENT_TEXT: 'ADVANCE PAYMENT',
        TYPE_MATERIAL_ON_SITE_TEXT: 'MATERIAL ON SITE',
        TYPE_DEBIT_CREDIT_NOTE_TEXT: 'DEBIT AND CREDIT NOTE',
        TYPE_DEPOSIT_TEXT: 'DEPOSIT',
        TYPE_PURCHASE_ON_BEHALF_TEXT: 'PURCHASE ON BEHALF',
        TYPE_PERMIT_TEXT: 'PERMIT',
        TYPE_KONGSIKONG_TEXT: "KONG SI KONG",
        TYPE_WORK_ON_BEHALF_TEXT: "WORK ON BEHALF",
        TYPE_WORK_ON_BEHALF_BACKCHARGE_TEXT: "WORK ON BEHALF (BACKCHARGE)",
        TYPE_PENALTY_TEXT: "PENALTY",
        TYPE_WATER_DEPOSIT_TEXT: "UTILITY",
    ...
    buildspace.apps.PostContract.getBillTypeText = function(itemType) {
        var itemTypeText;

        switch ( parseInt(itemType) )
        {
            case buildspace.apps.PostContract.ProjectStructureConstants.BILL_TYPE_STANDARD:
                itemTypeText = buildspace.apps.PostContract.ProjectStructureConstants.BILL_TYPE_STANDARD_TEXT;
                break;

            case buildspace.apps.PostContract.ProjectStructureConstants.BILL_TYPE_PROVISIONAL:
                itemTypeText = buildspace.apps.PostContract.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_TEXT;
                break;

            case buildspace.apps.PostContract.ProjectStructureConstants.BILL_TYPE_PRELIMINARY:
                itemTypeText = buildspace.apps.PostContract.ProjectStructureConstants.BILL_TYPE_PRELIMINARY_TEXT;
                break;

            case buildspace.apps.PostContract.ProjectStructureConstants.BILL_TYPE_PRIMECOST:
                itemTypeText = buildspace.apps.PostContract.ProjectStructureConstants.BILL_TYPE_PRIMECOST_TEXT;
                break;
