define(["../../../dojo/_base/declare",
    "dojo/when",
    'buildspace/apps/PostContractSubPackageReport/Builder',
    ...
    var Base = declare('buildspace.apps.PostContractSubPackageRemeasurementReport', buildspace.apps._App, {
        win: null,
        type: null,
        opt: null,
        project: null,
        ...
        init: function(args){
            ...
            var win = this.win = new buildspace.widget.Window({
                title: nls.postContractReport + ' > ' + nls.subPackage + ' ' + nls.remeasureProvisional + ' (' + nls[opt] + ')' + ' - ' + buildspace.truncateString(project.title, 100),
