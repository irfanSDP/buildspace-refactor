define('buildspace/apps/SubPackage/fileBrowserDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var FileBrowserGrid = declare('buildspace.apps.SubPackage.FileBrowserGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        projectId: 0,
        dialogWidget: null,
    ...
    var FileBrowserGridContainer = declare('buildspace.apps.SubPackage.FileBrowserGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        ...
        postCreate: function(){
            ...
            var container = dijit.byId('SubPackage-file_browser_'+this.projectId+'_'+this.billElementId+'-stackContainer');
            if(container){
    ...
    var Dialog = declare('buildspace.apps.SubPackage.FileBrowserDialog', dijit.Dialog, {
        ...
        makeGridContainer: function(content, title){
            ...
            var stackContainer = dijit.byId('SubPackage-file_browser_'+id+'-stackContainer');
            if(stackContainer){
                dijit.byId('SubPackage-file_browser_'+id+'-stackContainer').destroyRecursive();
            }

            stackContainer = new dijit.layout.StackContainer({
                style:'width:100%;height:100%;border:0px;',
                region: "center",
                id: 'SubPackage-file_browser_'+id+'-stackContainer'
            });
            ...
            var controller = new dijit.layout.StackController({
                region: "top",
                containerId: 'SubPackage-file_browser_'+id+'-stackContainer'
            });
