...
(function() {
  define('buildspace/apps/SubPackage/ImportSubPackageByContractorDialog', ["dojo/_base/declare", "dojo/on", 'dojo/_base/lang', "dojo/keys", "dojo/parser", "dijit/_WidgetBase", "dijit/_OnDijitClickMixin", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", 'dijit/Toolbar', 'dijit/form/Button', "dijit/layout/BorderContainer", "dijit/form/ValidationTextBox", "dijit/form/SimpleTextarea", "dijit/registry", "dojo/dom-style", "dojo/dom-form", "dojo/request", "dojox/validate/web", "dijit/form/Select", "dijit/form/FilteringSelect", "dojo/store/Memory", "dojox/form/Manager", "dojo/text!./templates/subPackageContractorRatesImportDialogForm.html", 'dojo/i18n!buildspace/nls/PostContract'], function(declare, on_, lang, keys, parser, _WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin, Toolbar, Button, BorderContainer, ValidationTextBox, SimpleTextarea, registry, domStyle, domForm, request, web, Select, FilteringSelect, Memory, Manager, template, nls) {
    ...
    SubPackageContractorRatesImportForm = declare("buildspace.apps.SubPackage.SubPackageContractorRatesImportForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
      ...
      createUploader: function() {
        ...
        this.uploader = new dojox.form.Uploader({
          label: nls.fileExcelImport,
          uploadOnSelect: true,
          style: 'height:24px;',
          url: "subPackage/importExcelBillBySupplier/_csrf_token/" + self.formInfo._csrf_token + "/subPackageId/" + self.subPackage.id + "/billId/" + self.bill.id + "/companyId/" + self.company.id,
        ...
        on_(this.uploader, "Complete", function(uploadedFiles) {
          ...
          if (uploadedFiles.success) {
            self.subContractorGridContainer.grid.store.close();
            self.subContractorGridContainer.grid.sort();
        ...
        this.subPackageImportFormUploader.appendChild(this.uploader.domNode);
    ...
    return Dialog = declare('buildspace.apps.SubPackage.ImportSubPackageContractorRatesDialog', dijit.Dialog, {
      ...
      createContent: function() {
        ...
        form = new SubPackageContractorRatesImportForm({
