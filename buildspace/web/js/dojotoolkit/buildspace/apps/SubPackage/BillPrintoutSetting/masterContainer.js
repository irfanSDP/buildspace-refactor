...
(function() {
  define(['dojo/_base/declare', 'dijit/layout/BorderContainer', 'dijit/layout/TabContainer', 'dijit/Toolbar', 'dijit/form/Button', 'dojo/request', 'dojo/dom', 'dojo/dom-attr', 'dojo/_base/lang', 'dojo/i18n!buildspace/nls/PrintLayoutSetting'], function(declare, BorderContainer, TabContainer, Toolbar, Button, request, dom, domAttr, lang, nls) {
    var BillPrintoutSetting;
    BillPrintoutSetting = declare('buildspace.apps.SubPackage.BillPrintoutSetting', BorderContainer, {
      projectId: 1,
      subPackageId: -1,
      layoutSettingId: -1,
      region: 'center',
      saveURL: 'subPackagePrintLayoutSetting/saveSettings',
      ...
      postCreate: function() {
        ...
        this.layoutSettingId = layoutSettings.layoutSetting.id;
      ...
      renderTabs: function(layoutSettings) {
        ...
        for (type in settings) {
          ...
          form[counter] = new buildspace.apps.SubPackage.BillPrintoutSetting[setting.nameSpace]({
            projectId: self.projectId,
            subPackageId: self.subPackageId,
            layoutSettingId: self.layoutSettingId,
      ...
      getSettings: function() {
        ...
        request.get("subPackagePrintLayoutSetting/getSettings/id/" + this.subPackageId, {
          sync: true,
          handleAs: 'json',
          preventCache: true
