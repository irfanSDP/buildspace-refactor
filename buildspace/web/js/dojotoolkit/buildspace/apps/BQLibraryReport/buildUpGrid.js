define('buildspace/apps/BQLibraryReport/buildUpGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
...
], function(declare, lang, array, domAttr, connect, Menu, Selector, Rearrange, FormulatedColumn, evt, keys, currency, focusUtil, html, xhr, PopupMenuItem, Select, Textarea, FormulaTextBox, popup, TooltipDialog, nls ){

    var BuildUpGrid = declare('buildspace.apps.BQLibraryReport.BuildUp.grid', dojox.grid.EnhancedGrid, {
        itemId: -1,
        resource: null,
        bqItemId: 0,
    ...
    return declare('buildspace.apps.BQLibraryReport.BuildUpGrid', dijit.layout.BorderContainer, {
