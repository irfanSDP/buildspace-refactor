define('buildspace/apps/BQLibraryReport/buildUpSummary',[
    'dojo/_base/declare',
    "dijit/_WidgetBase",
    ...
    return declare("buildspace.apps.BQLibraryReport.buildUpSummary", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        submitMarkup: function(){
            ...
            if(markup != this.markup){
                ...
                var self = this,
                    xhrArgs = {
                        url: 'bqLibrary/buildUpSummaryMarkupUpdate',
        ...
        doApplyConversionFactor: function(){
            ...
            if(checked != this.applyConversionFactor){
                ...
                var self = this,
                    xhrArgs = {
                        url: 'bqLibrary/buildUpSummaryApplyConversionFactorUpdate',
        ...
        toggleConversionFactorRows: function(show) {
            if(show){
                var self = this,
                    xhrArgs = {
                        url: 'bqLibrary/getConversionFactorUom',
                        content: { id: this.itemId },
                        handleAs: 'json',
                        load: function(resp) {
                            var uomSelect = new Select({
                                name: "bq_library_build_up_rate[conversion_factor_uom_id]",
                                style: "width:100%;",
        ...
        submitConversionFactorAmount: function(){
            ...
            if(amount != this.conversionFactorAmount){
                ...
                var self = this,
                    xhrArgs = {
                        url: 'bqLibrary/buildUpSummaryConversionFactorUpdate',
        ...
        submitConversionFactorUOM: function(val){
            ...
            pb.show();
            var xhrArgs = {
                    url: 'bqLibrary/buildUpSummaryConversionFactorUomUpdate',
