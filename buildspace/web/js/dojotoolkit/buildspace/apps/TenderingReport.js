require([
    ...
    'buildspace/apps/TenderingReport/_base',
    'buildspace/apps/TenderingReport/ProjectListingGrid',
    'buildspace/apps/TenderingReport/BillManager'
], function(nls){

    buildspace.apps.TenderingReport.ProjectStructureConstants = {
        TYPE_ROOT: 1,
        TYPE_LEVEL: 2,
        TYPE_BILL: 4,
    ...
    buildspace.apps.TenderingReport.getBillTypeText = function(type){
        switch(parseInt(type)){
            case buildspace.apps.TenderingReport.ProjectStructureConstants.BILL_TYPE_PROVISIONAL:
                return buildspace.apps.TenderingReport.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_TEXT;
            case buildspace.apps.TenderingReport.ProjectStructureConstants.BILL_TYPE_PRELIMINARY:
                return buildspace.apps.TenderingReport.ProjectStructureConstants.BILL_TYPE_PRELIMINARY_TEXT;
            case buildspace.apps.TenderingReport.ProjectStructureConstants.BILL_TYPE_STANDARD:
                return buildspace.apps.TenderingReport.ProjectStructureConstants.BILL_TYPE_STANDARD_TEXT;
            case buildspace.apps.TenderingReport.ProjectStructureConstants.BILL_TYPE_PRIMECOST:
                return buildspace.apps.TenderingReport.ProjectStructureConstants.BILL_TYPE_PRIMECOST_TEXT;
            default:
                return "";
        }
    };
