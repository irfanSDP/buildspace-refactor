...
(function() {
  define("buildspace/apps/ResourceLibraryReport/PrintItemsDialog", ["dojo/_base/declare", "dojo/aspect", "dojo/_base/lang", "dojo/_base/connect", "dojo/when", "dojo/html", "dojo/dom", "dojo/keys", "dojo/dom-style", "dojo/request", "dojo/json", "dojo/number", "dojo/currency", "./PrintPreviewFormDialog", "buildspace/widget/grid/cells/Formatter", 'dojo/i18n!buildspace/nls/PostContract'], function(declare, aspect, lang, connect, when_, html, dom, keys, domStyle, request, JSON, number, currency, PrintPreviewFormDialog, Formatter, nls) {
    ...
    selectedItemGridContainer = declare("buildspace.apps.ResourceLibraryReport.SelectedItemGridContainer", dijit.layout.BorderContainer, {
    ...
    return declare("buildspace.apps.ResourceLibraryReport.PrintPreviewDialog", dijit.Dialog, {
