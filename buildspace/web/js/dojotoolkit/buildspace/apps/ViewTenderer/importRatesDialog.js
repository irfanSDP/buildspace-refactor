define('buildspace/apps/ViewTenderer/importRatesDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var Form = declare("buildspace.apps.ViewTenderer.FileImportForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        refreshContractorGrid: function(){
            var contractorGrid = dijit.byId('viewTenderer-contractorGrid_'+this.projectId);
            contractorGrid.store.save();
            contractorGrid.store.close();
            contractorGrid._refresh();
        }
    });

    return declare('buildspace.apps.ViewTenderer.FileImportDialog', dijit.Dialog, {
        ...
        createForm: function(){
            ...
            var form = new Form({
                ...
                show: self.company.show[0],
                uploadUrl: "viewTenderer/importContractorRates/pid/"+self.project.id+"/cid/"+self.company.id
            });
