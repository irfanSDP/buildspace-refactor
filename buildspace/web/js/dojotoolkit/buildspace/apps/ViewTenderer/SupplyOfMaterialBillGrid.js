define('buildspace/apps/ViewTenderer/SupplyOfMaterialBillGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var BillGrid = declare('buildspace.apps.ViewTenderer.SupplyOfMaterialBillGrid', dojox.grid.EnhancedGrid, {
        type: null,
        billId: -1,
        elementId: 0,
        itemId: -1,
    ...
    return declare('buildspace.apps.ViewTenderer.SupplyOfMaterialBillGridBuilder', dijit.layout.BorderContainer, {
        pageId: 'page-00',
