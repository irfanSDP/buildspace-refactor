define('buildspace/apps/ViewTenderer/lumpSumPercentDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/when",
    "dojo/html",
    ...
    var LumpSumPercentForm = declare("buildspace.apps.ViewTenderer.LumpSumPercentForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    return declare('buildspace.apps.ViewTenderer.LumpSumPercentDialog', dijit.Dialog, {
