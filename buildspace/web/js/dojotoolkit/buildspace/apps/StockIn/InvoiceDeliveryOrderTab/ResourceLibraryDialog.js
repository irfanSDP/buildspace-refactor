...
(function() {
  define("buildspace/apps/StockIn/InvoiceDeliveryOrderTab/ResourceLibraryDialog", ["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/connect", "dojo/when", "dojo/html", "dojo/dom", "dojo/keys", "dojo/dom-style", "dojox/layout/ContentPane", "buildspace/widget/grid/cells/Formatter", "dojox/grid/enhanced/plugins/IndirectSelection", 'dojo/i18n!../../../nls/StockIn'], function(declare, lang, connect, when_, html, dom, keys, domStyle, ContentPane, GridFormatter, IndirectSelection, nls) {
    ...
    importGridContainer = declare("buildspace.apps.PurchaseOrder.ImportResourceGridContainer", dijit.layout.BorderContainer, {
      ...
      postCreate: function() {
        ...
        self.addChild(grid);
        container = dijit.byId("stockInCopyFromResourceLibrary-stackContainer");
        if (container) {
    ...
    return declare("buildspace.apps.PurchaseOrder.ImportResourceDialog", dijit.Dialog, {
      ...
      createItemGrid: function(tradeObj) {
        ...
        formatter = new GridFormatter();
        store = new dojo.data.ItemFileWriteStore({
          url: "stockIn/getResourceItemList/invoiceId/" + self.invoiceId + "/tradeId/" + tradeObj.id
        });
        return new importGridContainer({
      ...
      makeGridContainer: function(content) {
        ...
        stackContainer = dijit.byId("stockInCopyFromResourceLibrary-stackContainer");
        if (stackContainer) {
          dijit.byId("stockInCopyFromResourceLibrary-stackContainer").destroyRecursive();
        }
        stackContainer = new dijit.layout.StackContainer({
          style: "width:100%;height:100%;border:0px;",
          region: "center",
          id: "stockInCopyFromResourceLibrary-stackContainer"
        });
        ...
        controller = new dijit.layout.StackController({
          region: "top",
          containerId: "stockInCopyFromResourceLibrary-stackContainer"
        });
        ...
        dojo.subscribe("stockInCopyFromResourceLibrary-stackContainer-selectChild", "", function(page) {
          var children, index, widget, _results;
          widget = dijit.byId("stockInCopyFromResourceLibrary-stackContainer");
          if (widget) {
