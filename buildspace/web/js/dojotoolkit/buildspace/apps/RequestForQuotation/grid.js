...
(function() {
  define("buildspace/apps/RequestForQuotation/grid", ["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/dom-attr", "dojox/grid/enhanced/plugins/Menu", "dojox/grid/enhanced/plugins/Selector", "dojox/grid/enhanced/plugins/Rearrange", "dojo/_base/event", "dojo/keys", "dijit/focus", "dojo/_base/html", "dojo/request/xhr", "dijit/PopupMenuItem", 'dojo/request', "buildspace/widget/grid/cells/Textarea", 'buildspace/widget/grid/cells/Formatter', 'dojo/i18n!../../nls/RequestForQuotation'], function(declare, lang, array, domAttr, Menu, Selector, Rearrange, evt, keys, focusUtil, html, xhr, PopupMenuItem, request, Textarea, Formatter, nls) {
    return declare("buildspace.apps.RequestForQuotation.Grid", dojox.grid.EnhancedGrid, {
      ...
      noDataMessage: nls.noRequestForQuotationAvailableInGrid,
      postCreate: function() {
      ...
      deleteRow: function(rowIndex) {
        ...
        pb.show();
        xhrArgs = {
          url: 'requestForQuotation/deleteRFQInformation',
          content: {
            rfqId: item.id,
        ...
        return new buildspace.dialog.confirm(nls.deleteRFQTitle, nls.deleteRFQMsg, 80, 320, function() {
      ...
      contextMenuItems: function(e) {
        ...
        if (item.id > 0) {
          self.rowCtxMenu.addChild(new dijit.MenuItem({
            ...
            onClick: function() {
              return self.requestForQuotationGridContainer.requestForQuotationDialogForm(-1);
            }
          }));
      ...
      disableToolbarButtons: function(isDisable, buttonsToEnable) {
        var deleteRowBtn;
        deleteRowBtn = dijit.byId("deleteCompanyFromRequestForQuotation");
