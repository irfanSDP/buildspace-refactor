define('buildspace/apps/TenderingReport/ProjectListingGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    ...
    var ProjectListingGrid = declare('buildspace.apps.TenderingReport.ProjectListingGrid', EnhancedGrid, {
        keepSelection: true,
    ...
    return declare('buildspace.apps.TenderingReport.ProjectListing', dijit.layout.BorderContainer, {
