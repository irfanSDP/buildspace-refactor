define('buildspace/apps/Tendering/BillManager/importResourceDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var ImportResourceGrid = declare('buildspace.apps.Tendering.BillManager.ImportResourceGrid', dojox.grid.EnhancedGrid, {
        type: null,
        itemId: 0,
        dialogWidget: null,
        _csrf_token: null,
    ...
    var ImportGridContainer = declare('buildspace.apps.Tendering.BillManager.ImportResourceGridContainer', dijit.layout.BorderContainer, {
    ...
    var Dialog = declare('buildspace.apps.Tendering.BillManager.ImportResourceDialog', dijit.Dialog, {
