define('buildspace/apps/TenderingReport/BillManager/buildUpGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var BuildUpGrid = declare('buildspace.apps.TenderingReport.BillManager.BuildUp.grid', dojox.grid.EnhancedGrid, {
        itemId: -1,
        resource: null,
        BQItem: null,
    ...
    return declare('buildspace.apps.TenderingReport.BillManager.BuildUpGrid', dijit.layout.BorderContainer, {
