define('buildspace/apps/TenderingReport/ProjectProperties',[
    'dojo/_base/declare',
    "dojo/html",
    "dojo/dom",
    "dijit/form/Form",
    ...
    var MainInfoForm = declare("buildspace.apps.TenderingReport.MainInfoFormWidget", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    var ProjectProperties = declare('buildspace.apps.TenderingReport.ProjectProperties', dijit.layout.BorderContainer, {
        region: "center",
