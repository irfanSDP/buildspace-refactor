define('buildspace/apps/Tendering/SupplyOfMaterialBillManager',[
    'dojo/_base/declare',
    "dojo/dom-style",
    "dojo/when",
    ...
    function(declare, domStyle, when, ContentPane, EnhancedGrid, BillPropertiesForm, BillGrid, GridFormatter, aspect, nls) {
        ...
        var BillPropertiesContainer = declare('buildspace.apps.Tendering.SupplyOfMaterialBillPropertiesContainer', dijit.layout.BorderContainer, {
        ...
        var BillElementContainer = declare('buildspace.apps.Tendering.SupplyOfMaterialBillElementContainer', dijit.layout.BorderContainer, {
            ...
            createItemGrid: function(element, elementGridStore){
                ...
                pb.show().then(function(){
                    when(unitQuery, function(uom){
                        pb.hide();
                        try{
                            var editableDeveloperRate = false;
                            if(parseInt(String(self.rootProject.tender_type_id)) == buildspace.constants.TENDER_TYPE_TENDERED && parseInt(String(self.rootProject.status_id)) == buildspace.constants.STATUS_TENDERING){
                                editableDeveloperRate =  true;
                            }
                            new BillGrid({
                                ...
                                type: 'tree',
                                editable: parseInt(String(self.rootProject.tender_type_id)) == buildspace.constants.TENDER_TYPE_PARTICIPATED,
                                gridOpts: {
                                    store: store,
                                    editableDeveloperRate: editableDeveloperRate,
        ...
        return declare('buildspace.apps.Tendering.SupplyOfMaterialBillManager', dijit.layout.TabContainer, {
            region: "center",
            rootProject: null,
            nested: true,
