define('buildspace/apps/Tendering/SupplyOfMaterial/BillGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var BillGrid = declare('buildspace.apps.Tendering.SupplyOfMaterial.BillGrid', dojox.grid.EnhancedGrid, {
        type: null,
        billId: -1,
        elementId: 0,
        itemId: -1,
        ...
        constructor:function(args){
            ...
            this.editableDeveloperRate   = args.editableDeveloperRate;
        ...
        setColumnStructure: function(){
            ...
            if(this.type == 'tree'){
                this.structure = [[{
                    ...
                    name: nls.estimatedQty+"<br/>("+nls.includeWastage+")<br />(A)",
                    field: 'estimated_qty',
                    styles: "text-align:right;",
                    width: '80px',
                    editable: this.editable,
                    cellType: 'buildspace.widget.grid.cells.Textarea',
                    formatter: this.editable ? formatter.numberCellFormatter : formatter.unEditableNumberCellFormatter,
                    rowSpan: 2,
                    noresize: true
                },{
                    name: "% "+nls.ofWastageAllowed,
                    field: 'percentage_of_wastage',
                    styles: "text-align:right;",
                    width: '65px',
                    editable: this.editable,
                    cellType: 'buildspace.widget.grid.cells.Textarea',
                    ...
                    name: nls.contractorRate+"<br />(X)",
                    field: 'contractor_supply_rate',
                    styles: "text-align:right;",
                    width: '120px',
                    editable: this.editable,
                    cellType: 'buildspace.widget.grid.cells.Textarea',
                    ...
                    name: nls.developerRate+"<br />(Y)",
                    field: 'supply_rate',
                    styles: "text-align:right;",
                    editable: this.editableDeveloperRate,
                    width: '120px',
                    cellType: 'buildspace.widget.grid.cells.Textarea',
                    formatter: (this.editableDeveloperRate) ? formatter.currencyCellFormatter : formatter.unEditableCurrencyCellFormatter,
                    noresize: true
                },{
                    name: nls.difference+"<br />(B)=(Y)-(X)",
                    field: 'difference',
                    styles: "text-align:right;",
                    width: '120px',
                    ...
                    name: nls.amount+ " ("+this.currencySetting+")<br />(C)=(A)x(B)",
                    field: 'amount',
                    styles: "text-align:right;",
                    width: '120px',
                    formatter: formatter.unEditableCurrencyCellFormatter,
    ...
    return declare('buildspace.apps.Tendering.SupplyOfMaterial.BillGridBuilder', dijit.layout.BorderContainer, {
        pageId: 'page-00',
            ...
            if(this.type != 'tree'){
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        ...
                        onClick: function(e) {
                            window.open('supplyOfMaterialBill/printBill/id/' + billId, '_blank');
                        }
                    })
                );
