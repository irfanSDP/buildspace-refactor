define('buildspace/apps/Tendering/SupplyOfMaterial/BillPropertiesForm',[
    'dojo/_base/declare',
    "dojo/html",
    "dojo/dom",
    "dojo/dom-construct",
    ...
    var BillPropertiesMainInfoForm = declare("buildspace.apps.Tendering.SupplyOfMaterial.BillPropertiesMainInfoForm", [Form,
        _WidgetBase,
        _TemplatedMixin,
    ...
    return declare("buildspace.apps.Tendering.SupplyOfMaterial.BillPropertiesForm", dijit.layout.BorderContainer, {
        ...
        renderBillPropertiesInfoForm: function(data){
            var form = this.mainForm = new BillPropertiesMainInfoForm({
                ...
                billTitle: data['supply_of_material[title]'],
                billDescription: data['supply_of_material[description]']
            });
