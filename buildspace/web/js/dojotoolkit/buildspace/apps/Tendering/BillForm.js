define('buildspace/apps/Tendering/BillForm',[
    'dojo/_base/declare',
    "dojo/html",
    "dojo/dom",
    'dojo/keys',
    ...
    var BillFormWidget = declare("buildspace.apps.Tendering.BillFormWidget", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        constructor: function (args) {
            ...
            this.BILL_TYPE_STANDARD = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_STANDARD;
            this.BILL_TYPE_STANDARD_TEXT = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_STANDARD_TEXT;
            this.BILL_TYPE_STANDARD_DESCRIPTION = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_STANDARD_DESCRIPTION;
            this.BILL_TYPE_PRELIMINARY = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRELIMINARY;
            this.BILL_TYPE_PRELIMINARY_TEXT = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRELIMINARY_TEXT;
            this.BILL_TYPE_PRELIMINARY_DESCRIPTION = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRELIMINARY_DESCRIPTION;
            this.BILL_TYPE_PROVISIONAL = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PROVISIONAL;
            this.BILL_TYPE_PROVISIONAL_TEXT = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_TEXT;
            this.BILL_TYPE_PROVISIONAL_DESCRIPTION = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_DESCRIPTION;
            this.BILL_TYPE_PRIMECOST = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRIMECOST;
            this.BILL_TYPE_PRIMECOST_TEXT = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRIMECOST_TEXT;
            this.BILL_TYPE_PRIMECOST_DESCRIPTION = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRIMECOST_DESCRIPTION;
            ...
            this.BillTypeConstants = BillTypeConstants = [{
                label: buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_STANDARD_TEXT,
                value: buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_STANDARD,
                description: buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_STANDARD_DESCRIPTION
            },{
                label: buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRELIMINARY_TEXT,
                value: buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRELIMINARY,
                description: buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRELIMINARY_DESCRIPTION
            },{
                label: buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_TEXT,
                value: buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PROVISIONAL,
                description: buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_DESCRIPTION
            },{
                label: buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRIMECOST_TEXT,
                value: buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRIMECOST,
                description: buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRIMECOST_DESCRIPTION
            }];
    ...
    return declare('buildspace.apps.Tendering.BillFormDialog', dijit.Dialog, {
