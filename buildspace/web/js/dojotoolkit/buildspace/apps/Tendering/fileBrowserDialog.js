define('buildspace/apps/Tendering/fileBrowserDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var FileBrowserGrid = declare('buildspace.apps.Tendering.FileBrowserGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        projectId: 0,
        dialogWidget: null,
    ...
    var FileBrowserGridContainer = declare('buildspace.apps.Tendering.FileBrowserGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
        ...
        postCreate: function(){
            ...
            var container = dijit.byId('Tendering-file_browser_'+this.projectId+'_'+this.billElementId+'-stackContainer');
            if(container){
    ...
    return declare('buildspace.apps.Tendering.FileBrowserDialog', dijit.Dialog, {
        ...
        createContent: function(){
            ...
            var formatter = new GridFormatter(),
                store = dojo.data.ItemFileWriteStore({
                    url: "tenderingExportFile/getFileByProject/id/"+this.projectId
                }),
        ...
        makeGridContainer: function(content, title){
            ...
            var stackContainer = dijit.byId('Tendering-file_browser_'+id+'-stackContainer');
            if(stackContainer){
                dijit.byId('Tendering-file_browser_'+id+'-stackContainer').destroyRecursive();
            }

            stackContainer = new dijit.layout.StackContainer({
                style:'width:100%;height:100%;border:0px;',
                region: "center",
                id: 'Tendering-file_browser_'+id+'-stackContainer'
            });
