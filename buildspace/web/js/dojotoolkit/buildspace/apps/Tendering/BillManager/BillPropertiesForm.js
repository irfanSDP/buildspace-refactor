define('buildspace/apps/Tendering/BillManager/BillPropertiesForm',[
    'dojo/_base/declare',
    "dojo/html",
    "dojo/dom",
    "dojo/dom-construct",
    ...
    var MarkupSettingsForm = declare('buildspace.apps.Tendering.BillManager.MarkupSettingsForm',[_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin],{
        billId: -1,
        ...
        saveElementMarkup: function(){
            ...
            dojo.xhrPost({
                ...
                content: {
                    'bill_id': this.billId,
                    'type': 'element',
                    'bill_markup_setting[element_markup_enabled]': this.elementMarkupEnabledNode.get('checked'),
                    'bill_markup_setting[_csrf_token]': this._csrf_token
                },
                handleAs: 'json',
                load: function(resp) {
        ...
        saveRoundingType: function(){
            ...
            dojo.xhrPost({
                ...
                content: {
                    'bill_id': this.billId,
                    'type': 'rounding',
                    'bill_markup_setting[rounding_type]': this.roundingTypeNode.get('value'),
                    'bill_markup_setting[_csrf_token]': this._csrf_token
                },
                handleAs: 'json',
                load: function(resp) {
    ...
    var ColumnSettingsForm = declare('buildspace.apps.Tendering.BillManager.ColumnSettingsForm',[_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin],{
        count: 0,
        billId: -1,
        columnSettingName:'',
    ...
    var BillPropertiesMainInfoForm = declare("buildspace.apps.Tendering.BillManager.BillPropertiesMainInfoForm", [Form,
        _WidgetBase,
        _TemplatedMixin,
        ...
        constructor: function(){
            ...
            this.ROUNDING_TYPE_NEAREST_WHOLE_NUMBER_TEXT = buildspace.constants.ROUNDING_TYPE_NEAREST_WHOLE_NUMBER_TEXT;
            this.ROUNDING_TYPE_NEAREST_TENTH_TEXT = buildspace.constants.ROUNDING_TYPE_NEAREST_TENTH_TEXT;
            BillTypeConstantArray[buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_STANDARD] = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_STANDARD_TEXT;
            BillTypeConstantArray[buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRELIMINARY] = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRELIMINARY_TEXT;
            BillTypeConstantArray[buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PROVISIONAL] = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_TEXT;
            BillTypeConstantArray[buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PROVISIONAL] = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_TEXT;
            BillTypeConstantArray[buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRIMECOST] = buildspace.apps.Tendering.ProjectStructureConstants.BILL_TYPE_PRIMECOST_TEXT;
        ...
        postCreate: function(){
            this.inherited(arguments);
            var roundingTxt;
            switch(String(this.formData['bill_setting[build_up_quantity_rounding_type]'])){
                case this.ROUNDING_TYPE_UPWARD:
                    roundingTxt = this.ROUNDING_TYPE_UPWARD_TEXT;
                    break;
                case this.ROUNDING_TYPE_DOWNWARD:
                    roundingTxt = this.ROUNDING_TYPE_DOWNWARD_TEXT;
                    break;
                case this.ROUNDING_TYPE_NEAREST_WHOLE_NUMBER:
                    roundingTxt = this.ROUNDING_TYPE_NEAREST_WHOLE_NUMBER_TEXT;
                    break;
                case this.ROUNDING_TYPE_NEAREST_TENTH:
                    roundingTxt = this.ROUNDING_TYPE_NEAREST_TENTH_TEXT;
                    break;
                case this.ROUNDING_TYPE_DISABLED:
                    roundingTxt = this.ROUNDING_TYPE_DISABLED_TEXT;
                    break;
                default:
                    roundingTxt = "";
            }
            ...
            html.set(this.buildUpQuantityRoundingTypeNode, roundingTxt);
    ...
    return declare("buildspace.apps.Tendering.BillManager.BillPropertiesForm", dijit.layout.BorderContainer, {
