define('buildspace/apps/Tendering/BillManager/importElementDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var ImportElementGrid = declare('buildspace.apps.Tendering.BillManager.ImportElementGrid', dojox.grid.EnhancedGrid, {
        type: null,
        selectedItem: null,
        billId: 0,
        billElementId: 0,
    ...
    var ImportGridContainer = declare('buildspace.apps.Tendering.BillManager.ImportElementGridContainer', dijit.layout.BorderContainer, {
        stackContainerTitle: '',
    ...
    return declare('buildspace.apps.Tendering.BillManager.ImportElementDialog', dijit.Dialog, {
