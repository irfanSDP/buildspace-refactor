define('buildspace/apps/Tendering/BillManager/editBillNoteDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/connect",
    "dojo/when",
    ...
    var EditBillNoteForm = declare("buildspace.apps.Tendering.BillManager.EditBillNoteForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    return declare('buildspace.apps.Tendering.BillManager.EditBillNoteDialog', dijit.Dialog, {
