define('buildspace/apps/Tendering/BillManager/buildUpFloorAreaDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var BuildUpFloorAreaGrid = declare('buildspace.apps.Tendering.BillManager.BuildUpFloorArea.grid', dojox.grid.EnhancedGrid, {
    ...
    var BuildUpFloorAreaGridContainer = declare('buildspace.apps.Tendering.BillManager.BuildUpFloorAreaGrid', dijit.layout.BorderContainer, {
    ...
    return declare('buildspace.apps.Tendering.BillManager.BuildUpFloorAreaDialog', dijit.Dialog, {
