define('buildspace/apps/Tendering/BillManager/buildUpQuantityGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    'dijit/popup',
    'dijit/TooltipDialog',
    'dojo/i18n!buildspace/nls/BuildUpQuantityGrid'], function(declare, lang, array, domAttr, connect, Menu, Selector, Rearrange, FormulatedColumn, evt, keys, currency, focusUtil, html, xhr, PopupMenuItem, Select, Textarea, FormulaTextBox, popup, TooltipDialog, nls ) {

    var BuildUpQuantityGrid = declare('buildspace.apps.Tendering.BillManager.BuildUpQuantity.grid', dojox.grid.EnhancedGrid, {
    ...
    return declare('buildspace.apps.Tendering.BillManager.BuildUpQuantityGrid', dijit.layout.BorderContainer, {
