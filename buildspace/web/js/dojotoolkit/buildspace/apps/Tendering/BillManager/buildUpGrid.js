define('buildspace/apps/Tendering/BillManager/buildUpGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
...
], function(declare, lang, array, domAttr, connect, Menu, Selector, Rearrange, FormulatedColumn, evt, keys, currency, focusUtil, html, xhr, PopupMenuItem, Select, Textarea, FormulaTextBox, popup, TooltipDialog, ImportResourceDialog, nls ) {

    var BuildUpGrid = declare('buildspace.apps.Tendering.BillManager.BuildUp.grid', dojox.grid.EnhancedGrid, {
        itemId: -1,
        resource: null,
        BQItem: null,
    ...
    return declare('buildspace.apps.Tendering.BillManager.BuildUpGrid', dijit.layout.BorderContainer, {
        ...
        postCreate: function(){
            ...
            toolbar.addChild(
                new dijit.form.Button({
                    id: 'builUpGrid-'+self.resource.id+'_'+self.BQItem.id+'AddRow-button',
                    label: nls.addRow,
                    iconClass: "icon-16-container icon-16-add",
            ...
            toolbar.addChild(
                new dijit.form.Button({
                    id: 'builUpGrid-'+self.resource.id+'_'+self.BQItem.id+'DeleteRow-button',
                    label: nls.deleteRow,
                    iconClass: "icon-16-container icon-16-delete",
                    disabled: grid.selection.selectedIndex > -1 ? false : true,
                    onClick: function(){
            ...
            toolbar.addChild(
                new dijit.form.Button({
                    id: 'builUpGrid-'+self.resource.id+'_'+self.BQItem.id+'ImportRow-button',
