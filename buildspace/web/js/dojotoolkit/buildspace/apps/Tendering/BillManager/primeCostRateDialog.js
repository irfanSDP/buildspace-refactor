define('buildspace/apps/Tendering/BillManager/primeCostRateDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/when",
    "dojo/html",
    ...
    var PrimeCostRateForm = declare("buildspace.apps.Tendering.BillManager.PrimeCostRateForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    return declare('buildspace.apps.Tendering.BillManager.PrimeCostRateDialog', dijit.Dialog, {
