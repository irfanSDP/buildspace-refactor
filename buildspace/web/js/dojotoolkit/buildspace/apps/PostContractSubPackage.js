require([
    ...
    'buildspace/apps/PostContractSubPackage/_base',
    'buildspace/apps/PostContractSubPackage/SubPackageListingGrid'
], function(nls){
    buildspace.apps.PostContractSubPackage.ProjectStructureConstants = {
        TYPE_ROOT: 1,
        TYPE_LEVEL: 2,
        TYPE_BILL: 4,
    ...
    buildspace.apps.PostContractSubPackage.getBillTypeText = function(itemType) {
        var itemTypeText;

        switch ( parseInt(itemType) )
        {
            case buildspace.apps.PostContractSubPackage.ProjectStructureConstants.BILL_TYPE_STANDARD:
                itemTypeText = buildspace.apps.PostContractSubPackage.ProjectStructureConstants.BILL_TYPE_STANDARD_TEXT;
                break;

            case buildspace.apps.PostContractSubPackage.ProjectStructureConstants.BILL_TYPE_PROVISIONAL:
                itemTypeText = buildspace.apps.PostContractSubPackage.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_TEXT;
                break;

            case buildspace.apps.PostContractSubPackage.ProjectStructureConstants.BILL_TYPE_PRELIMINARY:
                itemTypeText = buildspace.apps.PostContractSubPackage.ProjectStructureConstants.BILL_TYPE_PRELIMINARY_TEXT;
                break;

            case buildspace.apps.PostContractSubPackage.ProjectStructureConstants.BILL_TYPE_PRIMECOST:
                itemTypeText = buildspace.apps.PostContractSubPackage.ProjectStructureConstants.BILL_TYPE_PRIMECOST_TEXT;
                break;
