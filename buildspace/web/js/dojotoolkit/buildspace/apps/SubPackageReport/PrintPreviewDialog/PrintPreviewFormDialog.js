...
(function() {
  define('buildspace/apps/SubPackageReport/PrintPreviewDialog/PrintPreviewFormDialog', ["dojo/_base/declare", 'dojo/_base/lang', "dojo/keys", "dojo/parser", "dijit/_WidgetBase", "dijit/_OnDijitClickMixin", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", 'dijit/Toolbar', 'dijit/form/Button', "dijit/layout/BorderContainer", "dijit/form/ValidationTextBox", "dijit/form/RadioButton", "dijit/form/SimpleTextarea", "dijit/registry", "dojo/dom-style", "dojo/dom-form", "dojo/request", "dojo/json", "dojox/validate/web", "dojox/form/Manager", "dojo/text!./templates/printPreviewForm.html", 'dojo/i18n!buildspace/nls/TenderingReport'], function(declare, lang, keys, parser, _WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin, Toolbar, Button, BorderContainer, ValidationTextBox, RadioButton, SimpleTextarea, registry, domStyle, domForm, request, JSON, web, Manager, template, nls) {
    ...
    printPreviewForm = declare("buildspace.apps.SubPackageReport.SupplierList.PrintPreviewForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
      ...
      print: function() {
        var billIdInput, csrfToken, descriptionFormat, form, formValues, priceFormat, printNoCents, printingPageTitle, selectedRows, sortingType, subPackageIdInput;
        ...
        if (this.subPackageId > 0) {
          subPackageIdInput = document.createElement("input");
          subPackageIdInput.setAttribute("name", "subPackageId");
          subPackageIdInput.setAttribute("value", this.subPackageId);
          subPackageIdInput.setAttribute('type', 'hidden');
          form.appendChild(subPackageIdInput);
        }
        if (this.billId > 0) {
    ...
    return declare('buildspace.apps.SubPackageReport.PrePrintFormDialog', dijit.Dialog, {
