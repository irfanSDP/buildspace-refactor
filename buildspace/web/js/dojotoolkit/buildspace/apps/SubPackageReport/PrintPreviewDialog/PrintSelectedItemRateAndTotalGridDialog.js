(function () {
    define("buildspace/apps/SubPackageReport/PrintPreviewDialog/PrintSelectedItemRateAndTotalGridDialog", ["dojo/_base/declare", "dojo/aspect", "dojo/_base/lang", "dojo/_base/connect", "dojo/when", "dojo/html", "dojo/dom", "dojo/keys", "dojo/dom-style", "dojo/request", "dojo/json", "./PrintPreviewFormDialog", "buildspace/widget/grid/cells/Formatter", 'dojo/i18n!buildspace/nls/TenderingReport'], function (declare, aspect, lang, connect, when_, html, dom, keys, domStyle, request, JSON, PrintPreviewFormDialog, Formatter, nls) {
        ...
        selectedItemGridContainer = declare("buildspace.apps.SubPackageReport.SelectedItemRateAndTotalGridContainer", dijit.layout.BorderContainer, {
        ...
        return declare("buildspace.apps.SubPackageReport.GroupProjectAssignmentDialog", dijit.Dialog, {
            ...
            createContent: function () {
                ...
                if (this.type) {
                    request.post("subPackageReporting/getSubContractors", {
                        sync: true,
                        handleAs: 'json',
                        data: {
                ...
                content = new selectedItemGridContainer({
                    ...
                    billId: self.bill ? self.bill.id : null,
                    selectedItems: self.selectedItems,
            ...
            constructGridStructure: function (selectedCompanies, type, self) {
                ...
                for (key in selectedCompanies) {
                    ...
                    textColor = selectedCompanies[key]['selected'] ? 'blue' : 'black';
