...
(function() {
  define("buildspace/apps/SubPackageReport/PrintPreviewDialog/PrintSelectedBillGridDialog", ["dojo/_base/declare", "dojo/aspect", "dojo/_base/lang", "dojo/_base/connect", "dojo/when", "dojo/html", "dojo/dom", "dojo/keys", "dojo/dom-style", "dojo/request", "dojo/json", "./PrintPreviewFormDialog", "buildspace/widget/grid/cells/Formatter", 'dojo/i18n!buildspace/nls/TenderingReport'], function(declare, aspect, lang, connect, when_, html, dom, keys, domStyle, request, JSON, PrintPreviewFormDialog, Formatter, nls) {
    ...
    selectedBillGridContainer = declare("buildspace.apps.SubPackageReport.SelectedBillGridContainer", dijit.layout.BorderContainer, {
          ...
          additionalStructures = [
            {
              ...
              field: "total_amount-" + self.companyId,
              styles: "text-align:right;color:blue;",
              width: '100px',
              formatter: formatter.unEditableCurrencyCellFormatter,
              noresize: true
              ...
              name: nls.difference + " %",
              field: "difference_percentage-" + self.companyId,
              styles: "text-align:right;color:blue;",
              width: '100px',
              ...
              field: "difference_amount-" + self.companyId,
              styles: "text-align:right;color:blue;",
              width: '100px',
              formatter: formatter.unEditableCurrencyCellFormatter,
              noresize: true
