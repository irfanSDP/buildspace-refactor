...
(function() {
    ...
    define("buildspace/apps/PurchaseOrder/SupplierList/SupplierSelectionGridDialog", ["dojo/_base/declare", "dojo/aspect", "dojo/_base/lang", "dojo/_base/connect", "dojo/request", "dojo/html", "dojo/dom", "dojo/keys", "dojo/dom-style", "buildspace/widget/grid/cells/Formatter", "dojox/grid/enhanced/plugins/IndirectSelection", 'buildspace/widget/grid/Filter', 'dojo/i18n!../../../nls/PurchaseOrder', 'dojo/i18n!../../../nls/CompanyDirectories'], function(declare, aspect, lang, connect, request, html, dom, keys, domStyle, Formatter, IndirectSelection, Filter, nls, nls2) {
        var supplierSelectionGrid = declare("buildspace.apps.PurchaseOrder.SupplierList.SupplierSelectionGrid", dojox.grid.EnhancedGrid, {
            ...
            postCreate: function() {
                ...
                this.store.fetch({
                    ...
                    onComplete: function(results) {
                        return dojo.forEach(results, function(company) {
                            if (company.selected[0]) {
                                return self.rowSelectCell.toggleRow(company._0, true);
                            }
                        });
                    }
                });
            ...
            select: function() {
                ...
                pb.show();
                return request.post('purchaseOrder/saveCurrentSelectedSupplierInfo', {
                    data: {
                        "poId": self.poId,
                    ...
                    if (response.success) {
                        self.poForm.currentAssignedSupplierNode.innerHTML = response.supplierName;
                        self.poForm.supplierAddressNode_1.set('value', response.supplierAddress[0]);
                        self.poForm.supplierAddressNode_2.set('value', response.supplierAddress[1]);
                        self.poForm.supplierAddressNode_3.set('value', response.supplierAddress[2]);
                    }
                    pb.hide();
        ...
        return declare("buildspace.apps.PurchaseOrder.SupplierList.SupplierSelectionDialog", dijit.Dialog, {
