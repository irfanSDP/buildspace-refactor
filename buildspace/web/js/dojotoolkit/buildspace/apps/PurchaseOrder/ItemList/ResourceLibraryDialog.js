    ...
    importResourceGrid = declare("buildspace.apps.PurchaseOrder.ImportResourceGrid", dojox.grid.EnhancedGrid, {
      ...
      copy: function() {
        ...
        if (itemIds.length > 0) {
          ...
          pb.show();
          xhrArgs = {
            url: "purchaseOrder/copyResourceItems",
            content: {
              poId: self.poId,
              ids: [itemIds],
    ...
    return declare("buildspace.apps.PurchaseOrder.ImportResourceDialog", dijit.Dialog, {
      ...
      createContent: function() {
        ...
        store = dojo.data.ItemFileWriteStore({
          url: "purchaseOrder/getResourceList"
        });
      ...
      createTradeGrid: function(resourceObj) {
        ...
        store = new dojo.data.ItemFileWriteStore({
          url: "purchaseOrder/getResourceTradeList/resourceId/" + resourceObj.id
        });
      ...
      createItemGrid: function(tradeObj) {
        ...
        formatter = new GridFormatter();
        store = new dojo.data.ItemFileWriteStore({
          url: "purchaseOrder/getResourceItemList/poId/" + self.poId + "/tradeId/" + tradeObj.id
        });
        return new importGridContainer({
