...
(function() {
  define("buildspace/apps/PurchaseOrder/ItemList/ProjectResourceDialog", ["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/connect", "dojo/when", "dojo/html", "dojo/dom", "dojo/keys", "dojo/dom-style", "dojox/layout/ContentPane", "buildspace/widget/grid/cells/Formatter", "dojox/grid/enhanced/plugins/IndirectSelection", "dojo/i18n!../../../nls/PurchaseOrder"], function(declare, lang, connect, when_, html, dom, keys, domStyle, ContentPane, GridFormatter, IndirectSelection, nls) {
    var importGridContainer, importProjectResourceGrid;
    importProjectResourceGrid = declare("buildspace.apps.PurchaseOrder.ImportProjectResourceGrid", dojox.grid.EnhancedGrid, {
      type: null,
      dialogWidget: null,
      _csrf_token: null,
      resource: null,
      ...
      copy: function() {
        ...
        if (itemIds.length > 0) {
          ...
          pb.show();
          xhrArgs = {
            url: "purchaseOrder/copyProjectResourceItems",
            content: {
              poId: self.poId,
    ...
    importGridContainer = declare("buildspace.apps.PurchaseOrder.ImportProjectResourceGridContainer", dijit.layout.BorderContainer, {
    ...
    return declare("buildspace.apps.PurchaseOrder.ImportProjectResourceDialog", dijit.Dialog, {
      ...
      createContent: function() {
        ...
        store = dojo.data.ItemFileWriteStore({
          url: "purchaseOrder/getProjectResources/pid/" + this.projectId
        });
      ...
      createTradeGrid: function(resourceObj) {
        ...
        store = new dojo.data.ItemFileWriteStore({
          url: "purchaseOrder/getProjectResourceTrades/pid/" + self.projectId + "/id/" + resourceObj.id
        });
      ...
      createItemGrid: function(resourceObj, tradeObj) {
        ...
        formatter = new GridFormatter();
        store = new dojo.data.ItemFileWriteStore({
          url: "purchaseOrder/getProjectResourceItems/poId/" + self.poId + "/pid/" + self.projectId + "/rid/" + resourceObj.id + "/id/" + tradeObj.id
        });
        return new importGridContainer({
