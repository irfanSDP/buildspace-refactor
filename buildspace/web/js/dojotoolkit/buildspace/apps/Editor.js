require([
    ...
    'buildspace/apps/Editor/_base',
    'buildspace/apps/Editor/BillManager',
], function(nls){

    buildspace.apps.Editor.ProjectStructureConstants = {
        TYPE_ROOT: 1,
        TYPE_LEVEL: 2,
        TYPE_BILL: 4,
    ...
    buildspace.apps.Editor.getBillTypeText = function(type){
        switch(parseInt(type)){
            case buildspace.apps.Editor.ProjectStructureConstants.BILL_TYPE_PROVISIONAL:
                return buildspace.apps.Editor.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_TEXT;
            case buildspace.apps.Editor.ProjectStructureConstants.BILL_TYPE_PRELIMINARY:
                return buildspace.apps.Editor.ProjectStructureConstants.BILL_TYPE_PRELIMINARY_TEXT;
            case buildspace.apps.Editor.ProjectStructureConstants.BILL_TYPE_STANDARD:
                return buildspace.apps.Editor.ProjectStructureConstants.BILL_TYPE_STANDARD_TEXT;
            case buildspace.apps.Editor.ProjectStructureConstants.BILL_TYPE_PRIMECOST:
                return buildspace.apps.Editor.ProjectStructureConstants.BILL_TYPE_PRIMECOST_TEXT;
            default:
                return "";
        }
    }
