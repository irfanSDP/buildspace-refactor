define('buildspace/apps/MasterCostData/SelectComponentsDialog',[
    'dojo/_base/declare',
    "dojo/aspect",
    "dojo/_base/array",
    "dojo/_base/connect",
    ...
    var Grid = declare('buildspace.apps.MasterCostData.SelectComponentsDialog.Grid', dojox.grid.EnhancedGrid, {
        region: 'center',
    ...
    return declare('buildspace.apps.MasterCostData.SelectComponentsDialog', dijit.Dialog, {
        style:"padding:0px;margin:0px;",
        title: nls.selectComponents,
        gridUrl: null,
        masterCostData: null,
        projectParticular: null,
        selectedItemIds: [],
        ...
        save: function(){
            ...
            var params = {
                ...
                _csrf_token: this.projectParticular._csrf_token ? this.projectParticular._csrf_token : null
            };

            var xhrArgs = {
                url: "masterCostData/updateProjectParticularSelectedComponents/id/"+this.projectParticular.id,
                content: params,
                handleAs: 'json',
                load: function(resp) {
                    if(resp.success){
