...
(function() {
    define('buildspace/apps/ScheduleOfQuantity/ImportCubitDialog', ["dojo/_base/declare", "dojo/on", 'dojo/_base/lang', "dojo/keys", "dojo/parser", "dijit/_WidgetBase", "dijit/_OnDijitClickMixin", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", 'dijit/Toolbar', 'dijit/form/Button', "dijit/layout/BorderContainer", "dijit/form/ValidationTextBox", "dijit/form/SimpleTextarea", "dijit/registry", "dojo/dom-style", "dojo/dom-form", "dojo/request", "dojox/validate/web", "dijit/form/Select", "dijit/form/FilteringSelect", "dojo/store/Memory", "dojox/form/Manager", "dojo/text!./templates/importDialogForm.html", 'dojo/i18n!buildspace/nls/ScheduleOfQuantity'], function(declare, on_, lang, keys, parser, _WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin, Toolbar, Button, BorderContainer, ValidationTextBox, SimpleTextarea, registry, domStyle, domForm, request, web, Select, FilteringSelect, Memory, Manager, template, nls) {
        var ScheduleOfQuantityImportForm;
        ScheduleOfQuantityImportForm = declare("buildspace.apps.ScheduleOfQuantity.ScheduleOfQuantityImportForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
            baseClass: "buildspace-form",
            scheduleOfQuantityId: -1,
            ...
            createUploader: function() {
                ...
                this.uploader = new dojox.form.Uploader({
                    ...
                    uploadOnSelect: true,
                    style: 'height:24px;',
                    url: "scheduleOfQuantityImport/importXMLFileFromCubit/scheduleOfQuantityId/" + self.scheduleOfQuantityId + "/_csrf_token/" + self.formInfo._csrf_token,
                ...
                on_(this.uploader, "Complete", function(uploadedFiles) {
                    ...
                    if (uploadedFiles.success) {
                        self.scheduleOfQuantityGrid.store.save();
                        self.scheduleOfQuantityGrid.store.close();
                        self.scheduleOfQuantityGrid.setStore(self.scheduleOfQuantityGrid.store);
        ...
        return declare('buildspace.apps.ScheduleOfQuantity.ImportCubitFileDialog', dijit.Dialog, {
            ...
            createContent: function() {
                ...
                form = new ScheduleOfQuantityImportForm({
                    scheduleOfQuantityId: this.scheduleOfQuantityId,
                    formInfo: this.formInfo,
                    dialogContainer: self,
                    scheduleOfQuantityGrid: this.scheduleOfQuantityGrid
                });
                toolbar = new Toolbar({
                    region: 'top',
