require([
    ...
    'buildspace/apps/ProjectBuilderReport/_base',
    'buildspace/apps/ProjectBuilderReport/ProjectListingGrid',
    'buildspace/apps/ProjectBuilderReport/BillManager'
], function(nls) {
    buildspace.apps.ProjectBuilderReport.ProjectStructureConstants = {
        TYPE_ROOT: 1,
        TYPE_LEVEL: 2,
        TYPE_BILL: 4,
    ...
    buildspace.apps.ProjectBuilderReport.getBillTypeText = function(type){
        switch(parseInt(type)){
            case buildspace.apps.ProjectBuilderReport.ProjectStructureConstants.BILL_TYPE_PROVISIONAL:
                return buildspace.apps.ProjectBuilderReport.ProjectStructureConstants.BILL_TYPE_PROVISIONAL_TEXT;
            case buildspace.apps.ProjectBuilderReport.ProjectStructureConstants.BILL_TYPE_PRELIMINARY:
                return buildspace.apps.ProjectBuilderReport.ProjectStructureConstants.BILL_TYPE_PRELIMINARY_TEXT;
            case buildspace.apps.ProjectBuilderReport.ProjectStructureConstants.BILL_TYPE_STANDARD:
                return buildspace.apps.ProjectBuilderReport.ProjectStructureConstants.BILL_TYPE_STANDARD_TEXT;
            case buildspace.apps.ProjectBuilderReport.ProjectStructureConstants.BILL_TYPE_PRIMECOST:
                return buildspace.apps.ProjectBuilderReport.ProjectStructureConstants.BILL_TYPE_PRIMECOST_TEXT;
            default:
                return "";
        }
    };
