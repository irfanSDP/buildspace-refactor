define('buildspace/apps/PostContractSubPackageReport/MaterialOnSiteReport', [
        'dojo/_base/declare',
        'dojo/aspect',
        'dojo/currency',
        'dojo/number',
    ...
    function (declare, aspect, currency, number, when, request, Memory, ContentPane, TabContainer, BorderContainer, MaterialOnSiteGrid, PrintSettingForm, GridFormatter, nls) {
        ...
        var CustomFormatter = {
            statusCellFormatter: function (cellValue, rowIdx, cell) {
                ...
                if (cellValue == buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.MATERIAL_ON_SITE_CLAIMED) {
        ...
        var materialOnSiteContainer = declare('buildspace.apps.PostContractSubPackageReport.MaterialOnSiteReport', BorderContainer, {
                    ...
                    grid = new MaterialOnSiteGrid({
                        ...
                        gridOpts: {
                            ...
                            getAffectedItemsByVO: function (item, type) {
                                ...
                                request.post('subPackageMaterialOnSiteReporting/getAffectedItems', {
                                    handleAs: 'json',
                                    data: {
            ...
            makeItemGrid: function (materialOnSite) {
                ...
                var formatter = new GridFormatter(),
                    ...
                    structure = [{
                        ...
                        width: '120px',
                        cellType: 'buildspace.widget.grid.cells.FormulaTextBox',
                        formatter: materialOnSite.status[0] == buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.MATERIAL_ON_SITE_THIS_CLAIM ? CustomFormatter.currencyCellFormatter : formatter.unEditableCurrencyCellFormatter,
                        noresize: true
                    }, {
                        name: nls.amount,
                        field: 'amount',
                    ...
                    grid = new MaterialOnSiteGrid({
                        ...
                        gridOpts: {
                            ...
                            getAffectedVOByItems: function (item, type) {
                                ...
                                request.post('subPackageMaterialOnSiteReporting/getAffectedMOS', {
                                    handleAs: 'json',
                                    data: {
                                        subPackageId: self.subPackage.id,
                                    ...
                                    var vosGrid = dijit.byId('material_on_site-' + self.subPackage.id);
                ...
                var pageId = 'material_on_site_items_report-' + materialOnSite.id + '-' + self.subPackage.id + '-page';
            ...
            appendNewStack: function (content, pageId, title) {
                ...
                var container = dijit.byId('materialOnSiteReport-' + self.subPackage.id + '-stackContainer');
        ...
        return declare('buildspace.apps.PostContractSubPackageReport.MaterialOnSiteTabContainer', TabContainer, {
            ...
            postCreate: function () {
                ...
                request.get('subPackageMaterialOnSite/getPrintSettingForm', {
                    handleAs: 'json',
                    query: {
