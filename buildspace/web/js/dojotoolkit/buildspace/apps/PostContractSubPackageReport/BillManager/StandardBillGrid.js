define('buildspace/apps/PostContractSubPackageReport/BillManager/StandardBillGrid',[
    ...
    var StandardBillGrid = declare('buildspace.apps.PostContractSubPackageReport.BillManager.StandardBillGrid', dojox.grid.EnhancedGrid, {
        typeItemId: -1,
        type: null,
        billId: -1,
        elementId: 0,
    ...
    return declare('buildspace.apps.PostContractSubPackageReport.BillManager.StandardBillGridBuilder', dijit.layout.BorderContainer, {
        pageId: 'page-00',
        ...
        postCreate: function(){
            ...
            lang.mixin(self.gridOpts, { subPackage: self.subPackage, billId: self.billId, typeItem: self.typeItem, project:self.rootProject, elementId: self.elementId, type:self.type, region:"center", disableEditing: self.disableEditing, borderContainerWidget: self });
            ...
            var container = dijit.byId('subPackagePostContractReportStandardBill' + this.billId + '-stackContainer');
        ...
        openSelectedElementDetailPrintPreview: function() {
            ...
            request.post('postContractSubPackageStandardBill/getPrintingSelectedElementClaims', {
                handleAs: 'json',
                data: {
                    subPackageId: self.subPackage.id,
                    bill_id: self.billId,
        ...
        openElementWorkDoneOnlyDetailPrintPreview: function() {
            ...
            request.post('postContractSubPackageStandardBill/getPrintingElementWorkDoneOnlyClaims', {
                handleAs: 'json',
                data: {
                    subPackageId: self.subPackage.id,
                    bill_id: self.billId,
        ...
        openSelectedItemPrintPreviewDialog: function() {
            ...
            request.post('postContractSubPackageStandardBill/getPrintingSelectedItemClaims', {
                handleAs: 'json',
                data: {
                    subPackageId: self.subPackage.id,
                    bill_id: self.billId,
                ...
                var dialog = new PrintPreviewItemDialog({
                    ...
                    billId: self.billId,
                    title: nls.allItems,
                    printURL: 'postContractSubPackageStandardBill/printStandardBillSelectedItems',
                    exportURL: 'postContractSubPackageStandardBillExportExcelReporting/exportExcelStandardBillSelectedItems',
                    data: data,
                    selectedItems: items
                });
        ...
        openItemsWithCurrentClaimPrintPreviewDialog: function() {
            ...
            request.post('postContractSubPackageStandardBill/getPrintingPreviewItemsWithCurrentClaim', {
                handleAs: 'json',
                data: {
                    subPackageId: self.subPackage.id,
                    bill_id: self.billId,
                ...
                var dialog = new PrintPreviewItemDialog({
                    ...
                    printURL: 'postContractSubPackageStandardBill/printStandardBillItemWithCurrentClaim',
                    exportURL: 'postContractSubPackageStandardBillExportExcelReporting/exportExcelStandardBillItemWithCurrentClaim',
                    data: data
                });
        ...
        openItemsWithClaimPrintPreviewDialog: function() {
            ...
            request.post('postContractSubPackageStandardBill/getPrintingPreviewItemsWithClaim', {
                handleAs: 'json',
                data: {
                    subPackageId: self.subPackage.id,
                    bill_id: self.billId,
                ...
                var dialog = new PrintPreviewItemDialog({
                    ...
                    subPackageId: self.subPackage.id,
                    billId: self.billId,
                    title: nls.itemsWithClaim,
                    printURL: 'postContractSubPackageStandardBill/printStandardBillItemWithClaim',
                    exportURL: 'postContractSubPackageStandardBillExportExcelReporting/exportExcelStandardBillItemWithClaim',
                    data: data
                });
        ...
        openItemsWorkDoneQtyPrintPreviewDialog: function() {
            ...
            request.post('postContractSubPackageStandardBill/getPrintingPreviewItemsWorkDoneWithQty', {
                handleAs: 'json',
                data: {
                    subPackageId: self.subPackage.id,
                    bill_id: self.billId,
        ...
        openItemsWorkDonePercentagePrintPreviewDialog: function() {
            ...
            request.post('postContractSubPackageStandardBill/getPrintingPreviewItemsWorkDoneWithPercentage', {
                handleAs: 'json',
                data: {
                    subPackageId: self.subPackage.id,
                    bill_id: self.billId,
