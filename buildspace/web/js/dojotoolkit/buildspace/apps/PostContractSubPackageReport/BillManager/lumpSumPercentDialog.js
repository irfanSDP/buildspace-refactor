define('buildspace/apps/PostContractSubPackageReport/BillManager/lumpSumPercentDialog',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/when",
    "dojo/html",
    ...
    var LumpSumPercentForm = declare("buildspace.apps.PostContractSubPackageReport.BillManager.LumpSumPercentForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        startup: function(){
            ...
            var xhrArgs = {
                ...
                handleAs: 'json',
                content: { id: this.itemObj.id, projectId: this.projectId },
                load: function(data){
        ...
        submit: function(dialog){
            ...
            var self = this, billGridStore = this.billGridStore,
                ...
                xhrArgs = {
                    url: 'postContractStandardBillClaim/lumpSumPercentageUpdate',
                    content: {id : values.id, rate: values['bill_item_lump_sum_percentage[amount]']},
                    handleAs: 'json',
                    load: function(resp) {
                        pb.hide();
                        var data = resp.data;
    ...
    return declare('buildspace.apps.PostContractSubPackageReport.BillManager.LumpSumPercentDialog', dijit.Dialog, {
