define('buildspace/apps/PostContractSubPackageReport/VariationOrder/buildUpQuantityGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var BuildUpQuantityGrid = declare('buildspace.apps.PostContractSubPackageReport.VariationOrder.BuildUpQuantity.grid', dojox.grid.EnhancedGrid, {
    ...
    return declare('buildspace.apps.PostContractSubPackageReport.VariationOrder.BuildUpQuantityGrid', dijit.layout.BorderContainer, {
