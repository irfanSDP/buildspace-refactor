define('buildspace/apps/PostContractSubPackageReport/VariationOrder/buildUpQuantitySummary',[
    'dojo/_base/declare',
    "dojo/dom-style",
    "dijit/_WidgetBase",
    ...
    return declare("buildspace.apps.PostContractSubPackageReport.VariationOrder.buildUpQuantitySummary", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        postCreate: function(){
            ...
            dojo.xhrGet({
                url: 'variationOrder/getSpBuildUpSummary',
                content: { id: this.itemId, type: this.type },
                handleAs: 'json',
                load: function(resp) {
        ...
        doApplyConversionFactor: function(){
            ...
            if(checked != this.applyConversionFactor){
                ...
                var self = this;
                dojo.xhrPost({
                    url: 'variationOrder/spBuildUpSummaryApplyConversionFactorUpdate',
                    content: { id: this.itemId, value: checked, _csrf_token: this._csrf_token, type: this.type },
                    handleAs: 'json',
                    load: function(resp) {
                        self.conversionFactorAmount = resp.conversion_factor_amount;
                        self.conversionFactorAmountNode.set('value', self.conversionFactorAmount);
        ...
        submitConversionFactorAmount: function(){
            ...
            if(amount != this.conversionFactorAmount){
                ...
                var self = this;
                dojo.xhrPost({
                    url: 'variationOrder/spBuildUpSummaryConversionFactorUpdate',
                    content: { id: this.itemId, val: amount, token: 'amount', _csrf_token: this._csrf_token, type: this.type },
                    handleAs: 'json',
                    load: function(resp) {
                        self.conversionFactorAmount = resp.conversion_factor_amount;
                        self.conversionFactorAmountNode.set('value', self.conversionFactorAmount);
        ...
        submitConversionFactorOperator: function(){
            ...
            if(operator != this.conversionFactorOperator){
                ...
                dojo.xhrPost({
                    url: 'variationOrder/spBuildUpSummaryConversionFactorUpdate',
                    content: { id: this.itemId, val: operator, token: 'operator', _csrf_token: this._csrf_token, type: this.type },
                    handleAs: 'json',
                    load: function(resp) {
                        self.conversionFactorOperator = resp.conversion_factor_operator;
                        self.conversionFactorOperatorNode.set('value', self.conversionFactorOperator);
        ...
        submitRoundingType: function(){
            ...
            if(roundingType != this.roundingType){
                ...
                var self = this;
                dojo.xhrPost({
                    url: 'variationOrder/spBuildUpSummaryRoundingUpdate',
                    content: { id: this.itemId, rounding_type: roundingType, _csrf_token: this._csrf_token, type: this.type },
                    handleAs: 'json',
                    load: function(resp) {
