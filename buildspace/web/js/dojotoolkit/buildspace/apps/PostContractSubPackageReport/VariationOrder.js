define('buildspace/apps/PostContractSubPackageReport/VariationOrder',[
    'dojo/_base/declare',
    'dojo/aspect',
    'dojo/currency',
    'dojo/number',
    ...
    function(declare, aspect, currency, number, request, Memory, ContentPane, VariationOrderGrid, VariationOrderItemContainer, GridFormatter, nls) {
        ...
        var VariationOrderContainer = declare('buildspace.apps.PostContractSubPackageReport.VariationOrderContainer', dijit.layout.BorderContainer, {
                    ...
                    grid = new VariationOrderGrid({
                        ...
                        gridOpts: {
                            ...
                            getAffectedItemsByVO: function(item, type) {
                                ...
                                request.post('subPackageVariationOrderReporting/getSubPackageAffectedItems', {
                                    handleAs: 'json',
                                    data: {
        ...
        return declare('buildspace.apps.PostContractSubPackageReport.VariationOrder', dijit.layout.BorderContainer, {
            region: "center",
            subPackage: null,
            style: "padding:0px;border:0px;margin:0px;width:100%;height:100%;",
            postCreate: function() {
                this.inherited(arguments);
                this.addChild(VariationOrderContainer({
