define('buildspace/apps/PostContractSubPackageReport/Preliminaries/buildUpQuantityGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    var BuildUpQuantityGrid = declare('buildspace.apps.PostContractSubPackageReport.BuildUpQuantity.grid', dojox.grid.EnhancedGrid, {
    ...
    return declare('buildspace.apps.PostContractSubPackageReport.BuildUpQuantityGrid', dijit.layout.BorderContainer, {
        ...
        postCreate: function(){
            ...
            var disableButton = (self.gridOpts.editable) ? false : true;
