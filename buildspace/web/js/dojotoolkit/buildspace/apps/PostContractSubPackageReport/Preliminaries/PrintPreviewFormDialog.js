...
(function() {
  define('buildspace/apps/PostContractSubPackageReport/Preliminaries/PrintPreviewFormDialog', ["dojo/_base/declare", 'dojo/_base/lang', "dojo/keys", "dojo/parser", "dijit/_WidgetBase", "dijit/_OnDijitClickMixin", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", 'dijit/Toolbar', 'dijit/form/Button', "dijit/layout/BorderContainer", "dijit/form/ValidationTextBox", "dijit/form/RadioButton", "dijit/form/SimpleTextarea", "dijit/registry", "dojo/dom-style", "dojo/dom-form", "dojo/request", "dojo/json", "dojox/validate/web", "dojox/form/Manager", "dojo/text!./templates/printPreviewForm.html", 'dojo/i18n!buildspace/nls/TenderingReport'], function(declare, lang, keys, parser, _WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin, Toolbar, Button, BorderContainer, ValidationTextBox, RadioButton, SimpleTextarea, registry, domStyle, domForm, request, JSON, web, Manager, template, nls) {
    ...
    printPreviewForm = declare("buildspace.apps.PostContractSubPackageReport.PrintPreviewForm", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
      ...
      print: function() {
        var bill_id_element, csrfToken, descriptionFormat, form, formValues, priceFormat, printNoCents, printingPageTitle, selectedRows, self, sub_package_id_element;
        self = this;
        ...
        if (this.subPackageId > 0) {
          sub_package_id_element = document.createElement("input");
          sub_package_id_element.setAttribute("name", "subPackageId");
          sub_package_id_element.setAttribute("value", this.subPackageId);
          sub_package_id_element.setAttribute('type', 'hidden');
          form.appendChild(sub_package_id_element);
        }
        if (this.billId > 0) {
      ...
      "export": function() {
        var bill_id_element, csrfToken, descriptionFormat, form, formValues, priceFormat, printNoCents, printingPageTitle, selectedRows, self;
        self = this;
        form = this.viewTendererReportingPrintForm;
        if (!form.validate()) {
          return false;
    ...
    return Dialog = declare('buildspace.apps.PostContractSubPackageReport.PrePrintFormDialog', dijit.Dialog, {
