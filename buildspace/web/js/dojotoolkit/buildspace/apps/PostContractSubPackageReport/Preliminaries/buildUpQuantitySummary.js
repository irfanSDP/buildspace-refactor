define('buildspace/apps/PostContractSubPackageReport/Preliminaries/buildUpQuantitySummary',[
    'dojo/_base/declare',
    "dijit/_WidgetBase",
    ...
    return declare("buildspace.apps.PostContractSubPackageReport.buildUpQuantitySummary", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
            ...
            var self = this,
                xhrArgs = {
                    ...
                    load: function(resp) {
                        ...
                        var disabled = (self.editable) ? false : true;
