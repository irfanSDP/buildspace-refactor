...
(function() {
  define("buildspace/apps/PostContractSubPackageReport/Preliminaries/PrintAllSelectedItemWithClaims", ["dojo/_base/declare", "dojo/aspect", "dojo/_base/lang", "dojo/_base/connect", "dojo/when", "dojo/html", "dojo/dom", "dojo/keys", "dojo/dom-style", "dojo/request", "dojo/json", "dojo/number", "dojo/currency", "./PrintPreviewFormDialog", "buildspace/widget/grid/cells/Formatter", 'dojo/i18n!buildspace/nls/PostContract'], function(declare, aspect, lang, connect, when_, html, dom, keys, domStyle, request, JSON, number, currency, PrintPreviewFormDialog, Formatter, nls) {
    ...
    reportingFormatter = declare("buildspace.apps.PostContractSubPackageReport.Preliminaries.PreviewItemGridFormatter", null, {
      formulaPrelimCurrencyCellFormatter: function(cellValue, rowIdx, cell) {
        ...
        if (item.type === buildspace.widget.grid.constants.HIERARCHY_TYPE_HEADER || item.type === buildspace.widget.grid.constants.HIERARCHY_TYPE_HEADER_N || item.type === buildspace.widget.grid.constants.HIERARCHY_TYPE_NOID) {
          ...
          if (fieldName && (fieldName === buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.PRELIM_COLUMN_RECURRING || fieldName === buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.PRELIM_COLUMN_TIMEBASED || fieldName === buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.PRELIM_COLUMN_WORKBASED)) {
      ...
      prelimPercentFormatter: function(cellValue, rowIdx, cell) {
        ...
        if (item.type[0] < 1) {
          ...
          cell.customClasses.push("disable-cell");
          val = "&nbsp;";
        } else if (fieldName && (fieldName === buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.PRELIM_COLUMN_RECURRING || fieldName === buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.PRELIM_COLUMN_TIMEBASED || fieldName === buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.PRELIM_COLUMN_WORKBASED)) {
          cell.customClasses.push("recurring-cell");
        } else {
          if (fieldName && (fieldName === buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.PRELIM_COLUMN_PREVIOUSCLAIM || fieldName === buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.PRELIM_COLUMN_CURRENTCLAIM || fieldName === buildspace.apps.PostContractSubPackageReport.ProjectStructureConstants.PRELIM_COLUMN_UPTODATECLAIM)) {
            cell.customClasses.push("disable-cell");
          }
        }
        if (item.type[0] < 1) {
    ...
    selectedItemGrid = declare("buildspace.apps.PostContractSubPackageReport.Preliminaries.SelectedItemGrid", dojox.grid.EnhancedGrid, {
    ...
    selectedItemGridContainer = declare("buildspace.apps.PostContractSubPackageReport.Preliminaries.SelectedItemGridContainer", dijit.layout.BorderContainer, {
      ...
      openPrintingDialog: function(self) {
        ...
        return request.get("viewTendererReporting/getPrintingInformation", {
          ...
          dialog = new PrintPreviewFormDialog({
            ...
            printURL: 'postContractSubPackagePreliminaries/printPrelimSelectedItemWithClaim',
            exportURL: 'exportExcelReport/exportPostContractPrelimSelectedItemWithClaim',
    ...
    return Dialog = declare("buildspace.apps.PostContractSubPackageReport.Preliminaries.GroupProjectAssignmentDialog", dijit.Dialog, {
