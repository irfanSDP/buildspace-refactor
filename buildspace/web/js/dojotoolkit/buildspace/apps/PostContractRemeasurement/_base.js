define(["../../../dojo/_base/declare",
    ...
    var Base = declare('buildspace.apps.PostContractRemeasurement', buildspace.apps._App, {
        win: null,
        type: null,
        opt: null,
        project: null,
        init: function(args){
            ...
            var win = this.win = new buildspace.widget.Window({
                title: nls.postContract + ' > ' + nls.remeasureProvisional + ' (' + nls[opt] + ')' + ' - ' + buildspace.truncateString(project.title, 100),
            ...
            toolbar.addChild(
                new dijit.form.Button({
                    label: nls.backTo + ' ' + nls.postContract,
            ...
            var remeasurementContainer = new buildspace.apps.PostContractRemeasurement.RemeasurementContainer({
                project: project,
                region: "center",
                opt: opt
            });
