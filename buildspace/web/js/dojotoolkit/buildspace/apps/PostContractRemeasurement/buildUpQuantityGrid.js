define('buildspace/apps/PostContractRemeasurement/buildUpQuantityGrid',[
    'dojo/_base/declare',
    'dojo/_base/lang',
    "dojo/_base/array",
    "dojo/dom-attr",
    ...
    'dojo/i18n!buildspace/nls/BuildUpQuantityGrid'], function(declare, lang, array, domAttr, connect, TooltipDialog, popup, Menu, Selector, Rearrange, FormulatedColumn, evt, keys, currency, focusUtil, html, xhr, PopupMenuItem, Select, Textarea, FormulaTextBox, nls ){

    var BuildUpQuantityGrid = declare('buildspace.apps.PostContractRemeasurement.BuildUpQuantity.grid', dojox.grid.EnhancedGrid, {
        BillItem: null,
        ...
        disableToolbarButtons: function(isDisable, buttonsToEnable){
            var addRowBtn = dijit.byId('postContractRemeasurementBuildUpGrid-'+this.BillItem.id+'AddRow-button');
            var deleteRowBtn = dijit.byId('postContractRemeasurementBuildUpGrid-'+this.BillItem.id+'DeleteRow-button');
            ...
            if(isDisable && buttonsToEnable instanceof Array ){
                ...
                dojo.forEach(buttonsToEnable, function(label){
                    var btn = dijit.byId('postContractRemeasurementBuildUpGrid-'+_this.BillItem.id+label+'Row-button');
            ...
            if(!disableButton){
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        id: 'postContractRemeasurementBuildUpGrid-'+this.BillItem.id+'AddRow-button',
                        label: nls.addRow,
                        iconClass: "icon-16-container icon-16-add",
                ...
                toolbar.addChild(
                    new dijit.form.Button({
                        id: 'postContractRemeasurementBuildUpGrid-'+this.BillItem.id+'DeleteRow-button',
                        label: nls.deleteRow,
                        iconClass: "icon-16-container icon-16-delete",
                        disabled: disableButton ? disableButton : grid.selection.selectedIndex > -1 ? false : true,
                        onClick: function(){
