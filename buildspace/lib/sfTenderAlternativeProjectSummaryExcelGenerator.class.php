...
class sfTenderAlternativeProjectSummaryExcelGenerator
{
    protected $objPHPExcel;
    protected $tenderCompany;
    protected $withNotListedItem;

    function __construct(TenderAlternative $tenderAlternative, $tenderCompany=null, $withNotListedItem=true)
    {
    ...
    private function setProperties()
    {
        ...
        $this->objPHPExcel->getProperties()->setTitle(trim($project->ProjectSummaryGeneralSetting->summary_title));
        $this->objPHPExcel->getProperties()->setSubject("Tender Summary");
        $this->objPHPExcel->getProperties()->setDescription(trim($project->ProjectSummaryGeneralSetting->project_title));
    ...
    {
        $summaryPageGenerator = new sfBuildspaceTenderAlternativeProjectSummaryGenerator($this->tenderAlternative, false, $this->tenderCompany, $this->withNotListedItem);
        ...
        if($page['summary_items'] instanceof SplFixedArray)
        {
            ...
            $this->objPHPExcel->getActiveSheet()->setCellValue('D'.$headerRowCount, "Amount (".$project->MainInformation->Currency->currency_code.")");
