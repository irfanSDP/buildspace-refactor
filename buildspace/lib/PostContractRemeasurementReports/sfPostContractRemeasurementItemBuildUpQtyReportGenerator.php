...
class sfPostContractRemeasurementItemBuildUpQtyReportGenerator extends sfBuildspaceBQMasterFunction {
	...
	public function __construct(PostContract $postContract, ProjectStructure $bill, $descriptionFormat = sfBuildspaceReportBillPageGenerator::DESC_FORMAT_FULL_LINE)
	{
	...
	public function getMaxRows()
	{
		...
		switch ($dimensionsCount)
		{
			...
			default:
				throw new InvalidArgumentException('Exceeded maximum dimension type');
				break;
		}
