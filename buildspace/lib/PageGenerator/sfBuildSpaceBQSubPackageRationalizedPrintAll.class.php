...
class sfBuildSpaceBQSubPackageRationalizedPrintAll extends sfBuildSpaceBQRationalizedPrintAll {
    ...
    {
        $bqPageGenerator    = new sfBuildspaceSubPackageRationalizedSummaryPageGenerator($this->projectStructure, null, $this->withNotListedItem);
    ...
    public function generateBillItemAndCollectionPages($sendToBrowser)
    {
        ...
        {
        	$bqPageGenerator      = new sfBuildspaceBQSubPackageRationalizedPageGenerator($this->projectStructure, $element, $this->withNotListedItem);
            $pages                = $bqPageGenerator->generatePages();
