...
class sfBuildSpaceBQSubPackageEstimationPrintAll extends sfBuildSpaceBQEstimationPrintAll 
{
    ...
    {
        $bqPageGenerator    = new sfBuildspaceSubPackageEstimationSummaryPageGenerator($this->projectStructure, null, $this->withNotListedItem);
    ...
    public function generateBillItemAndCollectionPages($sendToBrowser)
    {
        ...
        {
        	$bqPageGenerator      = new sfBuildspaceBQSubPackageEstimationPageGenerator($this->projectStructure, $element, $this->withNotListedItem);
            $pages                = $bqPageGenerator->generatePages();
