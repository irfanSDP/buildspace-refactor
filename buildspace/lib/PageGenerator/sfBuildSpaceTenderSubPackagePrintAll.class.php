...
class sfBuildSpaceTenderSubPackagePrintAll extends sfBuildSpaceBQPrintAll {
    ...
    {
    	$bqPageGenerator    = new sfBuildspaceTenderSubPackageBQPageGenerator($this->projectStructure, null);
    ...
    public function generateBillItemAndCollectionPages($sendToBrowser)
    {
        ...
        {
            $bqPageGenerator      = new sfBuildspaceTenderSubPackageBQPageGenerator($this->projectStructure, $element);
            $pages                = $bqPageGenerator->generatePages();
