...
class sfCostDataProjectInformationBreakdownComparisonExcelReportGenerator extends sfBuildspaceExcelReportGenerator {
    ...
    public function setParameters(array $benchMarkCostDataIds)
    {
    ...
    protected function processRows()
    {
        ...
        foreach($this->items as $itemId => $item)
        {
            ...
            $this->activeSheet->setCellValue($this->currentCol . $this->currentRow, $item['item']);
