<?php
class sfSorTradeItemReportGenerator extends sfBuildspaceExcelReportGenerator
{
    public $colUnit = "E";
    public $colRate = "F";
    public $colMarkup = "H";
    public $colTotalQty = "D";
    public $colTotalCost = "G";
    public $scheduleOfRateItemTotals;
    public $currentElementId;
    public $currentscheduleOfRateId;
    ...
    public function createHeader( $new = false ) 
    {
        ...
        $this->activeSheet->setCellValue( $this->colTotalCost.$row, self::COL_NAME_GRAND_TOTAL );
    ...
    public function process( $pages, $lock = false, $header, $subTitle, $topLeftTitle, $withoutCents, $totalPage)
    {
        ...
        {
            $this->currentscheduleOfRateId = $key;
