<?php
class sfBuildspaceLibraryExcelParser
{
    public $filename;
    public $uploadPath;
    public $extension;
    ...
    public $currentTradeId = -1;
    public $currentTradeDescription;
    ...
    public $tradeItemCount = array();
    public $tradeErrorCount = array();
    ...
    const ROW_TYPE_ELEMENT_TEXT = "Trade";
    ...
    public function readRowItem()
    {
        ...
        if($rowDescription != null && $rowDescription != ''){
            $this->setTrade(); //Set Trade
            $this->setItem(); //Set Item
        }
    }

    public function createXML(){
        $this->sfExportXML = new sfBuildspaceExportLibraryXML($this->filename, $this->uploadPath, null, false);
    ...
    public function setTrade(){
        ...
        //Override Set Trade Method
        /* This is Buildspace default setTrade Method */
        $this->newTrade();
    ...
    public function setItem(){
        // Later to put default Set Item & Trade Function
    ...
    public function getValidatedUOM($coord = NULL){
        ...
        if(!$this->isEmpty($uomSymbol)){
            ...
            else
            {
                ...
                $this->tradeErrorCount[$this->currentTradeId] += 1;
            }
        }
    ...
    public function processPreviewData(){
        ...
        $this->setActiveSheet(); //For now we'll defaulted to 
