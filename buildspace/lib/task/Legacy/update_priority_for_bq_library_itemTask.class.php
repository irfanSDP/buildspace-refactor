...
class update_priority_for_bq_library_itemTask extends sfBaseTask
{
	protected function configure()
	{
		...
		$this->namespace           = '';
		$this->name                = 'update_priority_for_bq_library_item';
		$this->briefDescription    = '';
		$this->detailedDescription = <<<EOF
The [update_priority_for_bq_library_item|INFO] task does things.
Call it with:

  [php symfony update_priority_for_bq_library_item|INFO]
EOF;
	}
	...
	protected function execute($arguments = array(), $options = array())
	{
		...
		{
			$this->logSection('update-bq-item-priority', 'Nothing to be updated !');
		...
		$this->logSection('update-bq-item-priority', 'Successfully updated all the BQ Item(s) priority');
	}
	...
	{
		$stmt = $connection->prepare("UPDATE " . BQItemTable::getInstance()->getTableName() . " SET
