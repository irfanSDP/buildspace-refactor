...
class sfBuildspacePostContractSubPackageReportPageItemWithClaimGenerator extends sfBuildspacePostContractSubPackageReportPageItemGenerator
{
    ...
    public function generatePages($typeRef)
    {
        ...
        foreach($this->affectedElements as $affectedElement)
        {
	        ...
	        $billItems   = SubPackageTable::getDataForPrintingPreviewItemsByColumn($element, $revision, $this->subPackage, $typeRef, 'up_to_date_amount');
