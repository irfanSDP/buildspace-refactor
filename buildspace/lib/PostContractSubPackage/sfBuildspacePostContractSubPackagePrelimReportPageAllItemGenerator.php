...
class sfBuildspacePostContractSubPackagePrelimReportPageAllItemGenerator extends sfBuildspacePostContractSubPackagePrelimReportPageItemGenerator
{
	...
	public function generatePages()
	{
		...
		foreach($this->affectedElements as $affectedElement)
		{
			...
			) = SubPackagePostContractBillItemRateTable::getPrintingPreviewDataStructureForPrelimBillItemListByClaimType($this->subPackage, $fakeObjectElement, $bill, 'upToDateClaim-amount');
