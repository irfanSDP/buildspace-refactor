...
class sfBuildSpaceSubPackageVariationOrderBuildUpItemGenerator extends sfBuildspaceBQMasterFunction {
	...
	public function __construct(ProjectStructure $project, SubPackage $subPackage, $descriptionFormat = sfBuildspaceReportBillPageGenerator::DESC_FORMAT_FULL_LINE)
	{
