...
class sfBuildspaceSubPackageVOWithClaimsReportGenerator extends sfBuildspaceBQMasterFunction {
	...
	public function generatePages()
	{
		...
		foreach($records as $key => $record)
		{
			...
			foreach($upToDateClaims as $upToDateClaim)
			{
				...
				{
					$records[$key]['up_to_date_percentage'] = $upToDateClaim['up_to_date_percentage'];
			...
			$voTotals['omission']               += ($records[$key]['is_approved'] && $records[$key]['total_claim'] > 0) ? $records[$key]['omission'] : 0;
			$voTotals['addition']               += ($records[$key]['is_approved'] && $records[$key]['total_claim'] > 0) ? $records[$key]['addition'] : 0;
			$voTotals['nett_omission_addition'] += ($records[$key]['is_approved'] && $records[$key]['total_claim'] > 0) ? $records[$key]['nett_omission_addition'] : 0;
			$voTotals['total_claim']            += ($records[$key]['is_approved'] && $records[$key]['total_claim'] > 0) ? $records[$key]['total_claim'] : 0;
