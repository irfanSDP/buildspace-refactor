...
/**
 * SubPackageBillLayoutSettingTable
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 */
class SubPackageBillLayoutSettingTable extends Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return object SubPackageBillLayoutSettingTable
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('SubPackageBillLayoutSetting');
    }
    ...
    public function getPrintingLayoutSettings($printingSettingId, $printingMode = FALSE)
    {
        ...
        $headSettings  = $masterSetting->getSubPackageBillHeadSettings();
        $phrase        = $masterSetting->getSubPackageBillPhrase();
    ...
    public static function cloneExistingPrintingLayoutSettingsForSubPackage($subPackageId)
    {
        //Clone Bill Layout Setting
        ...
        unset($defaultSetting['bill_id'], $defaultSetting['id'], $defaultSetting['created_at'], $defaultSetting['updated_at'], $defaultSetting['created_by'], $defaultSetting['updated_by'], $defaultSetting['deleted_at']);

        $defaultSetting['sub_package_id'] = $subPackageId;
        $newPrintingSettingObject  = new SubPackageBillLayoutSetting();
        ...
        $newSubPackageBillLayoutSettingId = $newPrintingSettingObject->id;
        // ====================================================================================================================================

        // ====================================================================================================================================     // BillLayoutPhrase
        // ====================================================================================================================================
        // strip off unnecessary information to be clone into the db
        unset($billPhraseSetting['bill_layout_setting_id'], $billPhraseSetting['id'], $billPhraseSetting['created_at'], $billPhraseSetting['updated_at'], $billPhraseSetting['created_by'], $billPhraseSetting['updated_by'], $billPhraseSetting['deleted_at']);

        $billPhraseSetting['sub_package_bill_layout_setting_id'] = $newSubPackageBillLayoutSettingId;
        $newPrintingSettingObject                                = new SubPackageBillLayoutPhrase();
        ...
        {
            $newPrintingSettingObject = new SubPackageBillLayoutHeadSetting();

            // strip off unnecessary information to be clone into the db
            unset($newPrintingSetting['bill_layout_setting_id'], $newPrintingSetting['id'], $newPrintingSetting['created_at'], $newPrintingSetting['updated_at'], $newPrintingSetting['created_by'], $newPrintingSetting['updated_by'], $newPrintingSetting['deleted_at']);

            $newPrintingSetting['sub_package_bill_layout_setting_id'] = $newSubPackageBillLayoutSettingId;
        ...
        return $newSubPackageBillLayoutSettingId;
        // ====================================================================================================================================
    }
}