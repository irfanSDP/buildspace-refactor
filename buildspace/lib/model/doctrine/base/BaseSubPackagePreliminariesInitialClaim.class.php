...
Doctrine_Manager::getInstance()->bindComponent('SubPackagePreliminariesInitialClaim', 'main_conn');

/**
 * BaseSubPackagePreliminariesInitialClaim
 * 
 ...
 * @method SubPackagePreliminariesInitialClaim setSubPackagePostContractBillItemRateId()        Sets the current record's "sub_package_post_contract_bill_item_rate_id" value
 * @method SubPackagePreliminariesInitialClaim setPercentage()                                  Sets the current record's "percentage" value
 * @method SubPackagePreliminariesInitialClaim setAmount()                                      Sets the current record's "amount" value
 * @method SubPackagePreliminariesInitialClaim setRevisionId()                                  Sets the current record's "revision_id" value
 * @method SubPackagePreliminariesInitialClaim setItemRate()                                    Sets the current record's "ItemRate" value
 * @method SubPackagePreliminariesInitialClaim setRevision()                                    Sets the current record's "Revision" value
 * 
 * @package    buildspace
 * @subpackage model
 ...
 */
abstract class BaseSubPackagePreliminariesInitialClaim extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('sub_package_prelim_initial_claims');
        ...
        $this->index('sub_package_prelim_initial_claim_uniq_idx', array(
             'fields' => 
             array(
