...
Doctrine_Manager::getInstance()->bindComponent('PreliminariesFinalClaim', 'main_conn');

/**
 * BasePreliminariesFinalClaim
 * 
 ...
 * @method PreliminariesFinalClaim   setPostContractBillItemRateId()      Sets the current record's "post_contract_bill_item_rate_id" value
 * @method PreliminariesFinalClaim   setPercentage()                      Sets the current record's "percentage" value
 * @method PreliminariesFinalClaim   setAmount()                          Sets the current record's "amount" value
 * @method PreliminariesFinalClaim   setRevisionId()                      Sets the current record's "revision_id" value
 * @method PreliminariesFinalClaim   setItemRate()                        Sets the current record's "ItemRate" value
 * @method PreliminariesFinalClaim   setRevision()                        Sets the current record's "Revision" value
 * 
 * @package    buildspace
 * @subpackage model
 ...
 */
abstract class BasePreliminariesFinalClaim extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('prelim_final_claims');
        ...
        $this->index('prelim_final_claim_uniq_idx', array(
             'fields' => 
             array(
