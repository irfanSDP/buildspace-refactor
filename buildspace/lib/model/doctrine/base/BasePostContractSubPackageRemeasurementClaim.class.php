...
Doctrine_Manager::getInstance()->bindComponent('PostContractSubPackageRemeasurementClaim', 'main_conn');

/**
 * BasePostContractSubPackageRemeasurementClaim
 * 
 ...
 * @method PostContractSubPackageRemeasurementClaim setSubPackagePostContractBillItemRateId()        Sets the current record's "sub_package_post_contract_bill_item_rate_id" value
 * @method PostContractSubPackageRemeasurementClaim setBillColumnSettingId()                         Sets the current record's "bill_column_setting_id" value
 * @method PostContractSubPackageRemeasurementClaim setQtyPerUnit()                                  Sets the current record's "qty_per_unit" value
 * @method PostContractSubPackageRemeasurementClaim setTotalPerUnit()                                Sets the current record's "total_per_unit" value
 * @method PostContractSubPackageRemeasurementClaim setHasBuildUp()                                  Sets the current record's "has_build_up" value
 * @method PostContractSubPackageRemeasurementClaim setItemRate()                                    Sets the current record's "ItemRate" value
 * @method PostContractSubPackageRemeasurementClaim setBillColumnSetting()                           Sets the current record's "BillColumnSetting" value
 * 
 * @package    buildspace
 * @subpackage model
 ...
 */
abstract class BasePostContractSubPackageRemeasurementClaim extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('post_contract_sp_remeasurement_claims');
        ...
        $this->index('post_contract_sp_remeasurement_claim_uniq_idx', array(
             'fields' => 
             array(
