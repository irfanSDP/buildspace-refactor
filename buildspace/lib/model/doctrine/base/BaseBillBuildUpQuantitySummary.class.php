...
Doctrine_Manager::getInstance()->bindComponent('BillBuildUpQuantitySummary', 'main_conn');

/**
 * BaseBillBuildUpQuantitySummary
 * 
 ...
 * @method BillBuildUpQuantitySummary setId()                         Sets the current record's "id" value
 * @method BillBuildUpQuantitySummary setBillItemId()                 Sets the current record's "bill_item_id" value
 * @method BillBuildUpQuantitySummary setBillColumnSettingId()        Sets the current record's "bill_column_setting_id" value
 * @method BillBuildUpQuantitySummary setLinkedTotalQuantity()        Sets the current record's "linked_total_quantity" value
 * @method BillBuildUpQuantitySummary setTotalQuantity()              Sets the current record's "total_quantity" value
 * @method BillBuildUpQuantitySummary setFinalQuantity()              Sets the current record's "final_quantity" value
 * @method BillBuildUpQuantitySummary setApplyConversionFactor()      Sets the current record's "apply_conversion_factor" value
 * @method BillBuildUpQuantitySummary setConversionFactorAmount()     Sets the current record's "conversion_factor_amount" value
 * @method BillBuildUpQuantitySummary setConversionFactorOperator()   Sets the current record's "conversion_factor_operator" value
 * @method BillBuildUpQuantitySummary setRoundingType()               Sets the current record's "rounding_type" value
 * @method BillBuildUpQuantitySummary setType()                       Sets the current record's "type" value
 * @method BillBuildUpQuantitySummary setBillItem()                   Sets the current record's "BillItem" value
 * @method BillBuildUpQuantitySummary setBillColumnSetting()          Sets the current record's "BillColumnSetting" value
 * 
 * @package    buildspace
 * @subpackage model
 ...
 */
abstract class BaseBillBuildUpQuantitySummary extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('bill_build_up_quantity_summaries');
        ...
        $this->index('bill_buq_summary_id_idx', array(
             'fields' => 
             array(
              0 => 'id',
              1 => 'bill_item_id',
        ...
        $this->index('bill_buq_unique_idx', array(
             'fields' => 
             array(
              0 => 'bill_item_id',
