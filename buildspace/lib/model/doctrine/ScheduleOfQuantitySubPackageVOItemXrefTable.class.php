...
/**
 * ScheduleOfQuantitySubPackageVOItemXrefTable
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 */
class ScheduleOfQuantitySubPackageVOItemXrefTable extends Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return object ScheduleOfQuantitySubPackageVOItemXrefTable
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('ScheduleOfQuantitySubPackageVOItemXref');
    }
    ...
    public static function getSelectedItemsBuildUpQuantity(ProjectStructure $project, array $voBillItems)
    {
        ...
        $stmt = $pdo->prepare("SELECT DISTINCT xref.schedule_of_quantity_item_id, xref.sub_package_variation_order_item_id, p.id, p.description, p.type, p.lft,
        ...
        JOIN ".self::getInstance()->getTableName()." xref ON xref.schedule_of_quantity_item_id = c.id
        ...
        WHERE xref.sub_package_variation_order_item_id IN (".implode(',', $itemIds).")
        AND xref.type = ".$type."
        ...
        foreach ( $items as $item )
        {
            ...
            $itemsData[$type][$item['sub_package_variation_order_item_id']][] = $item;
