 ...
 */
class SubPackageMaterialOnSiteItem extends BaseSubPackageMaterialOnSiteItem {
	...
	public function save(Doctrine_Connection $conn = null)
	{
		...
		$this->SubPackageMaterialOnSite->updateAmount();
	}

	public function updateRootPriority($priority, $excludeId = null)
	{
		SubPackageMaterialOnSiteItemTable::updateRootPriority($priority, $this->SubPackageMaterialOnSite, $excludeId);
	}
	...
	public function getPreviousRoot()
	{
		...
		return $this->getTable()
			...
			->addWhere('i.sp_material_on_site_id = ?', $this->sp_material_on_site_id)
	...
	public function indent()
	{
		...
		if ( $this->node->isRoot() and $previousRoot and ( $previousRoot->type == ResourceItem::TYPE_HEADER ) )
		{
			...
			AND sp_material_on_site_id = " . $this->sp_material_on_site_id . " AND deleted_at IS NULL");
	...
	public function moveTo(SubPackageMaterialOnSiteItem $targetItem, $lastPosition = false)
	{
		...
		try
		{
			...
			{
				Doctrine_Query::create()->update('SubPackageMaterialOnSiteItem i')
	...
	public function delete(Doctrine_Connection $conn = null)
	{
		if ( $this->type == ResourceItem::TYPE_HEADER )
		{
			Doctrine_Query::create()
				->delete('SubPackageMaterialOnSiteItem i')
				->where('i.root_id = ?', $this->root_id)
				->andWhere('i.sp_material_on_site_id = ?', $this->sp_material_on_site_id)
