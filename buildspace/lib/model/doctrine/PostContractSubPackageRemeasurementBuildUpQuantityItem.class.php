 ...
 */
class PostContractSubPackageRemeasurementBuildUpQuantityItem extends BasePostContractSubPackageRemeasurementBuildUpQuantityItem
{
    ...
    {
        return PostContractSubPackageRemeasurementBuildUpQuantityItemTable::getFormulatedColumnByRelationIdAndColumnName($this->id, $columnName, $hydrate);
    }

    public function calculateTotal()
    {
        $formulatedColumnNames = $this->getTable()->getFormulatedColumnNames($this->SubPackagePostContractBillItemRate->BillItem->UnitOfMeasurement);
        ...
        try
        {
            ...
            foreach($this->FormulatedColumns as $formulatedColumn)
            {
                ...
                if(is_array($nodes))
                {
                    ...
                    {
                        $referencedNode = Doctrine_Core::getTable('PostContractSubPackageRemeasurementBuildUpQuantityFormulatedColumn')->find($node['node_from']);
            ...
            if(count($formulatedColumnIds) > 0)
            {
                ...
                ->delete('PostContractSubPackageRemeasurementBuildUpQuantityEdge e')
    ...
    public function copyFormulatedColumnsFromItem(PostContractSubPackageRemeasurementBuildUpQuantityItem $item)
    {
        $formulatedColumnNames = PostContractSubPackageRemeasurementBuildUpQuantityItemTable::getFormulatedColumnNames($this->SubPackagePostContractBillItemRate->BillItem->UnitOfMeasurement);
        $edgeTable = Doctrine_Core::getTable('PostContractSubPackageRemeasurementBuildUpQuantityEdge');
