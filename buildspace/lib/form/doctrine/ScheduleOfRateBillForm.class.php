 ...
 */
class ScheduleOfRateBillForm extends BaseScheduleOfRateBillForm
{
    ...
    public function doSave($con=null)
    {
        ...
        if(($this->projectStatus) && $this->projectStatus == ProjectMainInformation::STATUS_PRETENDER)
        {
            if($isNew)
            {
                ...
                $billStructure->type = ProjectStructure::TYPE_SCHEDULE_OF_RATE_BILL;
        ...
        if($isNew)
        {
            ...
            ScheduleOfRateBillLayoutSettingTable::cloneExistingPrintingLayoutSettingsForBill($this->object, $defaultSetting, $billPhraseSetting, $headSettings);
