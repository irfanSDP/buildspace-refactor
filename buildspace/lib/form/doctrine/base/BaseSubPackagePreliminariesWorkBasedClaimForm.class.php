...
/**
 * SubPackagePreliminariesWorkBasedClaim form base class.
 *
 * @method SubPackagePreliminariesWorkBasedClaim getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseSubPackagePreliminariesWorkBasedClaimForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'SubPackagePreliminariesWorkBasedClaim', 'column' => array('sub_package_post_contract_bill_item_rate_id', 'revision_id', 'deleted_at')))
    );

    $this->widgetSchema->setNameFormat('sub_package_preliminaries_work_based_claim[%s]');
  ...
  {
    return 'SubPackagePreliminariesWorkBasedClaim';
  }
