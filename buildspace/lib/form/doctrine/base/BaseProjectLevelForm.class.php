...
/**
 * ProjectLevel form base class.
 *
 * @method ProjectLevel getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseProjectLevelForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('project_level[%s]');
