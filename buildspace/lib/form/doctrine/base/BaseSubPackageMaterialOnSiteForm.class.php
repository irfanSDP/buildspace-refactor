...
/**
 * SubPackageMaterialOnSite form base class.
 *
 * @method SubPackageMaterialOnSite getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseSubPackageMaterialOnSiteForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sub_package_material_on_site[%s]');
  ...
  {
    return 'SubPackageMaterialOnSite';
  }
