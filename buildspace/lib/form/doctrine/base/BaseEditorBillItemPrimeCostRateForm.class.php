...
/**
 * EditorBillItemPrimeCostRate form base class.
 *
 * @method EditorBillItemPrimeCostRate getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseEditorBillItemPrimeCostRateForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'EditorBillItemPrimeCostRate', 'column' => array('bill_item_info_id')))
    );

    $this->widgetSchema->setNameFormat('editor_bill_item_prime_cost_rate[%s]');
  ...
  {
    return 'EditorBillItemPrimeCostRate';
  }
