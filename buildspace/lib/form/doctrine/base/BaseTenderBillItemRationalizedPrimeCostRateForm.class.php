...
/**
 * TenderBillItemRationalizedPrimeCostRate form base class.
 *
 * @method TenderBillItemRationalizedPrimeCostRate getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseTenderBillItemRationalizedPrimeCostRateForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'TenderBillItemRationalizedPrimeCostRate', 'column' => array('tender_bill_item_rationalized_rates_id', 'deleted_at')))
    );

    $this->widgetSchema->setNameFormat('tender_bill_item_rationalized_prime_cost_rate[%s]');
  ...
  {
    return 'TenderBillItemRationalizedPrimeCostRate';
  }
