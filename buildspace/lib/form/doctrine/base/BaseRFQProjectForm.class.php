...
/**
 * RFQProject form base class.
 *
 * @method RFQProject getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseRFQProjectForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'RFQProject', 'column' => array('request_for_quotation_id', 'project_structure_id', 'deleted_at')))
    );

    $this->widgetSchema->setNameFormat('rfq_project[%s]');
