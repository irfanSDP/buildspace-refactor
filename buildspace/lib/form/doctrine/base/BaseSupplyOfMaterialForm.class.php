...
/**
 * SupplyOfMaterial form base class.
 *
 * @method SupplyOfMaterial getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseSupplyOfMaterialForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('supply_of_material[%s]');
