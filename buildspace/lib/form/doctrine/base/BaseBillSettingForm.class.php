...
/**
 * BillSetting form base class.
 *
 * @method BillSetting getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseBillSettingForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'build_up_quantity_rounding_type' => new sfValidatorInteger(),
      'build_up_rate_rounding_type'     => new sfValidatorInteger(),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'BillSetting', 'column' => array('project_structure_id', 'deleted_at')))
    );

    $this->widgetSchema->setNameFormat('bill_setting[%s]');
