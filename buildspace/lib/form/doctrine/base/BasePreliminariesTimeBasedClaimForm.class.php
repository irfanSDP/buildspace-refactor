...
/**
 * PreliminariesTimeBasedClaim form base class.
 *
 * @method PreliminariesTimeBasedClaim getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BasePreliminariesTimeBasedClaimForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'PreliminariesTimeBasedClaim', 'column' => array('post_contract_bill_item_rate_id', 'revision_id', 'deleted_at')))
    );

    $this->widgetSchema->setNameFormat('preliminaries_time_based_claim[%s]');
  ...
  {
    return 'PreliminariesTimeBasedClaim';
  }
