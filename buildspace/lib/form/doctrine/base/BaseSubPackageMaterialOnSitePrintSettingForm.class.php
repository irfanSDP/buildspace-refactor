...
/**
 * SubPackageMaterialOnSitePrintSetting form base class.
 *
 * @method SubPackageMaterialOnSitePrintSetting getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseSubPackageMaterialOnSitePrintSettingForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'project_name'                        => new sfValidatorString(array('max_length' => 285)),
    ...
    $this->widgetSchema->setNameFormat('sub_package_material_on_site_print_setting[%s]');
  ...
  {
    return 'SubPackageMaterialOnSitePrintSetting';
  }
