...
/**
 * SupplyOfMaterialLayoutPhraseSetting form base class.
 *
 * @method SupplyOfMaterialLayoutPhraseSetting getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseSupplyOfMaterialLayoutPhraseSettingForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'                          => new sfWidgetFormInputHidden(),
      'som_layout_setting_id'       => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('SupplyOfMaterialLayoutSetting'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'som_layout_setting_id'       => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('SupplyOfMaterialLayoutSetting'), 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('supply_of_material_layout_phrase_setting[%s]');
  ...
  {
    return 'SupplyOfMaterialLayoutPhraseSetting';
  }
