...
/**
 * SupplyOfMaterialLayoutSetting form base class.
 *
 * @method SupplyOfMaterialLayoutSetting getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseSupplyOfMaterialLayoutSettingForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('supply_of_material_layout_setting[%s]');
  ...
  {
    return 'SupplyOfMaterialLayoutSetting';
  }
