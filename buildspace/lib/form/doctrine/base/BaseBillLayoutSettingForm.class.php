...
/**
 * BillLayoutSetting form base class.
 *
 * @method BillLayoutSetting getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseBillLayoutSettingForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'                         => new sfWidgetFormInputHidden(),
      'bill_id'                    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ProjectStructure'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'bill_id'                    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('ProjectStructure'), 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('bill_layout_setting[%s]');
