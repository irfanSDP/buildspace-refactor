...
/**
 * BillLayoutPhrase form base class.
 *
 * @method BillLayoutPhrase getObject() Returns the current form's model object
 *
 * @package    buildspace
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseBillLayoutPhraseForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'                          => new sfWidgetFormInputHidden(),
      'bill_layout_setting_id'      => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('BillLayoutSetting'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'bill_layout_setting_id'      => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('BillLayoutSetting'), 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('bill_layout_phrase[%s]');
