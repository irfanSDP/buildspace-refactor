<?php
class sfImportExcelBuildsoft extends sfBuildspaceExcelParser
{
    public $colItem = "E";
    ...
    public function setElement(){
        ...
        $elementCoord = $this->colElement.$this->currentRow;

        //Read Current Row Element Description
        $elementDesc = $this->currentSheet->getCell($elementCoord)->getCalculatedValue();

        if($elementDesc == $this->currentElementDescription)
            return;
        ...
        $element = array(
            ...
            'description' => htmlspecialchars ($elementDesc)
        );
        ...
        $this->currentElementDescription = $elementDesc;
    }
}
