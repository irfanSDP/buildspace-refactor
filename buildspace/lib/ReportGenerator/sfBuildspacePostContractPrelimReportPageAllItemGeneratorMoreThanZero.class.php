...
class sfBuildspacePostContractPrelimReportPageAllItemGeneratorMoreThanZero extends sfBuildspacePostContractPrelimReportPageItemGenerator
{
    ...
    public function generatePages()
    {
        ...
        foreach($this->affectedElements as $affectedElement)
        {
            ...
            list(
                ...
                $billItemTypeRefFormulatedColumns,
                $initialCostings,
                $timeBasedCostings,
                $prevTimeBasedCostings,
                $workBasedCostings,
                $prevWorkBasedCostings,
                $finalCostings,
                $includeInitialCostings,
                $includeFinalCostings
                ) = PostContractBillItemRateTable::getPrintingPreviewDataStructureForPrelimBillItemListByClaimType($this->project->PostContract, $fakeObjectElement, $bill, 'currentClaim-amount');
