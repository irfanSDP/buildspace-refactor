...
<table cellpadding="0" cellspacing="0" class="mainTable">
	...
	<tr>
		...
		<td class="bqHeadCell" style="min-width:60px;width:60px;">Unit</td>
		<td class="bqHeadCell" style="min-width:120px;width:120px;">Rate</td>
	</tr>
	<?php
		...
		for($x=0; $x <= $maxRows; $x++):
			...
			$rate   = $itemRow ? $itemRow[sfScheduleOfRateItemReportGenerator::ROW_BILL_ITEM_RATE] : null;
