...
<table cellpadding="0" cellspacing="0" class="mainTable">
	...
	for ( $x = 0; $x <= $maxRows; $x ++ ):
		...
		<tr>
			...
			<td class="bqQtyCell">
				<?php echo !empty( $deliveredQty ) ? number_format($deliveredQty, $priceFormatting[2], $priceFormatting[0], ( $qtyCommaRemove ) ? '' : $priceFormatting[1]) : null; ?>
			</td>
			<td class="bqQtyCell">
				<?php echo !empty( $usedQty ) ? number_format($usedQty, $priceFormatting[2], $priceFormatting[0], ( $qtyCommaRemove ) ? '' : $priceFormatting[1]) : null; ?>
			</td>
			<td class="bqQtyCell">
	...
	<?php if ( $isLastPage ): ?>
		...
		<?php if ( $reduction_percentage > 0 or $reduction_percentage < 0 ) : ?>
			<tr>
				<td class="footer" style="padding-right:5px;" colspan="6">
			...
			<tr>
				<td style="padding-right:5px;" colspan="6">
