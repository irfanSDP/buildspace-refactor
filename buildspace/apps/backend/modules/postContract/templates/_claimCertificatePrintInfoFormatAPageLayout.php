<fieldset style="border-bottom:none;">
    ...
    <table cellpadding="2" cellspacing="2" width="100%">
		...
		<?php if($claimCertificatePrintSettings['display_tax_amount']):?>
			<tr>
				<td style="width:132px;text-align:left">Bill Total with Tax:</td>
				<td style="text-align:left" colspan="3"><?php echo $billTotalWithTax ?></td>
			</tr>
			<tr>
				<td style="width:132px;text-align:left">Total VO Amount with Tax:</td>
				<td style="text-align:left" colspan="3"><?php echo $voOverallTotalWithTax ?></td>
			</tr>
			<tr>
				<td style="width:132px;text-align:left">Contract Sum with Tax:</td>
				<td style="text-align:left" colspan="3"><?php echo $contractSumWithTax ?></td>
			</tr>
			
			<tr>
				<td style="width:132px;text-align:left">Balance of Contingency:</td>
				<td style="text-align:left" colspan="3"><?php echo $balanceOfContingency ?></td>
			</tr>
		<?php endif?>
		<tr>
...
<fieldset>
    <table cellpadding="0" cellspacing="5" width="100%">
		...
		<tr>
			...
			<td colspan="<?php if($claimCertificatePrintSettings['display_tax_column']):?> 6 <?php else:?> 4 <?php endif?>"></td>
		</tr>
		<tr>
		    <td colspan="<?php if($claimCertificatePrintSettings['display_tax_column']):?> 8 <?php else:?> 6 <?php endif?>"></td>
		</tr>
		...
		<tr>
			...
			<td style="text-align:right"><strong><?php echo $netPayableAmount ?></strong></td>
			<?php if($claimCertificatePrintSettings['display_tax_column']):?>
		    <td style="text-align:right"><?php echo $netPayableAmountGST ?></td>
			<td style="text-align:right"><strong><?php echo $netPayableAmountOverallTotal ?></strong></td>
			<?php endif?>
		</tr>
