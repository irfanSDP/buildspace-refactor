    ...
    for($x=0; $x < $maxRows; $x++):
        ...
        <tr>
            ...
            <td class="bqDescriptionCell" style="padding-left: <?php echo $itemPadding; ?>px;">
                ...
                <?php include_partial('printBQ/primeCostRateTable', array('rowCount'=>$rowCount, 'printAmountOnly' => $printAmountOnly, 'currency'=>$currency,'itemRow'=>$itemRow,'priceFormatting'=>$priceFormatting, 'printNoPrice' => $printNoPrice, 'printFullDecimal' => $printFullDecimal, 'rateCommaRemove' => $rateCommaRemove)) ?>
                <?php else:?>
            ...
            <?php if ( ! $printAmountOnly ): ?>
                <?php if ( $itemRow[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_TYPE] == BillItem::TYPE_ITEM_LUMP_SUM_PERCENT and ! empty($itemRow[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_ID]) ): ?>
            ...
            <?php elseif ( $itemRow[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_TYPE] == BillItem::TYPE_ITEM_LUMP_SUM ): ?>
                ...
                foreach($billColumnSettings as $billColumnSetting) {
                    ...
                    $includeStatus = $itemRow && is_array($itemRow[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_INCLUDE]) && array_key_exists($billColumnSettingId, $itemRow[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_INCLUDE]) ? $itemRow[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_INCLUDE][$billColumnSettingId] : 0;
            ...
            <?php elseif ( $itemRow[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_TYPE] == BillItem::TYPE_ITEM_LUMP_SUM_PERCENT ): ?>
                ...
                foreach($billColumnSettings as $billColumnSetting) {
                    ...
                    $quantity = $itemRow && is_array($itemRow[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_QTY_PER_UNIT]) && array_key_exists($billColumnSettingId, $itemRow[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_QTY_PER_UNIT]) && $itemRow[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_QTY_PER_UNIT][$billColumnSettingId] != 0 ? $itemRow[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_QTY_PER_UNIT][$billColumnSettingId] : 0;
                }
