<table cellpadding="0" cellspacing="0" class="mainTable">
    ...
    <tr>
        ...
        <?php
        $totalPerUnit = (array_key_exists('total_per_unit', $summaryPage) && isset($summaryPage['total_per_unit'][$billColumnSettingId])) ? $summaryPage['total_per_unit'][$billColumnSettingId] : 0;
        $totalPerUnit = number_format($totalPerUnit, $priceFormatting[2], $priceFormatting[0], $priceFormatting[1]);
        ?>
    ...
    <tr style="border-left:1px solid #000;border-bottom: 1px solid #000;">
        ...
        if($printGrandTotalQty)
        {
            $totalPerType = array_key_exists('total_per_unit', $summaryPage) ? $summaryPage['total_per_unit'][0] : 0;
        }
        else
        {
            $totalPerType = (array_key_exists('total_per_unit', $summaryPage) && isset($summaryPage['total_per_unit'][$billColumnSettingId])) ? $summaryPage['total_per_unit'][$billColumnSettingId] * $billColumnSettingQty : 0;
        }
    ...
    <tr style="border-bottom: 1px solid black;">
        ...
        <?php
            if(array_key_exists('total_per_unit', $summaryPage))
            {
            ...
            {
                $totalPerUnit = number_format(0, $priceFormatting[2], $priceFormatting[0], $priceFormatting[1]);
            }
        ?>
