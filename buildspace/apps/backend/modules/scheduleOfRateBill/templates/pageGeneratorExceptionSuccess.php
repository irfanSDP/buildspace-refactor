...
<div class="container" xmlns="http://www.w3.org/1999/html" style="width:auto;margin:50px 100px 40px 100px;">
    ...
    <?php
        $headerClass = ($pageItem[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_TYPE] == ScheduleOfRateBillItem::TYPE_HEADER or $pageItem[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_TYPE] == ScheduleOfRateBillItem::TYPE_HEADER_N) ? 'bqHead'.$pageItem[sfBuildspaceBQPageGenerator::ROW_BILL_ITEM_LEVEL] : null
    ?>
    <tr>
    ...
    <?php $occupiedRowsIdx = 0; foreach($occupiedRows as $occupiedRowDesc):?>
        <tr class="<?php echo ($maxRows < $rowCount) ? 'error' : ''; ?>">
            ...
            <td class="bqDescriptionCell" style="padding-left:4px;">
                <?php
                    $preClass = ($billItem->type == ScheduleOfRateBillItem::TYPE_HEADER or $billItem->type == ScheduleOfRateBillItem::TYPE_HEADER_N) ? 'bqHead'.$billItem->level : 'description'
                ?>
