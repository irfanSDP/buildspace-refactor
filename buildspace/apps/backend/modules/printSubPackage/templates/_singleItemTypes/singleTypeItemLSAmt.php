    ...
    <td class="bqAmountCell">
        <?php echo ! empty($itemRow[0]) && ! $printNoPrice ? Utilities::displayScientific($amount[0], 20, array( 
                'decimal_places' => 0,
    ...
    <?php else: ?>
    <td class="bqAmountCell" style="<?php echo ! $closeGrid ? 'border-right: none;' : null; ?>"><?php echo ! empty($itemRow[0]) && ! $printNoPrice && $amount != 0 ? Utilities::displayScientific($amount, ($printAmountOnly) ? 20 : 11, array(
