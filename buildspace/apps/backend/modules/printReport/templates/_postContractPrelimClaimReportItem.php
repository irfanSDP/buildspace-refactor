<table cellpadding="0" cellspacing="0" class="mainTable">
    ...
    <tr>
        ...
        <td class="bqHeadCell" colspan="2"><?php echo "Initial"; ?></td>
        <td class="bqHeadCell" colspan="2"><?php echo "Recurring"; ?></td>
        <td class="bqHeadCell" colspan="2"><?php echo "Final"; ?></td>
    </tr>
    <tr>
    ...
    for($x=0; $x <= $maxRows; $x++):
        ...
        <tr>
            ...
            <?php else: ?>
                ...
                <td class="bqRateCell">
                    <?php echo ! $printNoPrice && $initial_percentage && $initial_percentage != 0 ? number_format($initial_percentage, 2).'%' : null ?>
                </td>
                <td class="bqRateCell">
                ...
                <td class="bqRateCell">
                    <?php echo ! $printNoPrice && $recurring_percentage && $recurring_percentage != 0 ? number_format($recurring_percentage, 2).'%' : null ?>
                </td>
                <td class="bqRateCell">
                ...
                <td class="bqRateCell">
                    <?php echo ! $printNoPrice && $final_percentage && $final_percentage != 0 ?  number_format($final_percentage, 2).'%' : null ?>
                </td>
                <td class="bqRateCell">
        ...
        <?php if($printGrandTotal) : ?>
            <tr>
                ...
                <td class="footerSumAmount">
                    <?php echo ($elementTotals && $elementTotals['initial-percentage'] != 0) ?  number_format($elementTotals['initial-percentage'], 2).'%' : null ;?>
                </td>
                <td class="footerSumAmount">
                ...
                <td class="footerSumAmount">
                    <?php echo ($elementTotals && $elementTotals['recurring-percentage'] != 0) ?  number_format($elementTotals['recurring-percentage'], 2).'%' : null ;?>
                </td>
                <td class="footerSumAmount">
                ...
                <td class="footerSumAmount">
                    <?php echo ($elementTotals && $elementTotals['final-percentage'] != 0) ?  number_format($elementTotals['final-percentage'], 2).'%' : null ;?>
                </td>
                <td class="footerSumAmount">
