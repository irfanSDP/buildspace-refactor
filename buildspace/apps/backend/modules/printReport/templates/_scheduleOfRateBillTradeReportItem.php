<table cellpadding="0" cellspacing="0" class="mainTable">
    ...
    <?php
        ...
        for($x=0; $x <= $maxRows; $x++):
            ...
            $rate = $itemRow ? $itemRow[sfBuildspaceScheduleOfRateTradeItemGenerator::ROW_BILL_ITEM_RATE] : null;
            
            $unit = $itemRow ? $itemRow[sfBuildspaceScheduleOfRateTradeItemGenerator::ROW_BILL_ITEM_UNIT] : null;

            $wastage = $itemRow ? $itemRow[sfBuildspaceScheduleOfRateTradeItemGenerator::ROW_BILL_ITEM_MARKUP] : null;

            $totalQty = $itemRow ? $itemRow[sfBuildspaceScheduleOfRateTradeItemGenerator::ROW_BILL_ITEM_TOTAL_QTY] : null;

            $totalCost = $itemRow ? $itemRow[sfBuildspaceScheduleOfRateTradeItemGenerator::ROW_BILL_ITEM_TOTAL_COST] : null;
            ...
            elseif($itemRow and $itemRow[4] == sfBuildspaceScheduleOfRateTradeItemGenerator::ROW_TYPE_ELEMENT)
            {
            ...
            if ( $indentItem AND $itemRow AND ($itemRow[4] != sfBuildspaceScheduleOfRateTradeItemGenerator::ROW_TYPE_ELEMENT AND $itemRow[4] != ResourceItem::TYPE_HEADER) )
            {
                $itemPadding = 15;
            }
            else
