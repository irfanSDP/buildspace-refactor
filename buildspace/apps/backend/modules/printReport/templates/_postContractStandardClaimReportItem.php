<table cellpadding="0" cellspacing="0" class="mainTable">
    ...
    <tr>
        ...
        <td class="bqHeadCell" rowspan="2" style="min-width:90px;width:90px;"><?php echo "Contract Amount"; ?></td>
    ...
    <?php
        ...
        for($x=0; $x <= $maxRows; $x++):
            ...
            $prev_percentage = $itemRow ? $itemRow[sfBuildspacePostContractReportPageItemGenerator::ROW_CLAIM_PREVIOUS]['prev_percentage'] : null;
            $prev_amount     = $itemRow ? $itemRow[sfBuildspacePostContractReportPageItemGenerator::ROW_CLAIM_PREVIOUS]['prev_amount'] : null;

            $current_percentage = $itemRow ? $itemRow[sfBuildspacePostContractReportPageItemGenerator::ROW_CLAIM_CURRENT]['current_percentage'] : null;
            $current_amount     = $itemRow ? $itemRow[sfBuildspacePostContractReportPageItemGenerator::ROW_CLAIM_CURRENT]['current_amount'] : null;
        ...
        <?php if($printGrandTotal) : ?>
            <tr>
                ...
                <td class="footerSumAmount">
                    <?php echo ($elementTotals && array_key_exists('prev_percentage', $elementTotals) && $elementTotals['prev_percentage'] != 0) ?  number_format($elementTotals['prev_percentage'],2).'%' : null ;?>
                </td>
                <td class="footerSumAmount">
                    <?php echo ($elementTotals && array_key_exists('prev_amount', $elementTotals) && $elementTotals['prev_amount'] != 0) ?  number_format($elementTotals['prev_amount'], $priceFormatting[2], $priceFormatting[0], ($rateCommaRemove) ? '' : $priceFormatting[1]) : null ;?>
                </td>
                <td class="footerSumAmount">
                ...
                <td class="footerSumAmount">
                    <?php echo ($elementTotals && array_key_exists('current_percentage', $elementTotals) && $elementTotals['current_percentage'] != 0) ?  number_format($elementTotals['current_percentage'],2).'%' : null ;?>
                </td>
                <td class="footerSumAmount">
                    <?php echo ($elementTotals && array_key_exists('current_amount', $elementTotals) && $elementTotals['current_amount'] != 0) ?  number_format($elementTotals['current_amount'], $priceFormatting[2], $priceFormatting[0], ($rateCommaRemove) ? '' : $priceFormatting[1]) : null ;?>
                </td>
            </tr>
            <tr>
