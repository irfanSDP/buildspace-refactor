...
class ErrorCodes
{
    ...
    final public static function defaultGetAllErrorCodeTitles()
    {
        return array(
            ...
            'ACCOUNTBLOCKED' => \SimpleSAML\Locale\Translate::noop('{errors:title_ACCOUNTBLOCKED}'),
        );
    }
    ...
    final public static function defaultGetAllErrorCodeDescriptions()
    {
        return array(
            ...
            'ACCOUNTBLOCKED' => \SimpleSAML\Locale\Translate::noop('{errors:descr_ACCOUNTBLOCKED}'),
        );
    }
