...
$config = array(
    ...
    'buildspace-sp' => array(
        'saml:SP',
        'entityID' => 'https://' . getenv('SAMLAUTH_HOST'),
        'idp' => 'https://' . getenv('SAMLAUTH_HOST') . '/saml2/idp/metadata.php',
        'ssoPortalUrl' => 'https://' . getenv('SAMLAUTH_HOST') . '/saml2/idp/SSOService.php',
        'discoURL' => null
    ),

    'global-pck' => array(
        'buildspace:Auth',
        'dsn' => 'pgsql:host=' . getenv('EPROJECT_DB_HOST') . ';dbname=' . getenv('EPROJECT_DB_DATABASE'),
        'username' => getenv('EPROJECT_DB_USERNAME'),
        'password' => getenv('EPROJECT_DB_PASSWORD'),
    ),
