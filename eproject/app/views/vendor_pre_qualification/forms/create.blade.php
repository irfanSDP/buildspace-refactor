    ...
    <div class="row">
        <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
            <h1 class="page-title txt-color-blueDark">
                <i class="fa fa-address-card"></i> {{{ trans('forms.create') }}}
            </h1>
        </div>
    </div>
            ...
            <div class="jarviswidget ">
                ...
                <div>
                    <div class="widget-body">
                        {{ Form::open(array('route' => array('vendorPreQualification.formLibrary.form.store', $vendorGroup->id, $vendorWorkCategory->id), 'class' => 'smart-form')) }}
                            <div class="row">
