    ...
    <script>
        $(document).ready(function () {
            var mainTable = new Tabulator('#main-table', {
                ...
                ajaxURL: "{{ route('vendorPreQualification.formLibrary.form.node.children', [$vendorGroup->id, $vendorWorkCategory->id, $parentNode->id]) }}",
                layout:"fitColumns",
                columns:[
                    ...
                    {title:"{{ trans('vendorPreQualification.name') }}", field:"name", minWidth: 300, hozAlign:"left", headerSort:false, formatter:function(cell){
                        ...
                        else if(cell.getData()['descendent_amendments_required']){
            ...
            $("#node-form").on('submit', function(e){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('vendorPreQualification.formLibrary.form.node.storeOrUpdate', [$vendorGroup->id, $vendorWorkCategory->id, $parentNode->id])}}",
                    data: dataStr,
