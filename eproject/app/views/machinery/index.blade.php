...
<div class="row">
    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-lg fa-truck-pickup"></i></i>&nbsp;&nbsp;Machinery
        </h1>
    </div>
    ...
    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
    	<a href="{{ route('machinery.create')}}">
	        <button id="createDefect" class="btn btn-primary btn-md pull-right header-btn">
	            <i class="fa fa-plus"></i> Create Machinery Record
	        </button>
        </a>
    </div>
</div>
                        ...
                        <table class="table table-hover" id="dt_basic">
                            <thead>
                                <tr>
                                    ...
                                    <th class="hasinput">
                                        <input type="text" class="form-control" placeholder="Filter machinery" />
                                    </th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                <?php
                                    $count = 0;
                                ?>
                                @foreach ($machinery as $machinery)
                                    <tr>
                                        <td class="text-center text-middle">
                                            {{{++$count}}}
                                        </td>
                                        <td>
                                           <a href="{{{ route('machinery.edit', array($machinery->id))}}}">
                                           	    {{{$machinery->name}}}
                                           </a>
                                            <a href="{{{ route('machinery.delete', array($machinery->id)) }}}"
