<header>
	...
	<h2>{{{ PCK\Forms\AEMessageFirstLevelArchitectForm::formTitle }}}</h2>
</header>
	...
	<div class="widget-body no-padding">
		{{ Form::open(array('class' => 'smart-form')) }}
			<fieldset>
				...
				<section>
					<label class="label">Decision for Contractor's Notice of Intention to Claim AE<span class="required">*</span>:</label>
