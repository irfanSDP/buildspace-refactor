...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li>{{{trans('rejected_materials.add_rejected_material')}}}</li>
    </ol>
...
@section('content')
 ...
 <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        {{ Form::open(array('route' => array('rejected-materials.store'))) }}
        ...
        {{ Form::submit(trans('rejected_materials.create'), array('class' => 'btn btn-primary')) }}
