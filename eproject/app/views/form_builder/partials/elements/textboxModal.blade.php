<?php $modalId = isset($modalId) ? $modalId : 'textboxModal'; ?>
<?php $isNumberTextbox = isset($isNumberTextbox) ? $isNumberTextbox : false; ?>
            ...
            <div class="modal-body">
                <form class="smart-form" data-control="form_body">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <section class="col col-6">
                                <label class="label">{{ trans('formBuilder.minValue') }}</label>
                                <label class="input">
                                    <input type="number" name="min">
                                </label>
                            </section>
                            <section class="col col-6">
                                <label class="label">{{ trans('formBuilder.maxValue') }}</label>
                                <label class="input">
