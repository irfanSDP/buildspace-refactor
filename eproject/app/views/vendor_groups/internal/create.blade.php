...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li>{{ link_to_route('vendorGroups.internal.index', trans('contractGroupCategories.internalVendorGroups')) }}</li>
        <li>@if(isset($contractGroupCategory)) {{{ trans('forms.edit') }}} {{{ $contractGroupCategory->name }}} @else {{{ trans('forms.add') }}} {{{ trans('contractGroupCategories.internalVendorGroups') }}} @endif</li>
    </ol>
@endsection
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget ">
            <header>
                <h2>@if(isset($contractGroupCategory)) {{{ trans('forms.edit') }}} {{{ $contractGroupCategory->name }}} @else {{{ trans('forms.add') }}} {{{ trans('contractGroupCategories.internalVendorGroups') }}} @endif</h2>
            </header>
            <div>
                <div class="widget-body">
                    {{ Form::open(array('route' => array('vendorGroups.internal.store'), 'class' => 'smart-form')) }}
                        <input type="hidden" name="vendor_type" value="{{ ContractGroupCategory::TYPE_INTERNAL }}" />
                        <div class="row">
                        ...
                        <footer>
                            ...
                            {{ link_to_route('vendorGroups.internal.index', trans('forms.back'), array(), array('class' => 'btn btn-default')) }}
