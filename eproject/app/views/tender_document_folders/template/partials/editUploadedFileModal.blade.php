<div class="modal fade" id="editUploadedFileModal">
    <div class="modal-dialog">
        <div class="modal-content" style="width:510px;">
            ...
            {{ Form::open(array('route' => array('tender_documents.template.uploadUpdate') , 'id' => 'editDocumentForm')) }}
            <div class="modal-body no-padding">
                <div class="smart-form form-inline">
                    <fieldset>
                        ...
                        <section>
                            <label class="label">{{ trans('documentManagementFolders.workCategory') }}:</label>
                            <label class="fill-horizontal {{{ $errors->has('work_category_id') ? 'state-error' : null }}}">
                                {{ Form::select('work_category_id', $workCategories, Input::old('work_category_id'), ['id' => 'editDocumentForm-work_category', 'class' => 'select2 fill-horizontal'])}}
                            </label>
