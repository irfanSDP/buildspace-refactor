...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li>{{{trans('openTenderNews.create_news')}}}</li>
    </ol>
...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="jarviswidget">
			<header>
				<h2>{{ trans('openTenderNews.add_news') }}</h2>
			</header>
			<div>
				<div class="widget-body no-padding">
                    {{ Form::open(['route' => 'open_tender_news.store', 'class' => 'smart-form', 'id' => 'add-form', 'files' => true]) }}
