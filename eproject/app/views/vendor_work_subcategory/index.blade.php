...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
        <a href="{{ route('vendorWorkSubcategories.create', array($vendorWorkCategory->id)) }}" class="btn btn-primary btn-md pull-right header-btn">
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget ">
            <header>
                <h2> {{{ trans('contractGroupCategories.vendorWorkSubcategories') }}} </h2>
            </header>
            <div>
                <div class="widget-body">
                    <div id="vendor-work-subcategories-table"></div>
                    {{ Form::open(array('route' => array('vendorWorkSubcategories.hide', $vendorWorkCategory->id))) }}
...
@section('js')
    <script>
        $(document).ready(function () {
            var vendorWorkSubcategoriesTable = new Tabulator('#vendor-work-subcategories-table', {
                height:450,
                placeholder: "{{ trans('general.noRecordsFound') }}",
                ajaxURL: "{{ route('vendorWorkSubcategories.ajax.list', [$vendorWorkCategory->id]) }}",
                ajaxConfig: "GET",
                paginationSize: 100,
                pagination: "remote",
                ajaxFiltering:true,
                        ...
                        innerHtml: [
                            {
                                ...
                                tag: 'a',
                                attributes: {class:'btn btn-xs btn-danger', title: '{{ trans("general.reassign") }}'},
                                rowAttributes: {'href': 'route:reassign'},
                                innerHtml: {
                                    tag: 'i',
            ...
            $('#vendor-work-subcategories-table').on('click', 'input[data-action=hide]', function(){
