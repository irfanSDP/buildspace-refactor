        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group col-12">
                    ...
                    <input id="template-name-input" class="form-control date_picker" readonly/>
                    <em id="template-name-error" style="color:#F00;"></em>
                </div>
                <div class="form-group col-12">
                    <label class="control-label">Description:</label>
                    <textarea id="description-input" class="form-control" rows="5"></textarea>
                    <em id="description-error" style="color:#F00;"></em>
                </div>
            </div>
