<?php $modalId = isset($modalId) ? $modalId : 'warningModal' ?>
<?php $message = isset($message) ? $message : '' ?>
<?php $warningMessageId = isset($warningMessageId) ? $warningMessageId : 'warningMessageId'; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="margin: 0 20px;">
                <div class="row">
                    <p id="{{ $warningMessageId }}" class="well">
                        {{{ $message }}}
                    </p>
