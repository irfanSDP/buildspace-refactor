...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li>{{{ trans('general.developmentTypes') }}}</li>
    </ol>
@endsection
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
        <a href="{{ route('consultant.management.maintenance.development.type.create') }}" class="btn btn-primary btn-md pull-right header-btn">
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget ">
            <header>
                <h2> {{{ trans('general.developmentTypes') }}} </h2>
            </header>
            <div>
                <div class="widget-body no-padding">
                    <div id="development-types-table"></div>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function () {
    var developmentTypeTable = new Tabulator('#development-types-table', {
        height:450,
        placeholder: "{{ trans('general.noRecordsFound') }}",
        ajaxURL: "{{ route('consultant.management.maintenance.development.type.ajax.list') }}",
        ajaxConfig: "GET",
        paginationSize: 100,
        pagination: "remote",
        ajaxFiltering:true,
        ...
        columns:[
            ...
            {title:"{{ trans('general.productTypes') }}", field:"product_types", minWidth: 300, hozAlign:"left", headerSort:false, headerFilter:"input", headerFilterPlaceholder: "{{ trans('general.filter') }}", formatter:app_tabulator_utilities.variableHtmlFormatter, formatterParams: {
                innerHtml: function(rowData){
                    var c = '<div class="well">';
                    if(rowData.product_types.length){
                        c+='<p>'+rowData.product_types.join(', ')+'</p>';
                    }
                    c+='</div>';
                    return c;
                }
