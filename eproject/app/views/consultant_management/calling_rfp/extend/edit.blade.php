...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-clock"></i> {{{ trans('forms.extend') }}} {{{ trans('general.callingRFP') }}} {{{trans('documentManagementFolders.revision')}}} {{$callingRfp->consultantManagementRfpRevision->revision}}
        </h1>
    </div>
</div>
        ...
        <div class="jarviswidget ">
            ...
            <div>
                <div class="widget-body">
                    {{ Form::open(['route' => ['consultant.management.calling.rfp.extend.store', $vendorCategoryRfp->id], 'class' => 'smart-form']) }}
                    <div class="row">
                        <section class="col col-xs-4 col-md-4 col-lg-4">
                            ...
                            <label class="input {{{ $errors->has('calling_rfp_date') ? 'state-error' : null }}}">
                                <?php
                                $date = Input::old('calling_rfp_date', $consultantManagementContract->getContractTimeZoneTime($callingRfp->calling_rfp_date));
                        ...
                        <section class="col col-xs-4 col-md-4 col-lg-4">
                            ...
                            <?php
                                $date = Input::old('closing_rfp_date', $consultantManagementContract->getContractTimeZoneTime($callingRfp->closing_rfp_date));
