...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        @else
        <li>{{ link_to_route('consultant.management.consultant.questionnaire.rfp.show', trans('general.questionnaire'), [$vendorCategoryRfp->id, $company->id, $questionnaire->id]) }}</li>
        ...
        <div class="jarviswidget ">
            ...
            <div>
                <div class="widget-body">
                    {{ Form::open(['route' => ['consultant.management.consultant.questionnaire.rfp.store', $vendorCategoryRfp->id], 'class' => 'smart-form']) }}
                    <div class="row">
                    ...
                    ?>
                    <div id="questionnaire-options" @if( $selectedType == PCK\ConsultantManagement\ConsultantManagementRfpQuestionnaire::TYPE_MULTI_SELECT or $selectedType == PCK\ConsultantManagement\ConsultantManagementRfpQuestionnaire::TYPE_SINGLE_SELECT)  @else style="display:none;" @endif>
                        <hr class="simple">
                        <div class="row">
                    ...
                    <footer>
                        ...
                        {{ Form::hidden('vcrid', $vendorCategoryRfp->id) }}
                        ...
                        @else
                        {{ link_to_route('consultant.management.consultant.questionnaire.rfp.show', trans('forms.back'), [$vendorCategoryRfp->id, $company->id, $questionnaire->id], ['class' => 'btn btn-default']) }}
                        @endif
...
$(document).ready(function () {
    ...
    $('#type-select').on('change',function(e){
        e.preventDefault();
        if(parseInt($(this).val()) == {{PCK\ConsultantManagement\ConsultantManagementRfpQuestionnaire::TYPE_MULTI_SELECT}} || parseInt($(this).val()) == {{PCK\ConsultantManagement\ConsultantManagementRfpQuestionnaire::TYPE_SINGLE_SELECT}}){
