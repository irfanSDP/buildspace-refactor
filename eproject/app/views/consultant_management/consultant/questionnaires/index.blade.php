...
<ol class="breadcrumb">
    ...
    <li>{{{ trans('general.consultantManagement') }}} {{{ trans('general.questionnaires') }}}</li>
</ol>
@endsection
...
$(document).ready(function () {
    new Tabulator('#questionnaires-table', {
        ...
        ajaxURL: "{{ route('consultant.management.consultant.rfp.questionnaire.ajax.list') }}",
        ajaxConfig: "GET",
        paginationSize: 100,
        pagination: "remote",
        ajaxFiltering:true,
        ...
        columns:[
            ...
            {title:"RFP {{ trans('tenders.closingDate') }}", field:"closing_date", width:160, hozAlign:'center', cssClass:"text-center text-middle", headerSort:false},
