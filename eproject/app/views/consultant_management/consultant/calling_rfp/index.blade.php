...
<ol class="breadcrumb">
    ...
    <li>{{{ trans('general.consultantManagement') }}} {{{ trans('general.callingRFP') }}}</li>
</ol>
@endsection
...
<div class="row">
    <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-table"></i> {{{ trans('general.callingRFP') }}}
        </h1>
    </div>
</div>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget ">
            <header>
                <h2> {{{ trans('general.callingRFP') }}} </h2>
            </header>
            <div>
...
$(document).ready(function () {
    new Tabulator('#rfp-table', {
        ...
        ajaxURL: "{{ route('consultant.management.consultant.calling.rfp.ajax.list') }}",
        ajaxConfig: "GET",
        paginationSize: 100,
        pagination: "remote",
        ajaxFiltering:true,
