...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-user-tie"></i> {{{ trans('general.openRFP') }}} {{{ trans('verifiers.verifiers') }}}
        </h1>
    </div>
</div>
        ...
        <div class="jarviswidget ">
            <div>
                <div class="widget-body">
                    ...
                    {{ Form::open(['route' => ['consultant.management.open.rfp.verifier.update', $vendorCategoryRfp->id], 'class' => 'smart-form']) }}
                    <div class="row">
...
$(document).ready(function () {
    var verifierLogTable = new Tabulator('#verifier_logs-table', {
        ...
        ajaxURL: "{{ route('consultant.management.open.rfp.verifier.ajax.log', [$vendorCategoryRfp->id, $openRfp->id]) }}",
        ajaxConfig: "GET",
        paginationSize: 100,
        pagination: "remote",
        ajaxFiltering:true,
