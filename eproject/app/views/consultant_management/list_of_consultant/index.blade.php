...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-th-list"></i> {{{ trans('general.listOfConsultant') }}}
        </h1>
    </div>
</div>
        ...
        <div class="jarviswidget ">
            <div>
                <div class="widget-body no-padding">
                    <div id="list_of_consultant-table"></div>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function () {
    ...
    var listOfConsultantTable = new Tabulator('#list_of_consultant-table', {
        fillHeight:true,
        placeholder: "{{ trans('general.noRecordsFound') }}",
        ajaxURL: "{{ route('consultant.management.loc.ajax.list', $vendorCategoryRfp->id) }}",
        ajaxConfig: "GET",
        paginationSize: 100,
        pagination: "remote",
        ajaxFiltering:true,
