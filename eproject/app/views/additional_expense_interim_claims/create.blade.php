		...
		<article class="col-sm-12 col-md-12 col-lg-8">
			...
			<div class="jarviswidget">
				<header>
					...
					<h2>{{{ PCK\Forms\AdditionalExpenseInterimClaimForm::formTitle }}}</h2>
				</header>
				...
				<div>
					...
					<div class="widget-body no-padding">
						{{ Form::open(array('class' => 'smart-form')) }}
							<fieldset>
								<section>
									<label class="label">The Additional Expense has been paid in the following Interim Certificate<span class="required">*</span>:</label>
