<ul id="announcement_email-tabs" class="nav nav-tabs bordered">
    <li class="active">
        <a href="#announcement_email_content-tab" data-toggle="tab">{{{ trans('email.contents') }}}
            <em class="invalid" id="email_announcement-subject" style="display:none;font-size:11px;color:#D56161;">&nbsp;</em>
            <em class="invalid" id="email_announcement-message" style="display:none;font-size:11px;color:#D56161;">&nbsp;</em>
        </a>
    </li>
    <li>
        <a href="#announcement_email_recipients-tab" data-toggle="tab">{{{ trans('email.recipientGroupPlaceholder') }}} <em class="invalid" id="email_announcement-input-to_viewer" style="display:none;font-size:11px;color:#D56161;">&nbsp;</em></a>
    </li>
</ul>
<div id="announcement_email-tab-content" class="tab-content no-padding smart-form">
    <div class="tab-pane fade in active" id="announcement_email_content-tab">
        <fieldset>
            <section>
                ...
                <em class="invalid" id="email_announcement-input-subject" style="display:none;font-size:11px;color:#D56161;">&nbsp;</em>
            </section>

            <section>
                <label class="label">{{ trans('messaging.message') }}<span class="required">*</span>:</label>
                <label class="textarea">
                    {{ Form::textarea('message', Input::old('message'), array('rows' => 3)) }}
                </label>
                <em class="invalid" id="email_announcement-input-message" style="display:none;font-size:11px;color:#D56161;">&nbsp;</em>
            </section>
    ...
    <div class="tab-pane fade in" id="announcement_email_recipients-tab">
        @include('form_partials.select_contract_group_categories', array(
            'groups' => $groups,
            'hideLabel' => true,
...
$(document).ready(function() {
    ...
    $('#fileupload-' + '{{{ $formId }}}').fileupload({
        url: '{{ route("generalUploads.upload") }}',
