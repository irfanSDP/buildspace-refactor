...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li>{{ trans('vendorManagement.companyPersonnelSettings') }}</li>
    </ol>
@endsection
...
<div class="row">
    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-building"></i> {{ trans('vendorManagement.companyPersonnelSettings') }}
        </h1>
    </div>
</div>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget" data-widget-editbutton="false" data-widget-custombutton="false">
            <header>
                <h2>{{{ trans('vendorManagement.companyPersonnelSettings') }}}</h2>				
            </header>
            <div>
                <div class="widget-body">
                    <form class="smart-form" action="{{ route('company.personnel.settings.update') }}" method="POST">
