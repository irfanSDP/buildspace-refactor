...
@section('breadcrumb')
    ...
    <li>{{ link_to_route('projects.index', trans('navigation/mainnav.home'), array()) }}</li>
        ...
        <li>{{ link_to_route('vendorManagement.approval.companyPersonnel', trans('vendorManagement.companyPersonnel'), array($vendorRegistration->id)) }}</li>
        ...
        <div class="jarviswidget ">
            ...
            <div>
                <div class="widget-body">
                    {{ Form::model($companyPersonnel, array('route' => array('vendorManagement.approval.companyPersonnel.update', $companyPersonnel->id), 'class' => 'smart-form')) }}
                        <div class="row">
                        ...
                        <footer>
                            {{ link_to_route('vendorManagement.approval.companyPersonnel', trans('forms.back'), array($vendorRegistration->id), array('class' => 'btn btn-default')) }}
