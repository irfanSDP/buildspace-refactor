...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li>{{ link_to_route('vendorManagement.approval.preQualification', trans('vendorManagement.preQualification'), array($vendorRegistration->id)) }}</li>
        <li>{{{ $form->name }}}</li>
    </ol>
@endsection
        ...
        <div class="jarviswidget ">
            ...
            <div>
                <div class="widget-body">
                    {{ Form::open(array('route' => array('vendorManagement.approval.vendorPreQualification.formUpdate', $vendorRegistration->id, $vendorPreQualification->id, $form->id), 'id' => 'scores-form')) }}
    ...
    <script>
        $(document).ready(function () {
            ...
            function updateScore()
            {
                ...
                $.ajax({
                    url: "{{{ route('vendorPreQualification.live.score.get', [$vendorRegistration->id, $vendorPreQualification->id]) }}}",
                    method: 'GET',
                    data: {
                    ...
                    success: function (response) {
                        $('#totalSelectedScore').text(response.vpqScore);
                    },
            ...
            $('#main-table').on('change', '[data-action=exclude-node]', function(){
                var row = getNestedRow(mainTable, $(this).data('id'));
                if($(this).prop('checked'))
                {
                    row.treeCollapse();
