...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li>{{ link_to_route('vendorManagement.approval.supplierCreditFacilities', trans('vendorManagement.supplierCreditFacilities'), array($vendorRegistration->id)) }}</li>
        ...
        <div class="jarviswidget ">
            ...
            <div>
                <div class="widget-body">
                    {{ Form::model($supplierCreditFacility, array('route' => array('vendorManagement.approval.supplierCreditFacilities.update', $supplierCreditFacility->id), 'class' => 'smart-form')) }}
                        <div class="row">
                        ...
                        @endif
                        <footer>
                            {{ link_to_route('vendorManagement.approval.supplierCreditFacilities', trans('forms.back'), array($vendorRegistration->id), array('class' => 'btn btn-default')) }}
