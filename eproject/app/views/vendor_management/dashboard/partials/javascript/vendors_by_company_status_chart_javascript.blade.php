<script>
    var vendorsByCompanyStatusChart = new ApexCharts(document.querySelector("#vendorsByCompanyStatusChart"), {
        series: [],
        labels: [],
        chart: {
            width: 500,
    ...
    vendorsByCompanyStatusChart.render();
    ...
    renderVendorsByCompanyStatusChart(formInputs, 'vendorsByCompanyStatus');

    function renderVendorsByCompanyStatusChart(data, identifier) {
        ...
        $.ajax({
            ...
            success: function(response){
                vendorsByCompanyStatusChart.updateOptions({
