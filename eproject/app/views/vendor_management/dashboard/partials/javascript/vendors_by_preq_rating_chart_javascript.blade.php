<script>
    var vendorsByPreqRatingChart = new ApexCharts(document.querySelector("#vendorsByPreqRatingChart"), {
        series: [],
        labels: [],
        chart: {
            width: 500,
    ...
    vendorsByPreqRatingChart.render();
    ...
    renderVendorsByPreqRatingChart(formInputs, 'vendorsByPreqRating');

    function renderVendorsByPreqRatingChart(data, identifier) {
        ...
        $.ajax({
            ...
            success: function(response){
                vendorsByPreqRatingChart.updateOptions({
