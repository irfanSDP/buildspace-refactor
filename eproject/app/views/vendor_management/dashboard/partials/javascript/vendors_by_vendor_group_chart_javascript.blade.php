<script>
    var vendorsByVendorGroupChart = new ApexCharts(document.querySelector("#vendorsByVendorGroupChart"), {
        series: [],
        labels: [],
        chart: {
            width: 500,
    ...
    vendorsByVendorGroupChart.render();
    ...
    renderVendorsByVendorGroupChart(formInputs, 'vendorsByVendorGroup');

    function renderVendorsByVendorGroupChart(data, identifier) {
        ...
        $.ajax({
            ...
            success: function(response){
                vendorsByVendorGroupChart.updateOptions({
