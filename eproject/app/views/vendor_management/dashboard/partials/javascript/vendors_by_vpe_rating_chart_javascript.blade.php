<script>
    var vendorsByVpeRatingChart = new ApexCharts(document.querySelector("#vendorsByVpeRatingChart"), {
        series: [],
        labels: [],
        chart: {
            width: 500,
    ...
    vendorsByVpeRatingChart.render();
    ...
    renderVendorsByVpeRatingChart(formInputs, 'vendorsByVpeRating');

    function renderVendorsByVpeRatingChart(data, identifier) {
        ...
        $.ajax({
            ...
            success: function(response){
                vendorsByVpeRatingChart.updateOptions({
