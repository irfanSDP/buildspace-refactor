<script>
    var vendorsByCountryChart = new ApexCharts(document.querySelector("#vendorsByCountryChart"), {
        series: [],
        labels: [],
        chart: {
            width: '100%',
    ...
    renderVendorsByCountryChart(formInputs, 'vendorsByCountry');

    function renderVendorsByCountryChart(data, identifier) {
        ...
        $.ajax({
            ...
            success: function(response){
                vendorsByCountryChart.updateOptions({
