...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li>{{ link_to_route('vendors.vendorRegistration.projectTrackRecord', trans('vendorManagement.projectTrackRecord'), array()) }}</li>
            ...
            <div class="jarviswidget ">
                ...
                <div>
                    <div class="widget-body">
                        {{ Form::open(array('route' => array('vendors.vendorRegistration.projectTrackRecord.store'), 'class' => 'smart-form', 'id' => 'project-track-record-form')) }}
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <section class="col col-xs-12 col-md-4 col-lg-4">
                                    ...
                                    <label class="fill-horizontal {{{ $errors->has('vendor_work_category_id') ? 'state-error' : null }}}">
                                        <select class="fill-horizontal select2" name="vendor_work_category_id" style="width:100%;">
                            ...
                            <div class="row">
                                <section class="col col-xs-12 col-md-4 col-lg-4">
                                    ...
                                    <label class="input {{{ $errors->has('project_amount') ? 'state-error' : null }}}">
                                        {{ Form::number('project_amount', Input::old('project_amount') ?? 0, array('required' => 'required', 'step' => 0.01)) }}
                                    </label>
                            ...
                            <div class="row">
                                <section class="col col-xs-12 col-md-4 col-lg-4">
                                    ...
                                    <label class="input {{{ $errors->has('year_of_site_possession') ? 'state-error' : null }}}">
                                        {{ Form::text('year_of_site_possession', Input::old('year_of_site_possession'), array('class' => 'datetimepicker', 'required' => 'required')) }}
                                    </label>
                                ...
                                <section class="col col-xs-12 col-md-4 col-lg-4">
                                    ...
                                    <label class="input {{{ $errors->has('year_of_completion') ? 'state-error' : null }}}">
                                        {{ Form::text('year_of_completion', Input::old('year_of_completion'), array('class' => 'datetimepicker', 'required' => 'required')) }}
                                    </label>
                            ...
                            @endif
                            <footer>
                                {{ link_to_route('vendors.vendorRegistration.projectTrackRecord', trans('forms.back'), array(), array('class' => 'btn btn-default')) }}
                                {{ Form::button('<i class="fa fa-save"></i> '.trans('forms.save'), ['type' => 'submit', 'class' => 'btn btn-primary', 'id' => 'save-button'] )  }}
                            </footer>
                        {{ Form::close() }}
                    </div>
                </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#project-track-record-form').on('submit', function () {
                $('#save-button').prop('disabled', true); // Disable the button
            });
            ...
            function initVendorCategorySelect() {
                <?php $firstVendorCategoryId = $vendorCategorySelections[0]->id; ?>
                $('[name="vendor_category_id"]').val("{{ $firstVendorCategoryId }}").trigger('change');
            }

            initVendorCategorySelect();

            $('select[name=country_id]').val("{{ Input::old('country_id') ?? $defaultCountryId }}").trigger("change");
        });
    </script>
@endsection('js')