<div>
	<h4 role="tab" aria-selected="false" id="{{{ str_replace('%id%', $message->id, PCK\Forms\EOTMessageThirdLevelArchitectForm::accordianId) }}}">
		<span class="ui-accordion-header-icon ui-icon fa fa-plus"></span>

		{{{ PCK\Forms\EOTMessageThirdLevelArchitectForm::formTitle }}}
	</h4>
	...
	<div class="padding-10 ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom" role="tabpanel" aria-expanded="false" aria-hidden="true" style="display: none;">
		...
		<p>
			...
			{{{ $eot->project->getProjectTimeZoneTime($message->deadline_to_comply_with) }}}
		</p>
