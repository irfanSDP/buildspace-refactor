        ...
        <div role="content">
            <div class="widget-body">
                ...
                <div class="widget-body no-padding">
                    {{ Form::open(array('class'=>'smart-form','id'=>'weather-form','route' => array('site-management-site-diary-weather.create', $project->id, $siteDiaryId),'files' => true)) }}
                                ...
                                <select name="weather_id" id="weather_id" class="form-control">
                                    <option selected disabled>Select</option>                   
                                        @foreach($weathers as $weather)
                                            @if(Input::old('weather_id') == $weather->id)
                    ...
                    <footer>
                        ...
                        {{ Form::button('<i class="fa fa-save"></i> '.trans('siteManagementDefect.submit'), ['type' => 'submit', 'class' => 'btn btn-primary', 'name' => 'Submit', 'id' => 'weather'] )  }}
                    </footer>
                    {{ Form::close() }}
                </div>
            </div>
