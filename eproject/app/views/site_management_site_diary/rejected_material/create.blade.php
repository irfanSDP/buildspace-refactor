        ...
        <div role="content">
            <div class="widget-body">
                ...
                <div class="widget-body no-padding">
                    {{ Form::open(array('class'=>'smart-form','id'=>'rejected-material-form','route' => array('site-management-site-diary-rejected_material.create', $project->id, $siteDiaryId),'files' => true)) }}
                                ...
                                <select name="rejected_material_id" id="rejected_material_id" class="form-control">
                                    <option selected disabled>Select</option>                   
                                        @foreach($rejected_materials as $rejected_material)
                                            @if(Input::old('rejected_material_id') == $rejected_material->id)
