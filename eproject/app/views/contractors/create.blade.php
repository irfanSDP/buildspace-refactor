    ...
    <div class="row">
        <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
            <h1 class="page-title txt-color-blueDark">
                <i class="fa fa-edit"></i> {{ trans('companies.contractorDetails') }}
            </h1>
        </div>
    </div>
            ...
            <div class="jarviswidget">
                ...
                <div>
                    <div class="widget-body no-padding">
                        ...
                        {{ Form::open(array('class' => 'smart-form', 'id' => 'contractor-form')) }}
...
@section('js')
    ...
    <script>
        $(document).on('click', '#store-default-contractor', function() {
            $.ajax({
                url: '{{ route('companies.contractors.storeDefault', array($company_id)) }}',
                method: 'POST',
                data: {
                    _token: '{{{ csrf_token() }}}'
                },
