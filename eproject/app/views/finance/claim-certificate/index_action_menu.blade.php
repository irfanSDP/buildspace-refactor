<div class="dropdown {{{ $classes ?? 'pull-right' }}}">
    ...
    <ul data-type="action-button-menu-list" class="dropdown-menu" role="menu">
	    <li>
	    	<a href="{{ route('finance.claim-certificate.projects') }}" class="btn btn-block btn-md btn-info">
	    		<i class="fas fa-list"></i> {{ trans('finance.claimCertificatesReport') }}
	    	</a>
	    </li>
		<li class="divider"></li>
		<li>
	    	<a href="{{ route('finance.account.code.settings.index') }}" class="btn btn-block btn-md btn-warning">
