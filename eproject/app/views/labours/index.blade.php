...
<div class="row">
    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-lg fa-users"></i></i>&nbsp;&nbsp;Labours
        </h1>
    </div>

    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
    	<a href="{{ route('labours.create')}}">
	        <button id="createDefect" class="btn btn-primary btn-md pull-right header-btn">
	            <i class="fa fa-plus"></i> Create Labour Record
	        </button>
        </a>
    </div>
</div>
                        ...
                        <table class="table table-hover" id="dt_basic">
                            <thead>
                                <tr>
                                    ...
                                    <th class="hasinput">
                                        <input type="text" class="form-control" placeholder="Filter labours" />
                                    </th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                ...
                                @foreach ($labours as $labour)
                                    <tr>
                                        ...
                                        <td>
                                           <a href="{{{ route('labours.edit', array($labour->id))}}}">
                                           	    {{{$labour->name}}}
                                           </a>
                                            <a href="{{{ route('labours.delete', array($labour->id)) }}}"
