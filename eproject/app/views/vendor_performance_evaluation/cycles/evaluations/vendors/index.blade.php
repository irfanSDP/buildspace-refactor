...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li>{{ link_to_route('vendorPerformanceEvaluation.cycles.evaluations.index', trans('vendorManagement.projects'), array($evaluation->vendor_performance_evaluation_cycle_id)) }}</li>
