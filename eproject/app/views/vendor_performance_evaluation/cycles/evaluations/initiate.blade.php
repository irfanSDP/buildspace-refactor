...
<div class="row">
    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-users"></i> {{{ trans('vendorManagement.initiate') }}}
        </h1>
    </div>
</div>
        ...
        <div class="jarviswidget ">
            ...
            <div>
                <div class="widget-body">
                    {{ Form::open(array('route' => array('vendorPerformanceEvaluation.cycles.evaluations.initiate', $evaluation->vendor_performance_evaluation_cycle_id, $evaluation->id), 'class' => 'smart-form')) }}
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <section class="col col-xs-12 col-md-4 col-lg-4">
                                ...
                                <label class="input">
                                    {{{ \PCK\VendorPerformanceEvaluation\VendorPerformanceEvaluation::getProjectStageName($evaluation->project_status_id) }}}
                                </label>
                            </section>
                        </div>
                        <div class="row">
                        ...
                        <footer>
                            {{ link_to_route('vendorPerformanceEvaluation.setups.index', trans('forms.back'), array($evaluation->vendor_performance_evaluation_cycle_id), array('class' => 'btn btn-default')) }}
                            {{ Form::button('<i class="fa fa-save"></i> '.trans('vendorManagement.initiate'), ['type' => 'submit', 'class' => 'btn btn-warning'] )  }}
                        </footer>
                    {{ Form::close() }}
                </div>
            </div>
