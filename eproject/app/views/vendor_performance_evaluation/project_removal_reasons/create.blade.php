        ...
        <div class="jarviswidget ">
            ...
            <div>
                <div class="widget-body">
                    {{ Form::open(array('route' => array('vendorPerformanceEvaluation.projectRemovalReasons.store'), 'class' => 'smart-form')) }}
                        <div class="row">
                            <section class="col col-xs-12 col-md-12 col-lg-12">
                                <label class="label">{{{ trans('vendorPerformanceEvaluation.name') }}} <span class="required">*</span>:</label>
                        ...
                        <footer>
                            {{ link_to_route('vendorPerformanceEvaluation.projectRemovalReasons.index', trans('forms.back'), array(), array('class' => 'btn btn-default')) }}
