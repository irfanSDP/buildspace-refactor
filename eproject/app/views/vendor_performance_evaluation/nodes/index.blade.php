    ...
    <script>
        $(document).ready(function () {
            var mainTable = new Tabulator('#main-table', {
                ...
                ajaxURL: "{{ route('vendorPerformanceEvaluation.templateForm.nodes.list', [$templateForm->id, $parentNode->id]) }}",
                layout:"fitColumns",
                columns:[
            ...
            $("#node-form").on('submit', function(e){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('vendorPerformanceEvaluation.templateForm.nodes.storeOrUpdate', [$templateForm->id, $parentNode->id])}}",
                    data: dataStr,
