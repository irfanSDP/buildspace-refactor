...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li>{{{ trans('instructiontocontractor.submit-form') }}}</li>
    </ol>
    ...
    <div class="jarviswidget jarviswidget-sortable">
        ...
        <div role="content">
            ...
            <div class="widget-body no-padding">
                ...
                {{ Form::open(array('route' => array('instruction-to-contractor.store', $project->id),'files' => true)) }}
                   
                <fieldset>
                 

                    <section class="col col-xs-12 col-md-12 col-lg-12">
                        <label for="instruction" style="padding-left:5px;"><strong>{{{ trans('instructiontocontractor.instructions') }}}</strong>&nbsp;<span class="required">*</span></label>
