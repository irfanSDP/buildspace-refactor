            ...
            <div class="jarviswidget ">
                ...
                <div>
                    <div class="widget-body no-padding">
                        {{ Form::open(array('route' => 'costData.store', 'method' => 'POST', 'class' => 'smart-form', 'id' => 'cost-data-form')) }}
...
@section('js')
    ...
    <script>
        ...
        //         dataType: 'json',
        //         cache: 'false',
        //         url: '{{ route("costData.listProjects") }}',
        //         data: {
        //             'subsidiaryId': $('form#cost-data-form [name=subsidiary_id]').val(),
        ...
        //                 if(!selectedProjectIds.includes(value.id)) selectedProjectIds.push(value.id);
        //             });
        //             projectListTable.setData(response.data);
        //         }
        //     });
        // });
    </script>
