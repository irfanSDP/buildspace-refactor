...
@section('breadcrumb')
	<ol class="breadcrumb">
        ...
        @endif
        <li>{{ trans('letterOfAward.contractDetails') }}</li>
	</ol>
            ...
            <article class="col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget" id="wid-id-0" 
                    ...
                    <header>
                        ...
                        <h2>{{ trans('letterOfAward.edit') . ' ' . trans('letterOfAward.contractDetails') }}</h2>
                    </header>
                    <div>
                            ...
                            <form action="#" method="POST" class="smart-form">
                                ...
                                <fieldset>
                                    <div id="summernoteTextInputSection">
                                        <div id="letterOfAwardContractDetailsContents" class="summernote"></div>
                                    </div>
                                </fieldset>
                                <footer>
...
<script>
    $(document).ready(function() {
        $('#letterOfAwardContractDetailsContents').summernote({
            placeholder: '{{ trans('letterOfAward.contractDetails') }}',
            height: 200,
            toolbar: [
        ...
        function populateContractDetails() {
            ...
            $.ajax({
                ...
                success: function(contents){
                    $('#letterOfAwardContractDetailsContents').summernote('code', contents);
        ...
        @if (!$canUserEditLetterOfAward)
            $('#letterOfAwardContractDetailsContents').summernote('disable');
        @endif
        ...
        $('#btnSave').on('click', function(e) {
            ...
            let contractDetailsContents = $('#letterOfAwardContractDetailsContents').summernote('code');
            ...
            $.ajax({
                ...
                data: {
                    _token: '{{{ csrf_token() }}}',
                    contents: contractDetailsContents
                },
