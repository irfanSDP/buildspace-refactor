...
@else
	<li>The Architect specified the provision of the Conditions that empowers him to issue the AI. If the Contractor is not satisfied that the provision of the Conditions specified empowers the issuance of the AI, he may inform the Architect.</li>
@endif