	...
	<div class="row">
		...
		<article class="col-sm-12 col-md-12 col-lg-10">
			...
			<div class="jarviswidget">
				@if ($user->hasCompanyProjectRole($loe->project, PCK\ContractGroups\Types\Role::INSTRUCTION_ISSUER) or $user->hasCompanyProjectRole($loe->project, PCK\ContractGroups\Types\Role::CLAIM_VERIFIER))
					@include('loss_and_or_expense_third_level_messages.partials.architect_qs_form')
				@else
					@include('loss_and_or_expense_third_level_messages.partials.contractor_form')
				@endif
			</div>
			<!-- end widget -->
		</article>
