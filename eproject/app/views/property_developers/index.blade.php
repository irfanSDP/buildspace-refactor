...
<div id="content">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            <a href="{{ route('propertyDevelopers.create') }}" class="btn btn-primary btn-md pull-right header-btn">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="jarviswidget ">
                <header>
                    <h2>{{ trans('propertyDevelopers.propertyDevelopers') }}</h2>
                </header>
                <div>
                    <div class="widget-body">
                        <div id="main-table"></div>
                        {{ Form::open(array('route' => array('propertyDevelopers.update'))) }}
        ...
        $(document).ready(function () {
            var mainTable = new Tabulator('#main-table', {
                ...
                columns:[
                    ...
                    {title:"{{ trans('businessEntityTypes.name') }}", field:"name", minWidth: 300, hozAlign:"left", headerSort:false, headerFilter:"input", headerFilterPlaceholder: "{{ trans('general.filter') }}"},
