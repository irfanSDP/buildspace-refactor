...
@section('breadcrumb')
	<ol class="breadcrumb">
		...
		<li>{{ trans('cidbGrades.edit_cidb_grades') }}</li>
	</ol>
@endsection
    ...
    <div class="jarviswidget">
        ...
        <div>
            ...
            <div class="widget-body no-padding">
                {{ Form::model($record, array('class'=>'smart-form', 'route' => array('cidb_grades.update', $record->id), 'method' => 'PUT')) }}
                    <fieldset>
                        <legend><h2>{{{ trans('cidbGrades.edit_cidb_grades') }}}</h2></legend>
                    ...
                    <footer>
                        {{ Form::button('<i class="fa fa-save"></i> '.trans('cidbGrades.update'), ['type' => 'submit', 'class' => 'btn btn-primary', 'name' => 'Submit'] )  }}
