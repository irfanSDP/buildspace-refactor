...
@section('content')
    <p>{{ trans('email/openTender.tenderResubmissionApproveRequest', ['tenderRevision' => trans("tenders.tenderRevision", [], 'messages', $recipientLocale), 'senderName' => $senderName], 'messages', $recipientLocale) }}</p>
