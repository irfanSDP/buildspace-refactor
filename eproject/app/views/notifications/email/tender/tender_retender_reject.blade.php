...
@section('content')
    <p>{{ trans('email/openTender.tenderResubmissionRejected', ['senderName' => $senderName, 'tenderRevision' => trans("tenders.tenderRevision", [], 'messages', $recipientLocale)], 'messages', $recipientLocale) }}</p>
