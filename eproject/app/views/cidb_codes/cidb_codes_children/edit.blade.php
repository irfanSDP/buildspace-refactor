...
@section('breadcrumb')
	<ol class="breadcrumb">
        ...
        @endif
        <li>{{$name->code}}</li>
		<li>{{ trans('cidbCodes.edit_cidb_codes') }}</li>
	</ol>
@endsection
    ...
    <div class="jarviswidget">
        ...
        <div>
            ...
            <div class="widget-body no-padding">
                {{ Form::model($record, array('class'=>'smart-form', 'route' => array('cidb_codes_children.update', 'parentId'=>$parentId , $record->id), 'method' => 'PUT')) }}
                    <fieldset>
                        <legend><h2>{{{ trans('cidbCodes.edit_cidb_codes') }}}</h2></legend>
                        <section class="col-xs-12 col-md-12 col-lg-12">
                            ...
                            <textarea class="form-control padded-less-left" rows="5" name="description" id="description">{{{Input::old('description')??$record->description}}}</textarea>
                    ...
                    <footer>
                        {{ Form::button('<i class="fa fa-save"></i> '.trans('cidbCodes.update'), ['type' => 'submit', 'class' => 'btn btn-primary', 'name' => 'Submit'] )  }}
