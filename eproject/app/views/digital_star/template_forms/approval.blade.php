        ...
        <div class="jarviswidget ">
            ...
            <div>
                <div class="widget-body">
                    ...
                    {{ Form::open(array('route' => array('digital-star.templateForm.approve', $templateForm->id), 'id' => 'form')) }}
                    <footer class="pull-right">
                        <button type="submit" class="btn btn-primary" name="submit" value="submit">{{ trans('forms.finalize') }}</button>
                        <a href="{{ route('digital-star.templateForm', array($templateForm->id)) }}" class="btn btn-default">{{ trans('general.back') }}</a>
                    </footer>
                    {{ Form::close() }}
                    @endif
                </div>
        ...
        $(document).ready(function () {
            var mainTable = new Tabulator('#main-table', {
                ...
                columns:[
                    ...
                    {title:"{{ trans('digitalStar/vendorManagement.score') }}", field:"score", width: 150, cssClass:"text-center text-middle", headerSort:false},
                ],
            });
        });
    </script>
