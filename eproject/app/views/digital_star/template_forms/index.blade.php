...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
        <a href="{{ route('digital-star.templateForm.create') }}" class="btn btn-primary btn-md pull-right header-btn">
        ...
        $(document).ready(function () {
            var mainTable = new Tabulator('#main-table', {
                ...
                columns:[
                    ...
                    {title:"{{ trans('digitalStar/vendorManagement.name') }}", field:"name", minWidth: 300, hozAlign:"left", headerSort:true, headerFilter:true},
                    {title:"{{ trans('digitalStar/vendorManagement.status') }}", field:"status", width: 120, hozAlign:"center", cssClass:"text-center text-middle", headerSort:false},
