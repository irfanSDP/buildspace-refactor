        ...
        $(document).ready(function () {
            var mainTable = new Tabulator('#main-table', {
                ...
                columns:[
                    ...
                    {title:"{{ trans('digitalStar/vendorManagement.company') }}", field:"company", width:300, cssClass:"text-center text-middle", headerSort:false, headerFilter:true},
                    {title:"{{ trans('digitalStar/vendorManagement.vendorGroup') }}", field:"vendor_group", width:250, cssClass:"text-center text-middle", headerSort:false, headerFilter:true},
                    {
                    ...
                    {title:"{{ trans('digitalStar/vendorManagement.status') }}", field:"status", width: 120, cssClass:"text-center text-middle", headerSort:false, headerFilter:"select", headerFilterParams:{{ json_encode($statuses) }},},
