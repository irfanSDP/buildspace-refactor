...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        @if($canAssignVerifiers)
            <li>{{ link_to_route('digital-star.approval.project.assign-verifiers.index', trans('forms.approval'), array()) }}</li>
        @endif
        @if($canApproveOrReject)
            <li>{{ link_to_route('digital-star.approval.project.approve.index', trans('forms.approval'), array()) }}</li>
        @endif
        ...
        <div class="jarviswidget ">
            ...
            <div>
                <div class="widget-body">
                    ...
                    {{ Form::open(array('route' => array('digital-star.approval.project.assign-verifiers.update', $evaluationForm->id), 'id' => 'form')) }}
                        <div class="row smart-form">
                            <section class="col col-xs-12 col-md-12 col-lg-12">
