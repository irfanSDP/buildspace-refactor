...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li>{{ trans('digitalStar/digitalStar.processors') }}</li>
    </ol>
@endsection
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget">
            <header>
                <h2>{{ trans('digitalStar/digitalStar.processors') }}</h2>
            </header>
            <div>
                    ...
                    <div class="row margin-top-5">
                        <section class="col col-xs-12 col-md-12 col-lg-12">
                            <button type="button" class="btn btn-primary btn-md pull-right header-btn" data-toggle="modal" data-target="#unassigned-table-modal">
                                <i class="fa fa-plus"></i> {{{ trans('digitalStar/digitalStar.assignProcessors') }}}
                            </button>
                        </section>
                    </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    {{{ trans('digitalStar/digitalStar.assignProcessors') }}}
                </h4>
    ...
    <script>
        $(document).ready(function() {
            var assignedTable = new Tabulator('#assigned-table', {
                height: 450,
                ajaxURL: "{{ route('digital-star.setups.processors.company.assigned', [$evaluation->id]) }}",
            ...
            $('#unassigned-table-modal').on('show.bs.modal', function(){
                unassignedTable.setData("{{ route('digital-star.setups.processors.company.unassigned', [$evaluation->id]) }}");
            });
