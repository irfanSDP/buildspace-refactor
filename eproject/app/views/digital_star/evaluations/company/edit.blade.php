...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li>{{ link_to_route('digital-star.evaluation.company.index', trans('digitalStar/vendorManagement.evaluations'), array()) }}</li>
        <li>{{{ $evaluatedCompany->name }}}</li>
        <li>{{ link_to_route('digital-star.evaluation.company.edit', trans('digitalStar/digitalStar.companyEvaluation'), array($evaluation->id, $evaluation->company_id, $evaluationForm->id)) }}</li>
    </ol>
@endsection
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget ">
            <header>
                <h2>{{{ trans('digitalStar/digitalStar.companyEvaluation') }}}</h2>
            </header>
            <div>
                <div class="widget-body">
                    ...
                    {{ Form::model($evaluationForm, array('route' => array('digital-star.evaluation.company.update', $evaluation->id, $evaluationForm->id), 'id' => 'scores-form')) }}
