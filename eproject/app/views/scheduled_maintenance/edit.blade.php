...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li>{{{trans('scheduledMaintenance.edit_scheduled_maintenance')}}}</li>
    </ol>
...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="jarviswidget">
			<header>
				<h2>{{ trans('scheduledMaintenance.edit_scheduled_maintenance') }}</h2>
			</header>
			<div>
				<div class="widget-body no-padding">
                    {{ Form::model($id, ['route' => ['scheduled_maintenance.update', $id], 'class' => 'smart-form', 'method' => 'PUT', 'id' => 'edit-form', 'files' => true]) }}
