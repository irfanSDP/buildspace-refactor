...
class ExtensionOfTime extends Model implements StatusType, ContractualClaimInterface {
    ...
    {
        return self::calculateDeadlineToSubmitNoticeToClaim($this->project, $this->commencement_date_of_event, $this->project->pam2006Detail->deadline_submitting_notice_of_intention_claim_eot);
    }
    ...
    protected function deleteRelatedModels()
    {
        ModelOperations::deleteWithTrigger(array(
            ...
            $this->eotContractorConfirmDelay,
            $this->extensionOfTimeClaim,
        ));
    }
