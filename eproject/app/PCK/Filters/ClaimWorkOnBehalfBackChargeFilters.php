...
class ClaimWorkOnBehalfBackChargeFilters {
    ...
    public static function canSubstitute(Project $project, User $user, $objectId)
    {
        ...
        return ContractManagementClaimVerifier::isPending($project, PostContractClaim::TYPE_WORK_ON_BEHALF_BACK_CHARGE, $objectId) && ( $assignedCompany->hasProjectRole($project, Role::PROJECT_OWNER) && $user->isGroupAdmin() );
    }
