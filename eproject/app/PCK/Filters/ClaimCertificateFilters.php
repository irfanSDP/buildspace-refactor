...
class ClaimCertificateFilters {
    ...
    public static function canSubstitute(Project $project, User $user, $objectId)
    {
        ...
        return ContractManagementClaimVerifier::isPending($project, PostContractClaim::TYPE_CLAIM_CERTIFICATE, $objectId) && ( $assignedCompany->hasProjectRole($project, Role::PROJECT_OWNER) && $user->isGroupAdmin() );
    }
