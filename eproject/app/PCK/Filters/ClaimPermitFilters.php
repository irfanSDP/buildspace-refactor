...
class ClaimPermitFilters {
    ...
    public static function canSubstitute(Project $project, User $user, $objectId)
    {
        ...
        return ContractManagementClaimVerifier::isPending($project, PostContractClaim::TYPE_PERMIT, $objectId) && ( $assignedCompany->hasProjectRole($project, Role::PROJECT_OWNER) && $user->isGroupAdmin() );
    }
