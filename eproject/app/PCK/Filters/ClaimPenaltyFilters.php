...
class ClaimPenaltyFilters {
    ...
    public static function canSubstitute(Project $project, User $user, $objectId)
    {
        ...
        return ContractManagementClaimVerifier::isPending($project, PostContractClaim::TYPE_PENALTY, $objectId) && ( $assignedCompany->hasProjectRole($project, Role::PROJECT_OWNER) && $user->isGroupAdmin() );
    }
