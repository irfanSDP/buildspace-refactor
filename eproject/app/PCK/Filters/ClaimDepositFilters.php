...
class ClaimDepositFilters {
    ...
    public static function canSubstitute(Project $project, User $user, $objectId)
    {
        ...
        return ContractManagementClaimVerifier::isPending($project, PostContractClaim::TYPE_DEPOSIT, $objectId) && ( $assignedCompany->hasProjectRole($project, Role::PROJECT_OWNER) && $user->isGroupAdmin() );
    }
