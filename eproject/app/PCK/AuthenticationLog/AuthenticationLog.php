...
namespace PCK\AuthenticationLog;
...
class AuthenticationLog extends Model
{
    ...
    {
        return $this->findDetectionRulesAgainstUA(static::getBrowsers(), $this->user_agent);
    }
    ...
    {
        return $this->findDetectionRulesAgainstUA(static::getPlatforms(), $this->user_agent);
    }
    ...
    public function device()
    {
        ...
        return $this->findDetectionRulesAgainstUA($rules, $this->user_agent);
    }
