...
class ConsultantManagementConsultantRfpReplyAttachment extends Model
{
    protected $table = 'consultant_management_consultant_rfp_reply_attachments';

    protected $fillable = ['consultant_management_rfp_questionnaire_id', 'consultant_management_consultant_questionnaire_id'];
