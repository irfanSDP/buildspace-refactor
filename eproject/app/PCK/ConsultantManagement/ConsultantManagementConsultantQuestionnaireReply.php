...
class ConsultantManagementConsultantQuestionnaireReply extends Model
{
    protected $table = 'consultant_management_consultant_questionnaire_replies';

    protected $fillable = ['consultant_management_questionnaire_id', 'consultant_management_consultant_questionnaire_id', 'text', 'consultant_management_questionnaire_option_id'];
