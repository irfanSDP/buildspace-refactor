...
class ConsultantManagementCallingRfpCompany extends Model
{
    protected $table = 'consultant_management_calling_rfp_companies';

    protected $fillable = ['consultant_management_calling_rfp_id', 'company_id', 'status'];
