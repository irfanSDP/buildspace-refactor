...
class RegistrationForm extends CustomFormValidator {
    ...
    protected $rules = [
        ...
        'main_contact'               => 'required|max:250',
        'company_email'              => 'required|max:250|email',
    ...
    protected function updateUniquenessValidation($formData)
    {
        ...
        {
            $this->rules['reference_no']['unique']        = "unique:companies,reference_no,NULL,id,contract_group_category_id,{$formData['contract_group_category_id']}";
            $this->rules['tax_registration_no']['unique'] = "unique:companies,tax_registration_no,NULL,id,contract_group_category_id,{$formData['contract_group_category_id']}";
            $this->rules['tax_registration_id']['unique'] = "unique:companies,tax_registration_id,NULL,id,contract_group_category_id,{$formData['contract_group_category_id']}";
        }
    }
