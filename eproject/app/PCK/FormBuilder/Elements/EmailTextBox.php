...
class EmailTextBox extends Element implements Elementable
{
    protected $validationRules = ['required', 'email'];
    ...
    public function getValidationErrorMessage()
    {
        ...
        $messages[$name . '.email']    = trans('formBuilder.mustBeValidEmail', ['label' => $this->label]);
