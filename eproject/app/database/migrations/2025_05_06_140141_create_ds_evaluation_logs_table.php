...
class CreateDsEvaluationLogsTable extends Migration {
	...
	public function up()
	{
		Schema::create('ds_evaluation_logs', function(Blueprint $table)
		{
			$table->increments('id');
            $table->integer('ds_evaluation_form_id')->unsigned();
            $table->integer('ds_action_type_id')->unsigned()->nullable();
	...
	{
		Schema::drop('ds_evaluation_logs');
	}
