...
class CreateVendorEvaluationCycleScoresTable extends Migration {
	...
	public function up()
	{
		Schema::create('vendor_evaluation_cycle_scores', function(Blueprint $table)
		{
			$table->increments('id');
			...
			$table->unique(array('vendor_work_category_id', 'company_id', 'vendor_performance_evaluation_cycle_id'), 'vendor_evaluation_cycle_scores_unique');
		});
	}
	...
	{
		Schema::drop('vendor_evaluation_cycle_scores');
	}
