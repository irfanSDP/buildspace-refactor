...
class CreateTenderLotInformationTable extends CustomMigration {
	...
	public function up()
	{
		$this->schema->create('tender_lot_information', function (CustomBlueprint $table)
		{
			$table->increments('id');
	...
	{
		$this->schema->drop('tender_lot_information');
	}
