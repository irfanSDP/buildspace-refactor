...
class CreateIcInfoGrossValuesAttachmentsTable extends Migration {
	...
	public function up()
	{
		Schema::create('ic_info_gross_values_attachments', function (Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('ic_info_gross_values_attachments');
	}
