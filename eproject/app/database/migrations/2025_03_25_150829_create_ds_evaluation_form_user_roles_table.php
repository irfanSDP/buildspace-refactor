...
class CreateDsEvaluationFormUserRolesTable extends Migration {
	...
	public function up()
	{
		Schema::create('ds_evaluation_form_user_roles', function(Blueprint $table)
		{
            $table->increments('id');
	...
	{
		Schema::drop('ds_evaluation_form_user_roles');
	}
