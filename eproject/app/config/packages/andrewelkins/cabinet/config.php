...
return array(
    ...
    */
    ...
    'upload_folder_public_path' => 'upload/',
    ...
    */
    ...
    'upload_file_types' => array('image/png','image/gif','image/jpg','image/jpeg', 'application/pdf', 'application/zip'),
    'upload_file_extensions' => array('png','gif','jpg','jpeg','pdf','zip'), // Case insensitive

	// Max upload size - In BYTES. 1GB = 1073741824 bytes, 10 MB = 10485760, 1 MB = 1048576
    // Converter - https://convertlive.com/u/convert/megabytes/to/bytes
    'max_upload_file_size' => Config::get('uploader.max_file_size'),
    ...
    */
    ...
    'image_resize' => array(
	    array(84, 64), // 84x64 image
	    array(84, 64, true), // 84x64 image ratio constrained aspect ratio
	    array(null, 82, true), // auto width x 82 height constrained aspect ratio
    ),
