...
return array(
    ...
    */
     ...
     * User's Model Class
     */
    'sp_user_model_class' => 'PCK\Users\User',

    /*
     * The path to the working phpsimplesaml install
     */
    'sp_path' => getenv('PHP_SIMPLE_SAML_PATH'),

    /*
     * The service provider name
     */
    'sp_name' => "buildspace-sp",

    /*
     * The redirect destination after logging out
     */
    'logout_target' => getenv('SINGLE_SIGN_ON_IP_PROVIDER_URL').'module.php/core/as_logout.php?AuthId=buildspace-sp&ReturnTo='.Request::root(),
