<?php
error_reporting(E_ALL ^ E_DEPRECATED);//to silence deprecate warning from php7
...
return array(
    ...
    */
    ...
    'timezone' => getenv('TIMEZONE') ? getenv('TIMEZONE') : 'Asia/Kuala_Lumpur',
    ...
    */
    ...
    'key' => 'IYRkG5CfFm3ulZerJWypXZx6J93wAqzf',
    ...
    */
    ...
    'providers' => array(
        ...
        'PCK\Providers\ViewServiceProvider',
        ...
        'PCK\Providers\AppServiceProvider',
        'PCK\Providers\CheckpointRedirectServiceProvider',
        'PCK\Providers\AuthenticationLogServiceProvider',
    ),
    ...
    */
    ...
    'aliases' => array(
        ...
        'Checkpoint'        => 'PCK\Facades\CheckpointRedirect',
