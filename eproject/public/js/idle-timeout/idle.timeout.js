...
(function ($) {
    ...
    $.fn.idleTimeout = function (userRuntimeConfig) {
      ...
      checkIdleTimeout = function () {
        ...
        var s = Math.floor(Number(currentConfig.idleTimeLimit) % 3600 % 60);

        var timeIdleTimeout = (store.get('idleTimerLastActivity') + (currentConfig.idleTimeLimit * 1000));

        //console.log('limit '+s);
        //console.log('idle '+timeIdleTimeout);
        //console.log('now '+$.now());
      ...
      openWarningDialog = function () {
        ...
        var dialogContent = "<div id='idletimer_warning_dialog' class='alert-danger'><h4>" + currentConfig.dialogText + "</h4><h4 style='display:inline'><strong>" + currentConfig.dialogTimeRemaining + ":</strong> <div style='display:inline' id='countdownDisplay'></div></h4></div>";
